...
#! <An object in FunctorCategory( Category generated by the
#!  right quiver Delta_op(C0,C1,C2)
#!  [id:C0->C1,s:C1->C0,t:C1->C0,is:C1->C2,it:C1->C2,ps:C2->C1,pt:C2->C1,mu:C2->C1]
...
#! with relations -> SkeletalFinSets ), ObjectMembershipFunction )
