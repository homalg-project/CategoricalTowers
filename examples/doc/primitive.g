...
counit := Counit( B );
#! Functor from finitely presented Bialgebra generated by the right quiver q(1)[t:1->1] -> Algebra generated by the right quiver *(1)[]

comult := Comultiplication( B );
#! Functor from finitely presented Bialgebra generated by the right quiver q(1)[t:1->1] -> Algebra generated by the right quiver qxq(1x1)[1xt:1x1->1x1,tx1:1x1->1x1]

#antipode := Antipode( B );

idB := IdentityFunctor(B);
#! Identity functor of Hopf algebroid generated by the right quiver q(1)[t:1->1]
