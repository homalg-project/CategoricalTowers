...
g1 := ConvertToMapOfFinSets( c3c3.objects, c3c3.generators[1] );
#! <A morphism in FinSets>
Display( g1 );
#! [ [ 1, 2, 3 ], [ [ 1, 2 ], [ 2, 3 ], [ 3, 1 ] ], [ 1, 2, 3 ] ]
g2 := ConvertToMapOfFinSets( c3c3.objects, c3c3.generators[2] );
#! <A morphism in FinSets>
Display( g2 );
#! [ [ 1, 2, 3 ], [ [ 1, 4 ], [ 2, 5 ], [ 3, 6 ] ], [ 4, 5, 6 ] ]
g3 := ConvertToMapOfFinSets( c3c3.objects, c3c3.generators[3] );
#! <A morphism in FinSets>
Display( g3 );
#! [ [ 4, 5, 6 ], [ [ 4, 5 ], [ 5, 6 ], [ 6, 4 ] ], [ 4, 5, 6 ] ]
g := ConvertToMapOfFinSets( c3c3.objects, [,,,1,1,1] );
#! <A morphism in FinSets>
Display( g );
