...
Dependencies := rec(
  ...
  NeededOtherPackages := [ [ "GAPDoc", ">= 1.5" ],
                   ...
                   [ "CategoriesWithAmbientObjects", ">= 2026.04-01" ],
                   [ "ToolsForCategoricalTowers", ">= 2024.03-02" ],
                   [ "IntrinsicCategories", ">= 2026.04-01" ],
                   [ "IntrinsicModules", ">= 2026.04-01" ],
                   [ "ExteriorPowersCategories", ">= 2026.04-01" ],
                   ],
