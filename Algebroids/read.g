...
ReadPackage( "Algebroids", "gap/CategoryOfFpBialgebras.gi" );
ReadPackage( "Algebroids", "gap/CategoryOfFpMatrixBialgebras.gi" );
ReadPackage( "Algebroids", "gap/CategoryOfFpHopfAlgebras.gi" );
ReadPackage( "Algebroids", "gap/CategoryOfFpMatrixHopfAlgebras.gi" );
