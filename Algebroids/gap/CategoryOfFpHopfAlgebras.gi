...
InstallMethod( AffineVarietyOfHopfMonoids,
  ...
  function( fp_algebra, counit_record, comult_record, antipode_record )
    ...
    relations1 := Filtered( Concatenation( Concatenation( relations1 ) ), r -> not IsZero( r ) );
    relations2 := Filtered( Concatenation( Concatenation( relations2 ) ), r -> not IsZero( r ) );
    relations3 := Filtered( Concatenation( Concatenation( relations3 ) ), r -> not IsZero( r ) );
