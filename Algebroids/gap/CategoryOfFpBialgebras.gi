...
##
InstallOtherMethod( \/,
        "for an endomorphism of linear closures and and a finitely presented bialgebra",
...
InstallMethod( \/,
  ...
  function( fp_bialgebra, FpBialg_R )
    local B, R, fp_algebra, FpAlg_R, R_fp_algebra, nonuple, R_U, R_fp_algebra_square, counit, comult, septuple;
