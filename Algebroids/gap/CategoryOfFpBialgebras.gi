...
InstallMethod( AffineVarietyOfBimonoids,
  ...
  function( fp_algebra, counit_record, comult_record )
    ...
    relations1 := Filtered( Concatenation( relations1 ), r -> not IsZero( r ) );
    relations2 := Filtered( Concatenation( relations2 ), r -> not IsZero( r ) );
...
InstallMethod( \/,
        ...
        [ IsMorphismInCategoryOfFpBialgebras, IsCapCategory and IsLinearCategoryOverCommutativeRing and HasCommutativeSemiringOfLinearCategory ],
