...
################################
test: doc test_Algebroids test_CategoriesWithAmbientObjects test_ToolsForCategoricalTowers test_CatReps test_ExteriorPowersCategories test_FiniteCocompletions test_FunctorCategories test_GradedCategories test_InternalModules test_IntrinsicCategories test_IntrinsicGradedModules test_IntrinsicModules test_LazyCategories test_Locales test_PreSheaves test_QuotientCategories test_SubcategoriesForCAP test_Toposes test_ZariskiFrames
