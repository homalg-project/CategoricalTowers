...
doc_SliceCategoriesForCAP:
	$(MAKE) -C SliceCategoriesForCAP doc
...
test_SliceCategoriesForCAP:
	$(MAKE) -C SliceCategoriesForCAP test
...
ci-test_SliceCategoriesForCAP:
	$(MAKE) -C SliceCategoriesForCAP ci-test
