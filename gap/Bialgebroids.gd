...
#! @Description
#!  Construct the algebroid associated to the path <A>R</A>-algebra <A>Rq</A>,
#!  i.e., generated by the quiver <A>q</A> as an <A>R</A>-linear category.
#! @Arguments Rq
...
#! @Description
#!  Construct the algebroid associated to the path <A>R</A>-algebra <A>Rq</A> of the quiver <A>q</A>,
#!  and enhance it with a comultiplication and a counit using <A>comult_counit</A>.
