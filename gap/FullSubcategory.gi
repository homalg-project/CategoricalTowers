  ...
  function( L )
    ...
    if name = fail then
      ...
      if Size( L ) > 1 then
        ...
        name := Concatenation( "Full subcategory generated by ", String( Size( L ) ), " objects in ", Name( cat ) );
        
      else
        
        name := Concatenation( "Full subcategory generated by 1 object in ", Name( cat ) );
