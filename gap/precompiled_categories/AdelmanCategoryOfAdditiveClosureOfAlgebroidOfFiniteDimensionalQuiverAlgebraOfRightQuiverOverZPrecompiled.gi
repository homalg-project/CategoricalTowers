...
function ( cat_1, arg2_1 )
    ...
    deduped_69_1 := UnderlyingCategory( deduped_71_1 );
    ...
    deduped_65_1 := MorphismMatrix( deduped_66_1 );
    ...
    deduped_57_1 := ZeroImmutable( deduped_63_1 );
    ...
    hoisted_4_1 := List( deduped_62_1, function ( logic_new_func_list_2 )
    ...
    hoisted_44_1 := List( deduped_65_1, function ( logic_new_func_list_2 )
    ...
    hoisted_34_1 := List( deduped_65_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
    ...
    hoisted_29_1 := List( deduped_64_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    ...
    hoisted_27_1 := List( deduped_64_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                end );
        end );
    hoisted_26_1 := List( deduped_64_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                end );
        end );
    ...
    hoisted_23_1 := List( deduped_64_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                end );
        end );
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_82_1 := ZeroImmutable( deduped_87_1 );
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_170_1 := MorphismMatrix( deduped_175_1 );
    deduped_169_1 := MorphismMatrix( deduped_176_1 );
    deduped_168_1 := UnderlyingQuiverAlgebra( deduped_178_1 );
    deduped_167_1 := List( deduped_179_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_166_1 := BasisPathsByVertexIndex( deduped_178_1 );
    ...
    deduped_161_1 := List( deduped_170_1, function ( logic_new_func_new_row_2 )
            return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_160_1 := ZeroImmutable( deduped_168_1 );
    ...
    deduped_124_1 := List( deduped_170_1, function ( logic_new_func_new_row_2 )
            return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                    return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                end );
        end );
    ...
    deduped_121_1 := List( deduped_170_1, function ( logic_new_func_new_row_2 )
            return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                end );
        end );
    deduped_120_1 := List( deduped_170_1, function ( logic_new_func_new_row_2 )
            return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                end );
        end );
    ...
    hoisted_8_1 := List( deduped_166_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    ...
    hoisted_95_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_139_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
                    end ), List( deduped_132_1, function ( logic_new_func_x_2 )
                        return hoisted_71_1;
                    end ) ] ), UnionOfColumnsListList( deduped_140_1, [ deduped_167_1, deduped_162_1 ] ) ] );
    ...
    hoisted_93_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_139_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_132_1, function ( logic_new_func_x_2 )
    ...
    hoisted_91_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_139_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_132_1, function ( logic_new_func_x_2 )
    ...
    hoisted_86_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_139_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                            end );
                    end ), List( deduped_132_1, function ( logic_new_func_x_2 )
    ...
    hoisted_43_1 := UnionOfRowsListList( deduped_118_1, [ UnionOfColumnsListList( deduped_136_1, [ List( deduped_169_1, function ( logic_new_func_new_row_2 )
                        ...
                        return hoisted_18_1;
                    end ) ] ), UnionOfColumnsListList( deduped_137_1, [ deduped_171_1, deduped_161_1 ] ) ] );
