...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_90_1 := MorphismMatrix( deduped_91_1 );
    deduped_89_1 := MorphismMatrix( deduped_93_1 );
    deduped_88_1 := MorphismMatrix( deduped_92_1 );
    deduped_87_1 := UnderlyingQuiverAlgebra( deduped_94_1 );
    deduped_86_1 := BasisPathsByVertexIndex( deduped_94_1 );
    deduped_85_1 := UnderlyingRing( RangeCategoryOfHomomorphismStructure( deduped_97_1 ) );
    deduped_84_1 := ObjectList( Source( deduped_96_1 ) );
    deduped_83_1 := ObjectList( Source( deduped_91_1 ) );
    deduped_82_1 := ObjectList( Range( deduped_93_1 ) );
    deduped_81_1 := ZeroImmutable( deduped_87_1 );
    ...
    deduped_75_1 := List( deduped_82_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_74_1 := List( deduped_78_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_73_1 := Length( deduped_82_1 );
    deduped_72_1 := Length( deduped_80_1 );
    deduped_71_1 := List( deduped_80_1, function ( logic_new_func_x_2 )
            return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    ...
    deduped_66_1 := [ 1 .. deduped_73_1 ];
    deduped_65_1 := [ 1 .. deduped_72_1 ];
    deduped_64_1 := [ 1 .. Length( deduped_77_1 ) ];
    deduped_63_1 := Sum( [ deduped_72_1, deduped_73_1 ] );
    deduped_62_1 := [ 1 .. deduped_63_1 ];
    deduped_61_1 := [ 1 .. Sum( [ deduped_69_1, deduped_70_1 ] ) ];
    hoisted_21_1 := deduped_82_1;
    hoisted_20_1 := deduped_80_1;
    hoisted_6_1 := List( deduped_86_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    ...
    hoisted_49_1 := Concatenation( deduped_71_1, List( deduped_82_1, function ( logic_new_func_x_2 )
              return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
          end ) );
    hoisted_13_1 := deduped_87_1;
    ...
    hoisted_55_1 := List( deduped_90_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    ...
    hoisted_52_1 := List( deduped_90_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                end );
        end );
    hoisted_51_1 := List( deduped_90_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                end );
        end );
    ...
    hoisted_41_1 := UnionOfRowsListList( deduped_63_1, [ UnionOfColumnsListList( deduped_69_1, [ List( deduped_88_1, function ( logic_new_func_new_row_2 )
                        ...
                        return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
                    end ), List( deduped_89_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
                    end ) ] ) ] );
    ...
    hoisted_37_1 := deduped_75_1;
    hoisted_38_1 := List( deduped_66_1, function ( logic_new_func_x_2 )
            return hoisted_37_1[logic_new_func_x_2];
        end );
    hoisted_39_1 := UnionOfRowsListList( deduped_63_1, [ UnionOfColumnsListList( deduped_69_1, [ List( deduped_88_1, function ( logic_new_func_new_row_2 )
    ...
    hoisted_34_1 := deduped_74_1;
    hoisted_36_1 := UnionOfRowsListList( deduped_63_1, [ UnionOfColumnsListList( deduped_69_1, [ List( deduped_88_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_67_1, function ( logic_new_func_x_2 )
    ...
    hoisted_31_1 := UnionOfRowsListList( deduped_63_1, [ UnionOfColumnsListList( deduped_69_1, [ List( deduped_88_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                            end );
                    end ), List( deduped_67_1, function ( logic_new_func_x_2 )
    ...
    hoisted_22_1 := Concatenation( deduped_74_1, List( deduped_79_1, function ( logic_new_func_x_2 )
              return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
          end ) );
    ...
    hoisted_17_1 := UnionOfColumnsListList( deduped_72_1, [ List( deduped_65_1, function ( logic_new_func_x_2 )
                  local hoisted_1_2;
    ...
    return IsZero( DecideZeroRows( HomalgMatrixListList( UnionOfColumnsListList( 1, List( deduped_76_1, function ( logic_new_func_x_2 )
                ...
                end ) ), 1, deduped_60_1, deduped_85_1 ), HomalgMatrixListList( UnionOfRowsListList( deduped_60_1, Concatenation( List( deduped_76_1, function ( logic_new_func_x_2 )
                      local hoisted_1_2, hoisted_2_2;
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_172_1 := MorphismMatrix( deduped_174_1 );
    deduped_171_1 := List( deduped_180_1, function ( logic_new_func_new_row_2 )
            return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_170_1 := MorphismMatrix( deduped_176_1 );
    deduped_169_1 := List( deduped_179_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_168_1 := BasisPathsByVertexIndex( deduped_178_1 );
    deduped_167_1 := UnderlyingQuiverAlgebra( deduped_178_1 );
    deduped_166_1 := MorphismMatrix( deduped_175_1 );
    deduped_165_1 := ObjectList( Source( deduped_183_1 ) );
    deduped_164_1 := UnderlyingRing( RangeCategoryOfHomomorphismStructure( deduped_182_1 ) );
    deduped_163_1 := ObjectList( Source( deduped_181_1 ) );
    deduped_162_1 := List( deduped_172_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_161_1 := ObjectList( Source( deduped_174_1 ) );
    deduped_160_1 := ObjectList( Source( deduped_177_1 ) );
    deduped_159_1 := ZeroImmutable( deduped_167_1 );
    deduped_158_1 := List( deduped_166_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, UnderlyingQuiverAlgebraElement );
        end );
    deduped_157_1 := ObjectList( Range( deduped_177_1 ) );
    ...
    deduped_151_1 := [ 1 .. Length( deduped_165_1 ) ];
    deduped_150_1 := [ 1 .. Length( deduped_163_1 ) ];
    deduped_149_1 := List( deduped_160_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_148_1 := List( deduped_161_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_147_1 := List( deduped_152_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_146_1 := List( deduped_153_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_145_1 := Length( deduped_161_1 );
    deduped_144_1 := Length( deduped_160_1 );
    deduped_143_1 := List( deduped_155_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_142_1 := List( deduped_154_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_141_1 := List( deduped_156_1, function ( logic_new_func_x_2 )
            return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    deduped_140_1 := Length( deduped_157_1 );
    deduped_139_1 := List( deduped_157_1, function ( logic_new_func_x_2 )
            return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    ...
    deduped_133_1 := [ 1 .. deduped_144_1 ];
    deduped_132_1 := [ 1 .. deduped_140_1 ];
    deduped_131_1 := [ 1 .. deduped_145_1 ];
    deduped_130_1 := [ 1 .. deduped_136_1 ];
    deduped_129_1 := [ 1 .. deduped_138_1 ];
    deduped_128_1 := [ 1 .. deduped_137_1 ];
    deduped_127_1 := [ 1 .. deduped_135_1 ];
    deduped_126_1 := [ 1 .. deduped_134_1 ];
    deduped_125_1 := List( deduped_172_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                end );
        end );
    deduped_124_1 := List( deduped_166_1, function ( logic_new_func_new_row_2 )
            return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                    return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                end );
        end );
    deduped_123_1 := List( deduped_172_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                end );
        end );
    deduped_122_1 := List( deduped_172_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                end );
        end );
    deduped_121_1 := List( deduped_166_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                end );
        end );
    deduped_120_1 := List( deduped_166_1, function ( logic_new_func_x_2 )
            return List( logic_new_func_x_2, function ( logic_new_func_x_3 )
                    return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                end );
        end );
    deduped_119_1 := Sum( [ deduped_140_1, deduped_134_1 ] );
    deduped_118_1 := Sum( [ deduped_138_1, deduped_135_1 ] );
    deduped_117_1 := [ 1 .. Sum( [ deduped_144_1, deduped_145_1 ] ) ];
    deduped_116_1 := [ 1 .. deduped_119_1 ];
    deduped_115_1 := [ 1 .. deduped_118_1 ];
    deduped_114_1 := [ 1 .. Sum( [ deduped_136_1, deduped_137_1 ] ) ];
    hoisted_76_1 := deduped_152_1;
    hoisted_75_1 := deduped_157_1;
    hoisted_8_1 := List( deduped_168_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    deduped_113_1 := Sum( Concatenation( List( deduped_165_1, function ( logic_new_func_x_2 )
                local hoisted_1_2;
    ...
    hoisted_110_1 := deduped_160_1;
    hoisted_109_1 := deduped_128_1;
    hoisted_101_1 := Concatenation( deduped_139_1, List( deduped_152_1, function ( logic_new_func_x_2 )
              return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
          end ) );
    hoisted_63_1 := deduped_116_1;
    ...
    hoisted_108_1 := List( deduped_116_1, function ( logic_new_func_x_2 )
            ...
            return List( hoisted_63_1, function ( logic_new_func_x_3 )
                    if logic_new_func_x_2 = logic_new_func_x_3 then
                        ...
                        return deduped_159_1;
                    fi;
                    return;
                end );
        end );
    hoisted_107_1 := deduped_158_1;
    hoisted_65_1 := Concatenation( List( deduped_157_1, function ( logic_new_func_x_2 )
              return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
          end ), deduped_147_1 );
    hoisted_106_1 := List( deduped_116_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    hoisted_105_1 := List( deduped_116_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
            hoisted_1_2 := hoisted_65_1[logic_new_func_x_2];
            return List( hoisted_63_1, function ( logic_new_func_x_3 )
                    return hoisted_1_2;
    ...
    hoisted_102_1 := List( deduped_116_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    hoisted_98_1 := deduped_143_1;
    hoisted_99_1 := List( deduped_128_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    hoisted_100_1 := List( deduped_128_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    hoisted_17_1 := deduped_159_1;
    hoisted_71_1 := List( deduped_126_1, function ( logic_new_func_x_2 )
            return hoisted_17_1;
        end );
    hoisted_95_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_144_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
                    end ), List( deduped_133_1, function ( logic_new_func_x_2 )
                        return hoisted_71_1;
                    end ) ] ), UnionOfColumnsListList( deduped_145_1, [ deduped_169_1, deduped_162_1 ] ) ] );
    hoisted_81_1 := deduped_151_1;
    hoisted_80_1 := List( deduped_165_1, function ( logic_new_func_x_2 )
            return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    ...
    hoisted_45_1 := deduped_147_1;
    hoisted_92_1 := List( deduped_126_1, function ( logic_new_func_x_2 )
            return hoisted_45_1[logic_new_func_x_2];
        end );
    hoisted_93_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_144_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_133_1, function ( logic_new_func_x_2 )
                        return hoisted_92_1;
                    end ) ] ), UnionOfColumnsListList( deduped_145_1, [ List( deduped_179_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                            end );
                    end ), deduped_123_1 ] ) ] );
    ...
    hoisted_91_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_144_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_133_1, function ( logic_new_func_x_2 )
    ...
    hoisted_62_1 := List( deduped_165_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    ...
    hoisted_86_1 := UnionOfRowsListList( deduped_119_1, [ UnionOfColumnsListList( deduped_144_1, [ List( deduped_173_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                            end );
                    end ), List( deduped_133_1, function ( logic_new_func_x_2 )
    ...
    hoisted_78_1 := deduped_117_1;
    hoisted_77_1 := Concatenation( deduped_149_1, deduped_148_1 );
    ...
    hoisted_73_1 := [ 1 .. Length( ObjectList( Range( deduped_183_1 ) ) ) ];
    hoisted_70_1 := deduped_132_1;
    hoisted_69_1 := deduped_139_1;
    hoisted_72_1 := UnionOfColumnsListList( deduped_140_1, [ List( deduped_132_1, function ( logic_new_func_x_2 )
                  local hoisted_1_2;
    ...
    hoisted_66_1 := List( deduped_116_1, function ( logic_new_func_x_2 )
    ...
    hoisted_59_1 := deduped_131_1;
    hoisted_51_1 := Concatenation( deduped_141_1, List( deduped_153_1, function ( logic_new_func_x_2 )
              return QuiverVertexAsIdentityPath( UnderlyingVertex( logic_new_func_x_2 ) );
          end ) );
    ...
    hoisted_48_1 := deduped_148_1;
    hoisted_49_1 := List( deduped_131_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    hoisted_50_1 := List( deduped_131_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    hoisted_43_1 := UnionOfRowsListList( deduped_118_1, [ UnionOfColumnsListList( deduped_136_1, [ List( deduped_170_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, UnderlyingQuiverAlgebraElement );
                    end ), List( deduped_130_1, function ( logic_new_func_x_2 )
                        return hoisted_18_1;
                    end ) ] ), UnionOfColumnsListList( deduped_137_1, [ deduped_171_1, deduped_158_1 ] ) ] );
    ...
    hoisted_41_1 := UnionOfRowsListList( deduped_118_1, [ UnionOfColumnsListList( deduped_136_1, [ List( deduped_170_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Range( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_130_1, function ( logic_new_func_x_2 )
    ...
    hoisted_36_1 := deduped_142_1;
    hoisted_38_1 := UnionOfRowsListList( deduped_118_1, [ UnionOfColumnsListList( deduped_136_1, [ List( deduped_170_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return VertexIndex( UnderlyingVertex( Source( logic_new_func_x_3 ) ) );
                            end );
                    end ), List( deduped_130_1, function ( logic_new_func_x_2 )
    ...
    hoisted_33_1 := UnionOfRowsListList( deduped_118_1, [ UnionOfColumnsListList( deduped_136_1, [ List( deduped_170_1, function ( logic_new_func_new_row_2 )
                        return List( logic_new_func_new_row_2, function ( logic_new_func_x_3 )
                                return IsZero( UnderlyingQuiverAlgebraElement( logic_new_func_x_3 ) );
                            end );
                    end ), List( deduped_130_1, function ( logic_new_func_x_2 )
    ...
    hoisted_24_1 := Concatenation( deduped_142_1, deduped_143_1 );
    ...
    hoisted_16_1 := deduped_129_1;
    hoisted_14_1 := deduped_141_1;
    hoisted_19_1 := UnionOfColumnsListList( deduped_138_1, [ List( deduped_129_1, function ( logic_new_func_x_2 )
                  local hoisted_1_2;
    ...
    hoisted_4_1 := ListWithKeys( deduped_116_1, function ( key_2, logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
    ...
    hoisted_3_1 := ListWithKeys( deduped_117_1, function ( key_2, logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
    ...
    return IsZero( DecideZeroRows( HomalgMatrixListList( UnionOfColumnsListList( 1, List( deduped_150_1, function ( logic_new_func_x_2 )
                      ...
                      return UnionOfColumnsListList( 1, List( hoisted_6_1, function ( logic_new_func_x_3 )
                  ...
                  end ) ), 1, deduped_112_1, deduped_164_1 ), HomalgMatrixListList( UnionOfRowsListList( deduped_112_1, Concatenation( List( deduped_150_1, function ( logic_new_func_x_2 )
                        local hoisted_1_2, hoisted_2_2;
                        hoisted_1_2 := hoisted_26_1[logic_new_func_x_2];
                        ...
                        return UnionOfColumnsListList( Sum( List( hoisted_6_1, function ( logic_new_func_x_3 )
                          ...
                          end ) ) ) ] ), deduped_112_1, deduped_164_1 ) ) ) and IsZero( DecideZeroRows( HomalgMatrixListList( UnionOfColumnsListList( 1, List( deduped_151_1, function ( logic_new_func_x_2 )
                      local hoisted_1_2, hoisted_2_2, hoisted_3_2;
                      ...
                      return UnionOfColumnsListList( 1, List( hoisted_63_1, function ( logic_new_func_x_3 )
                  ...
                  end ) ), 1, deduped_113_1, deduped_164_1 ), HomalgMatrixListList( UnionOfRowsListList( deduped_113_1, Concatenation( List( deduped_151_1, function ( logic_new_func_x_2 )
                        local hoisted_1_2, hoisted_2_2;
                        ...
                        return UnionOfColumnsListList( Sum( List( hoisted_63_1, function ( logic_new_func_x_3 )
                          ...
                          end ) ) ) ] ), deduped_113_1, deduped_164_1 ) ) );
end
########
