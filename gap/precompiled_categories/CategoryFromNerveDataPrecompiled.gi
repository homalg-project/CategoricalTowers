...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_16_1 := List( [ 0 .. deduped_18_1 - 1 ], function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_14_1[1 + i_2] ), hoisted_7_1 );
        end );
    hoisted_15_1 := deduped_18_1;
    hoisted_11_1 := deduped_19_1;
    hoisted_13_1 := List( [ 0 .. deduped_17_1 - 1 ], function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_11_1[1 + i_2] ), hoisted_3_1 );
        end );
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Length, Length( Filtered( [ 0 .. deduped_17_1 * deduped_18_1 - 1 ], function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := CAP_JIT_INCOMPLETE_LOGIC( x_2 );
                return hoisted_13_1[1 + REM_INT( deduped_1_2, hoisted_12_1 )] = hoisted_16_1[1 + REM_INT( QUO_INT( deduped_1_2, hoisted_12_1 ), hoisted_15_1 )];
            end ) ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    deduped_23_1 := Filtered( [ 0 .. deduped_25_1 * deduped_27_1 - 1 ], function ( x_2 )
            local deduped_1_2;
            deduped_1_2 := CAP_JIT_INCOMPLETE_LOGIC( x_2 );
            return hoisted_6_1[1 + REM_INT( deduped_1_2, hoisted_5_1 )] = hoisted_8_1[1 + REM_INT( QUO_INT( deduped_1_2, hoisted_5_1 ), hoisted_7_1 )];
        end );
    hoisted_4_1 := AsList( deduped_32_1 );
    hoisted_3_1 := deduped_26_1;
    hoisted_2_1 := AsList( deduped_28_1 );
    hoisted_1_1 := deduped_24_1;
    deduped_22_1 := Filtered( [ 0 .. deduped_24_1 * deduped_26_1 - 1 ], function ( x_2 )
            local deduped_1_2;
            deduped_1_2 := CAP_JIT_INCOMPLETE_LOGIC( x_2 );
            return hoisted_2_1[1 + REM_INT( deduped_1_2, hoisted_1_1 )] = hoisted_4_1[1 + REM_INT( QUO_INT( deduped_1_2, hoisted_1_1 ), hoisted_3_1 )];
        end );
    ...
    hoisted_14_1 := List( [ 0 .. deduped_21_1 - 1 ], function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_12_1[1 + i_2] ), hoisted_5_1 );
        end );
    hoisted_13_1 := deduped_21_1;
    hoisted_9_1 := deduped_22_1;
    hoisted_11_1 := List( [ 0 .. deduped_20_1 - 1 ], function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_9_1[1 + i_2] ), hoisted_1_1 );
        end );
    hoisted_10_1 := deduped_20_1;
    deduped_19_1 := Filtered( [ 0 .. deduped_20_1 * deduped_21_1 - 1 ], function ( x_2 )
            local deduped_1_2;
            deduped_1_2 := CAP_JIT_INCOMPLETE_LOGIC( x_2 );
            return hoisted_11_1[1 + REM_INT( deduped_1_2, hoisted_10_1 )] = hoisted_14_1[1 + REM_INT( QUO_INT( deduped_1_2, hoisted_10_1 ), hoisted_13_1 )];
        end );
    deduped_18_1 := Length( deduped_19_1 );
    hoisted_15_1 := deduped_19_1;
    hoisted_17_1 := List( [ 0 .. deduped_18_1 - 1 ], function ( logic_new_func_x_2 )
            return hoisted_11_1[1 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_15_1[(1 + logic_new_func_x_2)] ), hoisted_10_1 )];
        end );
    ...
    return CreateCapCategoryMorphismWithAttributes( deduped_34_1, deduped_30_1, CreateCapCategoryObjectWithAttributes( deduped_34_1, Length, deduped_18_1 ), AsList, List( [ 0 .. Length( deduped_30_1 ) - 1 ], function ( x_2 )
              return -1 + SafePosition( hoisted_17_1, hoisted_16_1[(1 + x_2)] );
          end ) );
end
########
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    hoisted_13_1 := List( [ 0 .. deduped_21_1 - 1 ], function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_11_1[1 + i_2] ), hoisted_3_1 );
        end );
    ...
    hoisted_19_1 := List( [ 0 .. Length( deduped_20_1 ) - 1 ], function ( logic_new_func_x_2 )
            return hoisted_13_1[1 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_17_1[(1 + logic_new_func_x_2)] ), hoisted_12_1 )];
        end );
...
function ( cat_1, alpha_1, beta_1 )
    local hoisted_3_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_9_1, deduped_10_1, deduped_11_1, deduped_12_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1, deduped_18_1;
    deduped_18_1 := NerveData( cat_1 );
    deduped_17_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_16_1 := deduped_18_1[2];
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( alpha_1 ), Range( beta_1 ), MapOfMorphism, CreateCapCategoryMorphismWithAttributes( deduped_17_1, CreateCapCategoryObjectWithAttributes( deduped_17_1, Length, 1 ), Range( deduped_13_1 ), AsList, [ AsList( deduped_13_1 )[1 + (-1 + SafePosition( List( [ 0 .. (Length( deduped_18_1[1][3] ) - 1) ], function ( logic_new_func_x_2 )
                           local deduped_1_2;
                           deduped_1_2 := (1 + CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 ));
                           return (-1 + SafePosition( hoisted_9_1, (hoisted_7_1[deduped_1_2] + hoisted_8_1[deduped_1_2] * hoisted_3_1) ));
                       end ), CAP_JIT_INCOMPLETE_LOGIC( [ 0 .. (Length( deduped_10_1 ) - 1) ][SafePosition( deduped_10_1, (AsList( MapOfMorphism( alpha_1 ) )[1] + AsList( MapOfMorphism( beta_1 ) )[1] * deduped_11_1) )] ) ))] ] ) );
end
########
