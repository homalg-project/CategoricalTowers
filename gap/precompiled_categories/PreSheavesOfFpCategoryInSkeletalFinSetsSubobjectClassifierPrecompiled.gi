...
function ( cat_1 )
    ...
    deduped_28_1 := Source( cat_1 );
    deduped_27_1 := BasisPathsByVertexIndex( deduped_28_1 );
    deduped_26_1 := SetOfGeneratingMorphisms( deduped_28_1 );
    deduped_25_1 := SetOfObjects( deduped_28_1 );
    deduped_24_1 := Length( deduped_25_1 );
    deduped_23_1 := [ 1 .. Length( deduped_26_1 ) ];
    deduped_22_1 := [ 1 .. deduped_24_1 ];
    hoisted_10_1 := deduped_29_1;
    hoisted_9_1 := [ 1 ];
    hoisted_8_1 := UnderlyingQuiverAlgebra( deduped_28_1 );
    hoisted_7_1 := deduped_27_1;
    hoisted_6_1 := List( deduped_25_1, function ( logic_new_func_x_2 )
            return VertexIndex( UnderlyingVertex( logic_new_func_x_2 ) );
        end );
    hoisted_5_1 := deduped_24_1;
    hoisted_2_1 := deduped_25_1;
    hoisted_1_1 := List( deduped_27_1, function ( logic_new_func_list_2 )
            return List( logic_new_func_list_2, Length );
        end );
    hoisted_4_1 := List( deduped_25_1, function ( logic_new_func_x_2 )
            local hoisted_1_2;
    ...
    deduped_21_1 := List( deduped_22_1, function ( logic_new_func_x_2 )
            ...
            hoisted_4_2 := deduped_31_2 * GeometricSumDiff1( deduped_31_2, deduped_31_2 );
    ...
    hoisted_20_1 := [ 0, 1 ];
    hoisted_18_1 := HomStructureOnBasisPaths( deduped_28_1 );
    ...
    hoisted_11_1 := DefiningPairOfUnderlyingQuiver( deduped_28_1 )[2];
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_28_1, Range, deduped_29_1, ValuesOfPreSheaf, NTuple( 2, deduped_21_1, List( deduped_23_1, function ( m_2 )
