...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_37_1 := DefiningQuadrupleOfQuiver( arg2_1 );
    deduped_36_1 := DefiningQuadrupleOfQuiver( arg3_1 );
    deduped_35_1 := DefiningPairOfUnderlyingQuiver( cat_1 );
    ...
    deduped_25_1 := Concatenation( List( [ 1 .. deduped_29_1 ], function ( logic_new_func_x_2 )
              return hoisted_1_1[logic_new_func_x_2] ^ hoisted_2_1[logic_new_func_x_2];
          end ), ListWithIdenticalEntries( deduped_28_1, deduped_31_1 ^ deduped_32_1 ) );
    deduped_24_1 := [ 0 .. Product( deduped_25_1 ) - 1 ];
    hoisted_21_1 := [ 0 .. deduped_31_1 ^ deduped_34_1 - 1 ];
    hoisted_20_1 := [ 0 .. deduped_31_1 - 1 ];
    hoisted_19_1 := [ deduped_37_1[3], deduped_37_1[4] ];
    hoisted_18_1 := [ 0 .. deduped_34_1 - 1 ];
    hoisted_17_1 := deduped_30_1;
    hoisted_16_1 := [ 0 .. deduped_33_1 ^ deduped_32_1 - 1 ];
    hoisted_15_1 := deduped_31_1;
    hoisted_14_1 := [ 0 .. deduped_32_1 - 1 ];
    hoisted_13_1 := deduped_33_1;
    hoisted_12_1 := [ deduped_36_1[3], deduped_36_1[4] ];
    hoisted_4_1 := deduped_24_1;
    hoisted_3_1 := deduped_25_1;
    hoisted_6_1 := List( [ 1 .. deduped_29_1 + deduped_28_1 ], function ( logic_new_func_x_2 )
    ...
    hoisted_22_1 := Concatenation( List( deduped_27_1, function ( logic_new_func_x_2 )
              ...
              hoisted_6_2 := List( hoisted_21_1, function ( i_3 )
                      ...
                      hoisted_3_3 := List( hoisted_14_1, function ( i_4 )
                              return hoisted_20_1[1 + hoisted_2_3[(1 + i_4)]];
                          end );
              ...
              hoisted_3_2 := List( hoisted_16_1, function ( i_3 )
                      ...
                      hoisted_2_3 := List( hoisted_14_1, function ( i_4 )
                              return hoisted_1_3[1 + hoisted_14_1[(1 + i_4)]];
                          end );
                      hoisted_3_3 := List( hoisted_14_1, function ( i_4 )
    ...
    hoisted_10_1 := [ 1 .. deduped_26_1 ];
    hoisted_5_1 := deduped_29_1;
    hoisted_8_1 := Concatenation( List( deduped_27_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_3_1[hoisted_5_1 + logic_new_func_x_2];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    hoisted_9_1 := List( [ 0 .. deduped_26_1 - 1 ], function ( j_2 )
            return Product( hoisted_8_1{[ 1 .. j_2 ]} );
        end );
    hoisted_23_1 := List( deduped_24_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + i_2;
            return Sum( hoisted_10_1, function ( j_3 )
                    return hoisted_22_1[j_3][hoisted_1_2] * hoisted_9_1[j_3];
                end );
        end );
    hoisted_7_1 := Concatenation( List( deduped_27_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_6_1[hoisted_5_1 + logic_new_func_x_2];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    hoisted_11_1 := List( deduped_24_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + i_2;
            return Sum( hoisted_10_1, function ( j_3 )
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Length, Length( Filtered( [ 0 .. Length( deduped_24_1 ) - 1 ], function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := 1 + x_2;
                return hoisted_11_1[deduped_1_2] = hoisted_23_1[deduped_1_2];
            end ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1, arg4_1 )
    ...
    deduped_48_1 := DefiningQuadrupleOfQuiver( arg3_1 );
    deduped_47_1 := DefiningPairOfUnderlyingQuiver( cat_1 );
    deduped_46_1 := DefiningQuadrupleOfQuiver( arg2_1 );
    deduped_45_1 := Length( Source( arg4_1 ) );
    ...
    deduped_38_1 := [ 1 .. Length( SetOfObjects( cat_1 ) ) ];
    deduped_37_1 := Length( deduped_41_1 );
    deduped_36_1 := [ 1 .. deduped_37_1 ];
    deduped_35_1 := deduped_37_1 * 2;
    hoisted_3_1 := [ deduped_43_1, deduped_44_1 ];
    hoisted_1_1 := [ deduped_39_1, deduped_40_1 ];
    deduped_34_1 := Concatenation( List( [ 1 .. deduped_42_1 ], function ( logic_new_func_x_2 )
              return hoisted_3_1[logic_new_func_x_2] ^ hoisted_1_1[logic_new_func_x_2];
          end ), ListWithIdenticalEntries( deduped_37_1, deduped_43_1 ^ deduped_40_1 ) );
    deduped_33_1 := [ 0 .. Product( deduped_34_1 ) - 1 ];
    hoisted_22_1 := [ 0 .. deduped_43_1 ^ deduped_39_1 - 1 ];
    hoisted_21_1 := [ 0 .. deduped_43_1 - 1 ];
    hoisted_20_1 := [ deduped_46_1[3], deduped_46_1[4] ];
    hoisted_19_1 := [ 0 .. deduped_39_1 - 1 ];
    hoisted_18_1 := deduped_41_1;
    hoisted_17_1 := [ 0 .. deduped_44_1 ^ deduped_40_1 - 1 ];
    hoisted_16_1 := deduped_43_1;
    hoisted_15_1 := [ 0 .. deduped_40_1 - 1 ];
    hoisted_14_1 := deduped_44_1;
    hoisted_13_1 := [ deduped_48_1[3], deduped_48_1[4] ];
    hoisted_5_1 := deduped_33_1;
    hoisted_4_1 := deduped_34_1;
    hoisted_7_1 := List( [ 1 .. deduped_42_1 + deduped_37_1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
    ...
    hoisted_23_1 := Concatenation( List( deduped_36_1, function ( logic_new_func_x_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, deduped_7_2;
              deduped_7_2 := hoisted_18_1[logic_new_func_x_2];
              hoisted_4_2 := hoisted_20_1[logic_new_func_x_2];
              hoisted_6_2 := List( hoisted_22_1, function ( i_3 )
                      local hoisted_1_3, hoisted_2_3, hoisted_3_3;
                      ...
                      hoisted_3_3 := List( hoisted_15_1, function ( i_4 )
                              return hoisted_21_1[1 + hoisted_2_3[(1 + i_4)]];
                          end );
              ...
              hoisted_3_2 := List( hoisted_17_1, function ( i_3 )
                      ...
                      hoisted_2_3 := List( hoisted_15_1, function ( i_4 )
                              return hoisted_1_3[1 + hoisted_15_1[(1 + i_4)]];
                          end );
                      hoisted_3_3 := List( hoisted_15_1, function ( i_4 )
                              return hoisted_1_2[1 + hoisted_2_3[(1 + i_4)]];
                          end );
    ...
    hoisted_11_1 := [ 1 .. deduped_35_1 ];
    hoisted_6_1 := deduped_42_1;
    hoisted_9_1 := Concatenation( List( deduped_36_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_4_1[hoisted_6_1 + logic_new_func_x_2];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    hoisted_10_1 := List( [ 0 .. deduped_35_1 - 1 ], function ( j_2 )
    ...
    hoisted_24_1 := List( deduped_33_1, function ( i_2 )
            ...
            return Sum( hoisted_11_1, function ( j_3 )
                    return hoisted_23_1[j_3][hoisted_1_2] * hoisted_10_1[j_3];
                end );
        end );
    hoisted_8_1 := Concatenation( List( deduped_36_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
    ...
    deduped_31_1 := Filtered( [ 0 .. Length( deduped_33_1 ) - 1 ], function ( x_2 )
            local deduped_1_2;
            deduped_1_2 := 1 + x_2;
            return hoisted_12_1[deduped_1_2] = hoisted_24_1[deduped_1_2];
        end );
    hoisted_30_1 := List( deduped_38_1, function ( logic_new_func_x_2 )
            return hoisted_4_1[logic_new_func_x_2];
        end );
    hoisted_28_1 := [ 0 .. deduped_45_1 - 1 ];
    hoisted_27_1 := AsList( arg4_1 );
    hoisted_26_1 := [ 0 .. Length( deduped_31_1 ) - 1 ];
    hoisted_25_1 := deduped_31_1;
    hoisted_29_1 := List( deduped_38_1, function ( logic_new_func_x_2 )
            ...
            hoisted_4_2 := List( hoisted_26_1, function ( i_3 )
                    return hoisted_3_2[1 + hoisted_25_1[(1 + i_3)]];
                end );
            return List( hoisted_28_1, function ( i_3 )
                    return hoisted_4_2[1 + hoisted_27_1[(1 + i_3)]];
                end );
        end );
    hoisted_2_1 := deduped_45_1;
    deduped_32_1 := List( deduped_38_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, hoisted_7_2, hoisted_8_2, hoisted_9_2, hoisted_10_2, hoisted_11_2, hoisted_12_2, hoisted_13_2, deduped_14_2, deduped_15_2, deduped_16_2, deduped_17_2, deduped_18_2;
            deduped_18_2 := hoisted_3_1[logic_new_func_x_2];
            deduped_17_2 := hoisted_1_1[logic_new_func_x_2];
            deduped_16_2 := deduped_18_2 ^ deduped_17_2;
            deduped_15_2 := [ 0 .. deduped_17_2 - 1 ];
            deduped_14_2 := [ 0 .. hoisted_2_1 * deduped_17_2 - 1 ];
            ...
            hoisted_10_2 := hoisted_30_1[logic_new_func_x_2];
            ...
            hoisted_9_2 := List( deduped_14_2, function ( i_3 )
            ...
            hoisted_5_2 := List( deduped_14_2, function ( i_3 )
                    return hoisted_4_2[1 + hoisted_3_2[(1 + i_3)]];
                end );
            hoisted_11_2 := List( deduped_14_2, function ( i_3 )
                    local deduped_1_3;
                    deduped_1_3 := 1 + i_3;
                    return hoisted_5_2[deduped_1_3] + hoisted_9_2[deduped_1_3] * hoisted_10_2;
                end );
            hoisted_13_2 := List( deduped_14_2, function ( i_3 )
                    return hoisted_12_2[1 + hoisted_11_2[(1 + i_3)]];
                end );
            return List( deduped_15_2, function ( i_3 )
                    return hoisted_13_2[1 + hoisted_8_2[(1 + i_3)]];
                end );
        end );
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_47_1 := DefiningQuadrupleOfQuiver( arg2_1 );
    deduped_46_1 := DefiningQuadrupleOfQuiver( arg3_1 );
    ...
    deduped_38_1 := [ 1 .. Length( SetOfObjects( cat_1 ) ) ];
    deduped_37_1 := Length( deduped_40_1 );
    deduped_36_1 := [ 1 .. deduped_37_1 ];
    deduped_35_1 := deduped_37_1 * 2;
    hoisted_2_1 := [ deduped_44_1, deduped_42_1 ];
    hoisted_1_1 := [ deduped_41_1, deduped_43_1 ];
    deduped_34_1 := Concatenation( List( [ 1 .. deduped_39_1 ], function ( logic_new_func_x_2 )
              return hoisted_1_1[logic_new_func_x_2] ^ hoisted_2_1[logic_new_func_x_2];
          end ), ListWithIdenticalEntries( deduped_37_1, deduped_41_1 ^ deduped_42_1 ) );
    deduped_33_1 := [ 0 .. Product( deduped_34_1 ) - 1 ];
    hoisted_21_1 := [ 0 .. deduped_41_1 ^ deduped_44_1 - 1 ];
    hoisted_20_1 := [ 0 .. deduped_41_1 - 1 ];
    hoisted_19_1 := [ deduped_47_1[3], deduped_47_1[4] ];
    hoisted_18_1 := [ 0 .. deduped_44_1 - 1 ];
    hoisted_17_1 := deduped_40_1;
    hoisted_16_1 := [ 0 .. deduped_43_1 ^ deduped_42_1 - 1 ];
    hoisted_15_1 := deduped_41_1;
    hoisted_14_1 := [ 0 .. deduped_42_1 - 1 ];
    hoisted_13_1 := deduped_43_1;
    hoisted_12_1 := [ deduped_46_1[3], deduped_46_1[4] ];
    hoisted_4_1 := deduped_33_1;
    hoisted_3_1 := deduped_34_1;
    hoisted_6_1 := List( [ 1 .. deduped_39_1 + deduped_37_1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_2_2 := hoisted_3_1[logic_new_func_x_2];
            hoisted_1_2 := Product( hoisted_3_1{[ 1 .. logic_new_func_x_2 - 1 ]} );
            return List( hoisted_4_1, function ( i_3 )
    ...
    hoisted_22_1 := Concatenation( List( deduped_36_1, function ( logic_new_func_x_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, deduped_7_2;
              deduped_7_2 := hoisted_17_1[logic_new_func_x_2];
              hoisted_4_2 := hoisted_19_1[logic_new_func_x_2];
              hoisted_6_2 := List( hoisted_21_1, function ( i_3 )
    ...
    hoisted_9_1 := List( [ 0 .. deduped_35_1 - 1 ], function ( j_2 )
            return Product( hoisted_8_1{[ 1 .. j_2 ]} );
        end );
    ...
    hoisted_7_1 := Concatenation( List( deduped_36_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_6_1[hoisted_5_1 + logic_new_func_x_2];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    hoisted_11_1 := List( deduped_33_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + i_2;
            return Sum( hoisted_10_1, function ( j_3 )
                    return hoisted_7_1[j_3][hoisted_1_2] * hoisted_9_1[j_3];
    ...
    deduped_32_1 := Filtered( [ 0 .. Length( deduped_33_1 ) - 1 ], function ( x_2 )
            local deduped_1_2;
            deduped_1_2 := 1 + x_2;
            return hoisted_11_1[deduped_1_2] = hoisted_23_1[deduped_1_2];
        end );
    ...
    hoisted_26_1 := deduped_30_1;
    hoisted_24_1 := deduped_31_1;
    hoisted_25_1 := List( deduped_30_1, function ( i_2 )
    ...
    return List( deduped_30_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            hoisted_1_2 := hoisted_4_1[1 + hoisted_27_1[(1 + hoisted_26_1[(1 + hoisted_25_1[(1 + logic_new_func_x_2)])])]];
            hoisted_2_2 := List( hoisted_28_1, function ( logic_new_func_x_3 )
            ...
            deduped_3_2 := List( hoisted_28_1, function ( logic_new_func_x_3 )
                    local hoisted_1_3, hoisted_2_3, hoisted_3_3, hoisted_4_3, hoisted_5_3, hoisted_6_3, hoisted_7_3, hoisted_8_3, hoisted_9_3, hoisted_10_3, hoisted_11_3, deduped_12_3, deduped_13_3, deduped_14_3, deduped_15_3;
                    deduped_15_3 := hoisted_1_1[logic_new_func_x_3];
                    deduped_14_3 := hoisted_2_1[logic_new_func_x_3];
                    deduped_13_3 := deduped_15_3 ^ deduped_14_3;
                    deduped_12_3 := [ 0 .. deduped_14_3 - 1 ];
                    hoisted_2_3 := deduped_15_3;
                    hoisted_1_3 := deduped_13_3;
                    hoisted_10_3 := List( [ 0 .. deduped_13_3 * deduped_14_3 - 1 ], function ( i_4 )
                            return REM_INT( QUO_INT( i_4, hoisted_2_3 ^ QUO_INT( i_4, hoisted_1_3 ) ), hoisted_2_3 );
                        end );
                    hoisted_8_3 := hoisted_2_2[logic_new_func_x_3][1];
                    hoisted_7_3 := hoisted_29_1[logic_new_func_x_3];
                    hoisted_5_3 := deduped_12_3;
                    hoisted_3_3 := deduped_14_3;
                    hoisted_4_3 := List( deduped_12_3, function ( i_4 )
                            return REM_INT( i_4, hoisted_3_3 );
                        end );
                    hoisted_6_3 := List( deduped_12_3, function ( i_4 )
                            return hoisted_5_3[1 + hoisted_4_3[(1 + i_4)]];
                        end );
                    hoisted_9_3 := List( deduped_12_3, function ( i_4 )
                            return hoisted_8_3 + hoisted_6_3[(1 + i_4)] * hoisted_7_3;
                        end );
                    hoisted_11_3 := List( deduped_12_3, function ( i_4 )
                            return hoisted_10_3[1 + hoisted_9_3[(1 + i_4)]];
                        end );
                    return List( deduped_12_3, function ( i_4 )
                            return hoisted_11_3[1 + hoisted_5_3[(1 + i_4)]];
                        end );
                end );
