...
#! PosetOfCategory( SliceCategoryOverTensorUnit( Rows( Q[x,y] ) ) ):
#! 
#! 16 primitive operations were used to derive 261 operations for this category
...
#! SliceCategoryOverTensorUnit( Rows( Q[x,y] ) ) ) ):
#! 
#! 15 primitive operations were used to derive 313 operations for this category
#! which algorithmically
#! * IsEquippedWithHomomorphismStructure
#! * IsHeytingAlgebra
#! * IsClosedMonoidalLattice
