  ...
  function( CAP_NAMED_ARGUMENTS, B )
    ...
    AddIsWellDefinedForObjects( MonB,
      function( MonB, monoid )
        ...
        return IsEqualForObjects( B, Source( unit ), TensorUnit( B ) ) and
               ...
               IsWellDefinedForObjects( B, object ) and
                            ...
                            [ AssociatorRightToLeft( B,
                              ...
                              TensorProductOnMorphisms( B,
                                    TensorProductOnMorphisms( B,
                                            IdentityMorphism( B,
                                                    object1 ),
                                            Braiding( B, ## we need the symmetric braiding here
                                                    object2,
                                                    object1 ) ),
                                    IdentityMorphism( B,
                                            object2 ) ),
...
InstallMethod( FullMatrixAlgebraAsInternalMonoid,
  ...
  function( n, MonB )
    ...
    Assert( 0, HasIsLinearCategoryOverCommutativeRing( B ) and IsLinearCategoryOverCommutativeRing( B ) and HasCommutativeSemiringOfLinearCategory( B ) );
    
    U := TensorUnit( B );
    V := n^2 / B;
    V2 := TensorProduct( V, V );
    
    k := CommutativeSemiringOfLinearCategory( B );
    ...
    mult := UnionOfRows( k, n^2, Concatenation( mult ) );;
...
InstallMethod( FullMatrixAlgebraAsInternalMonoid,
        ...
        [ IsInt, IsCapCategory and IsLinearCategoryOverCommutativeRing and HasCommutativeSemiringOfLinearCategory ],
...
InstallMethod( Counit,
        ...
        [ IsCapCategory and IsLinearCategoryOverCommutativeRing and HasCommutativeSemiringOfLinearCategory, IsRecord ],
...
InstallMethod( Comultiplication,
        "for a f.p. linear category on one object and a record",
        [ IsCapCategory and IsLinearCategoryOverCommutativeRing and HasCommutativeSemiringOfLinearCategory and HasRangeCategoryOfHomomorphismStructure, IsRecord ],
