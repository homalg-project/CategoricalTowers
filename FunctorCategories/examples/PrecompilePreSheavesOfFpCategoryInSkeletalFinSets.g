...
#! # CI_SINGLE_JOB_ID:PreSheavesOfFreeCategoryInSkeletalFinSetsPrecompiled
...
compiled_category_name := "PreSheavesOfFreeCategoryInSkeletalFinSetsPrecompiled";;
...
PreSheavesOfFreeCategoryInSkeletalFinSetsPrecompiled( given_arguments[1] );
