...
function ( cat_1, a_1, b_1 )
    ...
    deduped_92_1 := [  ];
    deduped_91_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_90_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( b_1 );
    deduped_89_1 := UnderlyingCategory( cat_1 );
    deduped_88_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( a_1 );
    deduped_87_1 := deduped_90_1[3];
    deduped_86_1 := deduped_88_1[3];
    deduped_85_1 := deduped_90_1[2];
    deduped_84_1 := deduped_90_1[1];
    deduped_83_1 := CreateCapCategoryObjectWithAttributes( deduped_89_1, IndexOfObject, 1 );
    deduped_82_1 := deduped_88_1[2];
    deduped_81_1 := CreateCapCategoryObjectWithAttributes( deduped_89_1, IndexOfObject, 0 );
    deduped_80_1 := deduped_88_1[1];
    deduped_79_1 := CreateCapCategoryObjectWithAttributes( deduped_91_1, Length, deduped_80_1 );
    deduped_78_1 := CreateCapCategoryMorphismWithAttributes( deduped_89_1, deduped_81_1, deduped_83_1, IndexOfMorphism, 2 );
    deduped_77_1 := CreateCapCategoryMorphismWithAttributes( deduped_89_1, deduped_81_1, deduped_83_1, IndexOfMorphism, 1 );
    deduped_76_1 := ListWithIdenticalEntries( deduped_82_1, deduped_83_1 );
    deduped_75_1 := 2 * deduped_80_1;
    deduped_74_1 := ListWithIdenticalEntries( deduped_80_1, deduped_81_1 );
    deduped_73_1 := [ 0 .. deduped_80_1 - 1 ];
    deduped_72_1 := [ 0 .. deduped_82_1 - 1 ];
    deduped_71_1 := CreateCapCategoryMorphismWithAttributes( deduped_91_1, CreateCapCategoryObjectWithAttributes( deduped_91_1, Length, 0 ), CreateCapCategoryObjectWithAttributes( deduped_91_1, Length, deduped_82_1 ), AsList, deduped_92_1 );
    deduped_70_1 := CreateCapCategoryObjectWithAttributes( deduped_91_1, Length, deduped_75_1 );
    deduped_69_1 := ListWithIdenticalEntries( deduped_75_1, deduped_81_1 );
    deduped_68_1 := [ 0 .. deduped_82_1 + deduped_82_1 - 1 ];
    deduped_2_1 := [ deduped_84_1, deduped_85_1 ];
    deduped_1_1 := [ deduped_81_1, deduped_83_1 ];
    deduped_66_1 := Concatenation( List( deduped_69_1, function ( objB_2 )
          ...
          end ), List( deduped_76_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_67_1 := List( deduped_72_1, function ( i_2 )
            ...
            deduped_3_2 := 1 + (i_2 + deduped_75_1);
    ...
    deduped_36_1 := List( deduped_73_1, function ( i_2 )
            return REM_INT( QUO_INT( i_2, 1 ), deduped_80_1 );
        end );
    deduped_64_1 := ListOfValues( [ CreateCapCategoryMorphismWithAttributes( deduped_91_1, deduped_79_1, deduped_70_1, AsList, List( deduped_73_1, function ( i_2 )
                    return deduped_36_1[(1 + i_2)] * 2;
                end ) ), deduped_71_1 ] );
    deduped_62_1 := ListOfValues( [ CreateCapCategoryMorphismWithAttributes( deduped_91_1, deduped_79_1, deduped_70_1, AsList, List( deduped_73_1, function ( i_2 )
    ...
    deduped_13_1 := [ List( deduped_87_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_87_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_12_1 := [ deduped_77_1, deduped_78_1 ];
    deduped_11_1 := [ 0, 1, 2, 3 ];
    deduped_10_1 := [ 0, 1, 1, 1 ];
    deduped_9_1 := [ 0, 0, 0, 1 ];
    deduped_8_1 := [ 0, 3 ];
    hoisted_24_1 := Concatenation( List( ListWithIdenticalEntries( deduped_82_1, deduped_77_1 ), function ( morB_2 )
              ...
              return;
          end ), List( ListWithIdenticalEntries( deduped_82_1, deduped_78_1 ), function ( morB_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 := IndexOfMorphism( morB_2 );
              deduped_6_2 := IndexOfObject( Range( morB_2 ) );
              deduped_5_2 := IndexOfObject( Source( morB_2 ) );
    ...
    hoisted_14_1 := List( deduped_86_1, function ( a_2 )
            return a_2[2];
        end );
    deduped_15_1 := List( deduped_72_1, function ( i_2 )
            return 1 + CAP_JIT_INCOMPLETE_LOGIC( hoisted_14_1[(1 + REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_2 ), 1 ), deduped_82_1 ))] ) * 2;
        end );
    deduped_7_1 := Concatenation( List( deduped_69_1, IndexOfObject ), List( deduped_76_1, IndexOfObject ) );
    hoisted_5_1 := List( deduped_86_1, function ( a_2 )
            return a_2[1];
        end );
    deduped_6_1 := List( deduped_72_1, function ( i_2 )
            return CAP_JIT_INCOMPLETE_LOGIC( hoisted_5_1[(1 + REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_2 ), 1 ), deduped_82_1 ))] ) * 2;
        end );
    ...
    hoisted_28_1 := [ [ 0 .. deduped_84_1 - 1 ], [ 0 .. deduped_85_1 - 1 ] ];
    ...
    hoisted_32_1 := List( [ 1 .. deduped_80_1 ], function ( i_2 )
