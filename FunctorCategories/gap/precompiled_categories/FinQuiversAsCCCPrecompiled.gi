...
function ( cat_1, a_1, b_1 )
    ...
    deduped_69_1 := CreateCapCategoryMorphismWithAttributes( deduped_89_1, CreateCapCategoryObjectWithAttributes( deduped_89_1, Length, 0 ), CreateCapCategoryObjectWithAttributes( deduped_89_1, Length, deduped_80_1 ), AsList, deduped_90_1 );
    ...
    deduped_65_1 := ListOfValues( [ CreateCapCategoryMorphismWithAttributes( deduped_89_1, deduped_77_1, deduped_68_1, AsList, List( deduped_71_1, function ( i_2 )
                    return 1 + i_2 * 2;
                end ) ), deduped_69_1 ] );
    ...
    deduped_62_1 := Concatenation( List( deduped_67_1, function ( objB_2 )
              local hoisted_1_2;
    ...
    deduped_60_1 := Product( deduped_62_1 );
    deduped_56_1 := [ 0 .. deduped_60_1 - 1 ];
    deduped_63_1 := List( deduped_70_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := 1 + (i_2 + deduped_73_1);
            hoisted_2_2 := deduped_62_1[deduped_3_2];
            hoisted_1_2 := Product( deduped_62_1{[ 1 .. deduped_3_2 - 1 ]} );
            return List( deduped_56_1, function ( i_3 )
                    return REM_INT( QUO_INT( i_3, hoisted_1_2 ), hoisted_2_2 );
                end );
        end );
    deduped_61_1 := Concatenation( List( deduped_72_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_59_1 := [ 1 .. Length( deduped_65_1 ) ];
    deduped_58_1 := [ 1 .. Length( deduped_64_1 ) ];
    deduped_57_1 := ListWithIdenticalEntries( Length( deduped_70_1 ), deduped_60_1 );
    deduped_55_1 := [ 0 .. Product( deduped_61_1 ) - 1 ];
    hoisted_26_1 := Concatenation( deduped_63_1, deduped_63_1 );
    ...
    deduped_3_1 := Concatenation( deduped_57_1, deduped_57_1 );
    ...
    deduped_52_1 := Length( deduped_54_1 );
    deduped_48_1 := List( deduped_65_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    deduped_46_1 := List( deduped_65_1, function ( logic_new_func_x_2 )
    ...
    hoisted_50_1 := Concatenation( List( deduped_59_1, function ( i_2 )
              ...
              return List( [ 0 .. deduped_46_1[i_2] - 1 ], function ( i_3 )
                      ...
                      hoisted_2_3 := deduped_62_1[deduped_3_3];
                      hoisted_1_3 := Product( deduped_62_1{[ 1 .. deduped_3_3 - 1 ]} );
                      return List( deduped_56_1, function ( i_4 )
    ...
    deduped_38_1 := Concatenation( List( deduped_72_1, function ( objB_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2, deduped_8_2;
    ...
    deduped_33_1 := List( deduped_71_1, function ( j_2 )
            return Product( deduped_61_1{[ 1 .. j_2 ]} );
        end );
    hoisted_28_1 := [ [ 0 .. deduped_82_1 - 1 ], [ 0 .. deduped_83_1 - 1 ] ];
    hoisted_29_1 := Concatenation( List( deduped_72_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
    ...
    hoisted_32_1 := List( [ 1 .. deduped_78_1 ], function ( i_2 )
            ...
            hoisted_2_2 := deduped_61_1[i_2];
            hoisted_1_2 := Product( deduped_61_1{[ 1 .. i_2 - 1 ]} );
            return List( deduped_55_1, function ( i_3 )
                    return hoisted_3_2[1 + REM_INT( QUO_INT( i_3, hoisted_1_2 ), hoisted_2_2 )];
                end );
        end );
    deduped_44_1 := List( deduped_55_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + i_2;
    ...
    deduped_39_1 := List( deduped_64_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    deduped_35_1 := List( deduped_64_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningTripleOfQuiverEnrichedOverSkeletalFinSets, NTuple( 3, Length( deduped_53_1 ), deduped_52_1, List( [ 0 .. deduped_52_1 - 1 ], function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := 1 + CAP_JIT_INCOMPLETE_LOGIC( deduped_54_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 ))] );
                return NTuple( 2, -1 + BigInt( SafePosition( deduped_53_1, CAP_JIT_INCOMPLETE_LOGIC( deduped_44_1[(1 + Sum( deduped_71_1, function ( j_3 )
                                     local deduped_1_3;
                                     deduped_1_3 := (1 + j_3);
                                     return hoisted_42_1[deduped_1_3][deduped_1_2] * deduped_33_1[deduped_1_3];
                                 end ))] ) ) ), -1 + BigInt( SafePosition( deduped_53_1, CAP_JIT_INCOMPLETE_LOGIC( deduped_44_1[(1 + Sum( deduped_71_1, function ( j_3 )
                                     local deduped_1_3;
                                     deduped_1_3 := (1 + j_3);
