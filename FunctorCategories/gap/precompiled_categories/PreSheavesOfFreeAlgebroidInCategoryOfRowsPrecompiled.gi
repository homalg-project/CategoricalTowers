...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_21_1 := List( [ 1 .. Length( deduped_35_1 ) ], function ( i_2 )
            ...
            hoisted_1_2 := deduped_26_1 * UnionOfRows( HomalgZeroMatrix( Sum( deduped_11_1{[ 1 .. (i_2 - 1) ]} ), deduped_2_2, deduped_37_1 ), HomalgIdentityMatrix( deduped_2_2, deduped_37_1 ), HomalgZeroMatrix( Sum( deduped_11_1{[ (i_2 + 1) .. deduped_30_1 ]} ), deduped_2_2, deduped_37_1 ) );
...
function ( cat_1 )
    ...
    hoisted_3_1 := HomalgIdentityMatrix( 0, CommutativeRingOfLinearCategory( cat_1 ) );
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    hoisted_18_1 := List( deduped_21_1, function ( i_2 )
            ...
            return hoisted_17_1 * UnionOfRows( HomalgZeroMatrix( Sum( deduped_13_1{[ 1 .. (i_2 - 1) ]} ), deduped_1_2, deduped_33_1 ), HomalgIdentityMatrix( deduped_1_2, deduped_33_1 ), HomalgZeroMatrix( Sum( deduped_13_1{[ (i_2 + 1) .. deduped_23_1 ]} ), deduped_1_2, deduped_33_1 ) );
        end );
...
function ( cat_1, s_1, a_1, L_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfColumns( deduped_4_1, hoisted_2_1[o_2], List( hoisted_6_1, function ( i_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[i_3];
                        return KroneckerMat( hoisted_2_2, UnionOfRows( HomalgZeroMatrix( Sum( deduped_1_2{[ 1 .. i_3 - 1 ]} ), deduped_1_3, deduped_4_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_4_1 ), HomalgZeroMatrix( Sum( deduped_1_2{[ i_3 + 1 .. deduped_9_1 ]} ), deduped_1_3, deduped_4_1 ) ) );
                    end ) );
...
function ( cat_1, s_1, a_1, L_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfRows( deduped_3_1, hoisted_1_1[o_2], List( hoisted_5_1, function ( i_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[i_3];
                        return KroneckerMat( hoisted_2_2, UnionOfColumns( HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ 1 .. i_3 - 1 ]} ), deduped_3_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_3_1 ), HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ i_3 + 1 .. deduped_9_1 ]} ), deduped_3_1 ) ) );
                    end ) );
...
function ( cat_1, morphisms_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, CAP_JIT_INCOMPLETE_LOGIC( Source( deduped_8_1 ) ), P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_5_2 := List( hoisted_4_1, function ( i_3 )
                      local deduped_1_3;
                      deduped_1_3 := deduped_6_2[i_3];
                      return deduped_7_2[i_3] * UnionOfColumns( HomalgZeroMatrix( deduped_1_3, Sum( deduped_6_2{[ 1 .. (i_3 - 1) ]} ), deduped_2_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_2_1 ), HomalgZeroMatrix( deduped_1_3, Sum( deduped_6_2{[ (i_3 + 1) .. deduped_9_1 ]} ), deduped_2_1 ) );
                  end );
...
function ( cat_1, s_1, L_1, a_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfColumns( deduped_3_1, hoisted_2_1[o_2], List( hoisted_6_1, function ( i_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[i_3];
                        return KroneckerMat( UnionOfRows( HomalgZeroMatrix( Sum( deduped_1_2{[ 1 .. i_3 - 1 ]} ), deduped_1_3, deduped_3_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_3_1 ), HomalgZeroMatrix( Sum( deduped_1_2{[ i_3 + 1 .. deduped_9_1 ]} ), deduped_1_3, deduped_3_1 ) ), hoisted_2_2 );
                    end ) );
              return CreateCapCategoryMorphismWithAttributes( deduped_7_1, deduped_8_1[o_2], CreateCapCategoryObjectWithAttributes( deduped_7_1, RankOfObject, NumberColumns( deduped_3_2 ) ), UnderlyingMatrix, deduped_3_2 );
          end ) );
end
...
function ( cat_1, s_1, L_1, a_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfRows( deduped_2_1, hoisted_1_1[o_2], List( hoisted_5_1, function ( i_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[i_3];
                        return KroneckerMat( UnionOfColumns( HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ 1 .. i_3 - 1 ]} ), deduped_2_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_2_1 ), HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ i_3 + 1 .. deduped_9_1 ]} ), deduped_2_1 ) ), hoisted_2_2 );
                    end ) );
              return CreateCapCategoryMorphismWithAttributes( deduped_6_1, CreateCapCategoryObjectWithAttributes( deduped_6_1, RankOfObject, NumberRows( deduped_3_2 ) ), deduped_8_1[o_2], UnderlyingMatrix, deduped_3_2 );
          end ) );
end
...
function ( cat_1 )
    ...
    deduped_5_1 := Source( cat_1 );
    deduped_4_1 := DefiningTripleOfUnderlyingQuiver( deduped_5_1 );
    hoisted_3_1 := HomalgIdentityMatrix( 1, CommutativeRingOfLinearCategory( cat_1 ) );
...
function ( cat_1 )
    ...
    deduped_5_1 := Source( cat_1 );
    deduped_4_1 := DefiningTripleOfUnderlyingQuiver( deduped_5_1 );
    hoisted_3_1 := HomalgZeroMatrix( 0, 0, CommutativeRingOfLinearCategory( cat_1 ) );
    deduped_1_1 := CreateCapCategoryObjectWithAttributes( deduped_6_1, RankOfObject, 0 );
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_5_1, Target, deduped_6_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_4_1[1] ], function ( o_2 )
                return deduped_1_1;
            end ), LazyHList( [ 1 .. deduped_4_1[2] ], function ( m_2 )
