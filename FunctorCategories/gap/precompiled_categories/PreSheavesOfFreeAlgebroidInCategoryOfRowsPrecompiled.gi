...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_17_1 := List( deduped_29_1, function ( logic_new_func_x_2 )
    ...
    hoisted_21_1 := List( [ 1 .. Length( deduped_36_1 ) ], function ( logic_new_func_x_2 )
            ...
            hoisted_1_2 := deduped_26_1 * UnionOfRows( HomalgZeroMatrix( Sum( deduped_17_1{[ 1 .. (logic_new_func_x_2 - 1) ]} ), deduped_2_2, deduped_31_1 ), HomalgIdentityMatrix( deduped_2_2, deduped_31_1 ), HomalgZeroMatrix( Sum( deduped_17_1{[ (logic_new_func_x_2 + 1) .. deduped_30_1 ]} ), deduped_2_2, deduped_31_1 ) );
            return List( deduped_24_1, function ( logic_new_func_x_3 )
                    return ConvertRowToMatrix( CertainRows( hoisted_15_1, [ logic_new_func_x_3 ] ), 1, deduped_25_1 ) * hoisted_1_2;
                end );
        end );
...
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( deduped_5_1, hoisted_1_1[o_2], hoisted_2_1[o_2], UnderlyingMatrix, DiagMat( hoisted_3_1, List( L_1, function ( logic_new_func_x_3 )
                          return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                      end ) ) );
          end ) );
end
...
########
function ( cat_1, arg2_1, arg3_1 )
    local deduped_1_1, deduped_2_1, hoisted_3_1, hoisted_4_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_10_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1, deduped_18_1, deduped_19_1, deduped_20_1, deduped_21_1, deduped_22_1, deduped_23_1, deduped_24_1;
    ...
    hoisted_7_1 := List( deduped_18_1, Range );
    hoisted_6_1 := List( deduped_18_1, Source );
    deduped_2_1 := List( deduped_24_1[1], RankOfObject );
    deduped_1_1 := List( deduped_23_1[1], RankOfObject );
    return CreateCapCategoryObjectWithAttributes( deduped_21_1, RankOfObject, Sum( List( deduped_14_1, function ( logic_new_func_x_2 )
                  return deduped_1_1[logic_new_func_x_2] * deduped_2_1[logic_new_func_x_2];
                    ...
                    hoisted_4_2 := deduped_1_1[deduped_7_2] * deduped_2_1[deduped_7_2];
                    hoisted_3_2 := TransposedMatrix( HomalgIdentityMatrix( deduped_5_2, deduped_17_1 ) );
                    hoisted_2_2 := HomalgIdentityMatrix( deduped_6_2, deduped_17_1 );
                    deduped_1_2 := deduped_16_1[logic_new_func_x_2];
                    return UnionOfColumns( deduped_17_1, deduped_5_2 * deduped_6_2, List( deduped_15_1, function ( logic_new_func_x_3 )
                              local deduped_1_3, deduped_2_3, deduped_3_3, deduped_4_3;
                              deduped_4_3 := (deduped_1_2 = hoisted_7_1[logic_new_func_x_3]);
                              deduped_3_3 := (deduped_1_2 = hoisted_6_1[logic_new_func_x_3]);
                              deduped_2_3 := KroneckerMat( hoisted_8_1[logic_new_func_x_3], hoisted_2_2 );
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_7_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_8_1, hoisted_1_1[o_2], hoisted_2_1[o_2], UnderlyingMatrix, UnionOfColumns( HomalgZeroMatrix( deduped_1_2, Sum( deduped_2_2{hoisted_3_1} ), deduped_4_1 ), HomalgIdentityMatrix( deduped_1_2, deduped_4_1 ), HomalgZeroMatrix( deduped_1_2, Sum( deduped_2_2{hoisted_5_1} ), deduped_4_1 ) ) );
          end ) );
end
########
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    hoisted_17_1 := UnderlyingMatrix( alpha_1 ) * SyzygiesOfRows( UnionOfRows( deduped_30_1, Sum( deduped_20_1 ), List( deduped_21_1, function ( logic_new_func_x_2 )
                  ...
                  hoisted_4_2 := (deduped_5_1[deduped_7_2] * deduped_6_1[deduped_7_2]);
    ...
    deduped_15_1 := List( deduped_21_1, function ( logic_new_func_x_2 )
    ...
    hoisted_18_1 := List( deduped_21_1, function ( logic_new_func_x_2 )
            ...
            deduped_1_2 := deduped_5_1[deduped_2_2] * deduped_6_1[deduped_2_2];
            return hoisted_17_1 * UnionOfRows( HomalgZeroMatrix( Sum( deduped_15_1{[ 1 .. (logic_new_func_x_2 - 1) ]} ), deduped_1_2, deduped_30_1 ), HomalgIdentityMatrix( deduped_1_2, deduped_30_1 ), HomalgZeroMatrix( Sum( deduped_15_1{[ (logic_new_func_x_2 + 1) .. deduped_23_1 ]} ), deduped_1_2, deduped_30_1 ) );
        end );
...
function ( cat_1, s_1, a_1, L_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_1_2 := List( L_1, function ( logic_new_func_x_3 )
                      return RankOfObject( CAP_JIT_INCOMPLETE_LOGIC( ValuesOfPreSheaf( logic_new_func_x_3 )[1][o_2] ) );
                  end );
              deduped_3_2 := UnionOfColumns( deduped_4_1, hoisted_2_1[o_2], List( hoisted_6_1, function ( logic_new_func_x_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[logic_new_func_x_3];
                        return KroneckerMat( hoisted_2_2, UnionOfRows( HomalgZeroMatrix( Sum( deduped_1_2{[ 1 .. logic_new_func_x_3 - 1 ]} ), deduped_1_3, deduped_4_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_4_1 ), HomalgZeroMatrix( Sum( deduped_1_2{[ logic_new_func_x_3 + 1 .. deduped_10_1 ]} ), deduped_1_3, deduped_4_1 ) ) );
                    end ) );
...
function ( cat_1, s_1, a_1, L_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfRows( deduped_3_1, hoisted_1_1[o_2], List( hoisted_5_1, function ( logic_new_func_x_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[logic_new_func_x_3];
                        return KroneckerMat( hoisted_2_2, UnionOfColumns( HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ 1 .. logic_new_func_x_3 - 1 ]} ), deduped_3_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_3_1 ), HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ logic_new_func_x_3 + 1 .. deduped_10_1 ]} ), deduped_3_1 ) ) );
                    end ) );
...
function ( cat_1, morphisms_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( deduped_8_1 ), P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_9_1, Source( CAP_JIT_INCOMPLETE_LOGIC( hoisted_1_1[o_2] ) ), CreateCapCategoryObjectWithAttributes( deduped_9_1, RankOfObject, NumberColumns( deduped_3_2 ) ), UnderlyingMatrix, deduped_3_2 );
          end ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, deduped_6_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_7_1, CreateCapCategoryObjectWithAttributes( deduped_7_1, RankOfObject, NumberRows( deduped_1_2 ) ), hoisted_5_1[o_2], UnderlyingMatrix, deduped_1_2 );
          end ) );
end
########
...
function ( cat_1, s_1, L_1, a_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfColumns( deduped_3_1, hoisted_2_1[o_2], List( hoisted_6_1, function ( logic_new_func_x_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[logic_new_func_x_3];
                        return KroneckerMat( UnionOfRows( HomalgZeroMatrix( Sum( deduped_1_2{[ 1 .. logic_new_func_x_3 - 1 ]} ), deduped_1_3, deduped_3_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_3_1 ), HomalgZeroMatrix( Sum( deduped_1_2{[ logic_new_func_x_3 + 1 .. deduped_10_1 ]} ), deduped_1_3, deduped_3_1 ) ), hoisted_2_2 );
                    end ) );
              return CreateCapCategoryMorphismWithAttributes( deduped_9_1, deduped_8_1[o_2], CreateCapCategoryObjectWithAttributes( deduped_9_1, RankOfObject, NumberColumns( deduped_3_2 ) ), UnderlyingMatrix, deduped_3_2 );
          end ) );
end
...
function ( cat_1, s_1, L_1, a_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              ...
              deduped_3_2 := UnionOfRows( deduped_2_1, hoisted_1_1[o_2], List( hoisted_5_1, function ( logic_new_func_x_3 )
                        local deduped_1_3;
                        deduped_1_3 := deduped_1_2[logic_new_func_x_3];
                        return KroneckerMat( UnionOfColumns( HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ 1 .. logic_new_func_x_3 - 1 ]} ), deduped_2_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_2_1 ), HomalgZeroMatrix( deduped_1_3, Sum( deduped_1_2{[ logic_new_func_x_3 + 1 .. deduped_10_1 ]} ), deduped_2_1 ) ), hoisted_2_2 );
                    end ) );
              return CreateCapCategoryMorphismWithAttributes( deduped_9_1, CreateCapCategoryObjectWithAttributes( deduped_9_1, RankOfObject, NumberRows( deduped_3_2 ) ), deduped_8_1[o_2], UnderlyingMatrix, deduped_3_2 );
          end ) );
end
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    hoisted_1_1 := ValuesOfPreSheaf( P_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( deduped_7_1, hoisted_1_1[o_2], deduped_6_1[o_2], UnderlyingMatrix, UnionOfRows( hoisted_4_1, hoisted_3_1[o_2], List( tau_1, function ( logic_new_func_x_3 )
                          return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                      end ) ) );
          end ) );
end
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    hoisted_2_1 := ValuesOfPreSheaf( P_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( Source( cat_1 ) )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( deduped_7_1, deduped_6_1[o_2], hoisted_2_1[o_2], UnderlyingMatrix, UnionOfColumns( hoisted_4_1, hoisted_3_1[o_2], List( tau_1, function ( logic_new_func_x_3 )
                          return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                      end ) ) );
          end ) );
end
