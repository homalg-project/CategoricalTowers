...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_28_1 := CreateCapCategoryObjectWithAttributes( deduped_31_1, IndexOfObject, 1 );
    deduped_27_1 := deduped_30_1[2];
    deduped_26_1 := CreateCapCategoryObjectWithAttributes( deduped_31_1, IndexOfObject, 0 );
    deduped_25_1 := deduped_30_1[1];
    deduped_24_1 := ListWithIdenticalEntries( deduped_27_1, deduped_28_1 );
    deduped_23_1 := ListWithIdenticalEntries( deduped_25_1, deduped_26_1 );
    deduped_22_1 := [ 0 .. deduped_27_1 - 1 ];
    deduped_2_1 := [ deduped_32_1[1], deduped_32_1[2] ];
    deduped_1_1 := [ deduped_26_1, deduped_28_1 ];
    deduped_21_1 := Concatenation( List( deduped_23_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ), List( deduped_24_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ) );
    ...
    deduped_6_1 := [ 0, 0, 1 ];
    deduped_5_1 := [ 0, 2 ];
    hoisted_17_1 := List( ListWithIdenticalEntries( deduped_27_1, CreateCapCategoryMorphismWithAttributes( deduped_31_1, deduped_26_1, deduped_28_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
    ...
    hoisted_19_1 := List( deduped_22_1, function ( i_2 )
            ...
            deduped_4_2 := 1 + (CAP_JIT_INCOMPLETE_LOGIC( i_2 ) + deduped_25_1);
    ...
    hoisted_9_1 := [ deduped_26_1, deduped_26_1, deduped_28_1 ];
    hoisted_4_1 := Concatenation( List( deduped_23_1, IndexOfObject ), List( deduped_24_1, IndexOfObject ) );
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_41_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( source_1 );
    deduped_40_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_39_1 := deduped_43_1[3];
    deduped_38_1 := deduped_43_1[2];
    deduped_37_1 := deduped_43_1[1];
    deduped_36_1 := CreateCapCategoryObjectWithAttributes( deduped_42_1, IndexOfObject, 1 );
    deduped_35_1 := CreateCapCategoryObjectWithAttributes( deduped_42_1, IndexOfObject, 0 );
    deduped_34_1 := deduped_41_1[2];
    deduped_33_1 := deduped_41_1[1];
    deduped_32_1 := ListWithIdenticalEntries( deduped_34_1, deduped_36_1 );
    deduped_31_1 := ListWithIdenticalEntries( deduped_33_1, deduped_35_1 );
    deduped_30_1 := [ 0 .. deduped_34_1 - 1 ];
    deduped_2_1 := [ deduped_37_1, deduped_38_1 ];
    deduped_1_1 := [ deduped_35_1, deduped_36_1 ];
    deduped_29_1 := Concatenation( List( deduped_31_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ), List( deduped_32_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ) );
    deduped_28_1 := List( ListOfValues( [ CreateCapCategoryObjectWithAttributes( deduped_40_1, Length, deduped_33_1 ), CreateCapCategoryObjectWithAttributes( deduped_40_1, Length, deduped_34_1 ) ] ), Length );
    deduped_27_1 := deduped_28_1[1];
    deduped_26_1 := [ 0 .. Product( deduped_29_1 ) - 1 ];
    deduped_25_1 := Product( deduped_29_1{[ 1 .. deduped_27_1 ]} );
    deduped_8_1 := [ 0, 1, 2 ];
    deduped_7_1 := [ 0, 1, 1 ];
    deduped_6_1 := [ 0, 0, 1 ];
    deduped_5_1 := [ 0, 2 ];
    hoisted_17_1 := List( ListWithIdenticalEntries( deduped_34_1, CreateCapCategoryMorphismWithAttributes( deduped_42_1, deduped_35_1, deduped_36_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
            local deduped_1_2, deduped_2_2, deduped_3_2;
            deduped_3_2 := Source( morB_2 );
            deduped_2_2 := IndexOfObject( deduped_3_2 );
            deduped_1_2 := 1 + deduped_5_1[(1 + deduped_2_2)];
    ...
    hoisted_19_1 := List( deduped_30_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, deduped_4_2;
            deduped_4_2 := 1 + (CAP_JIT_INCOMPLETE_LOGIC( i_2 ) + deduped_33_1);
            hoisted_3_2 := hoisted_17_1[1 + i_2];
    ...
    deduped_3_1 := deduped_41_1[3];
    hoisted_14_1 := List( deduped_30_1, function ( i_2 )
            return deduped_2_1[SafePosition( deduped_1_1, hoisted_13_1[1 + deduped_3_1[(1 + i_2)]] )];
        end );
    deduped_15_1 := List( deduped_30_1, function ( j_2 )
            return Product( hoisted_14_1{[ 1 .. j_2 ]} );
        end );
    hoisted_9_1 := [ deduped_35_1, deduped_35_1, deduped_36_1 ];
    hoisted_4_1 := Concatenation( List( deduped_31_1, IndexOfObject ), List( deduped_32_1, IndexOfObject ) );
    hoisted_12_1 := List( deduped_30_1, function ( i_2 )
            ...
            hoisted_2_2 := deduped_29_1[deduped_7_2];
            hoisted_1_2 := Product( deduped_29_1{[ 1 .. deduped_7_2 - 1 ]} );
            return List( deduped_26_1, function ( i_3 )
                    return hoisted_3_2[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_3 ), hoisted_1_2 ), hoisted_2_2 ) )];
                end );
        end );
    ...
    hoisted_23_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_24_1, deduped_25_1 ), Product( deduped_29_1{[ 1 + deduped_27_1 .. Sum( deduped_28_1{[ 1, 2 ]} ) ]} ) ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfBouquetMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( [ 0 .. deduped_27_1 - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_21_1, deduped_37_1 ^ i_2 ), deduped_37_1 );
            end ), List( [ 0 .. deduped_28_1[2] - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_23_1, deduped_38_1 ^ i_2 ), deduped_38_1 );
            end ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_44_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( arg2_1 );
    deduped_43_1 := deduped_46_1[3];
    deduped_42_1 := deduped_46_1[2];
    deduped_41_1 := deduped_46_1[1];
    deduped_40_1 := CreateCapCategoryObjectWithAttributes( deduped_45_1, IndexOfObject, 1 );
    deduped_39_1 := deduped_44_1[2];
    deduped_38_1 := CreateCapCategoryObjectWithAttributes( deduped_45_1, IndexOfObject, 0 );
    deduped_37_1 := deduped_44_1[1];
    deduped_36_1 := ListWithIdenticalEntries( deduped_39_1, deduped_40_1 );
    deduped_35_1 := ListWithIdenticalEntries( deduped_37_1, deduped_38_1 );
    deduped_34_1 := [ 0 .. deduped_39_1 - 1 ];
    deduped_2_1 := [ deduped_41_1, deduped_42_1 ];
    deduped_1_1 := [ deduped_38_1, deduped_40_1 ];
    deduped_33_1 := Concatenation( List( deduped_35_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ), List( deduped_36_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ) );
    deduped_32_1 := List( ListOfValues( [ CreateCapCategoryObjectWithAttributes( deduped_47_1, Length, deduped_37_1 ), CreateCapCategoryObjectWithAttributes( deduped_47_1, Length, deduped_39_1 ) ] ), Length );
    deduped_31_1 := deduped_32_1[1];
    deduped_30_1 := [ 0 .. Product( deduped_33_1 ) - 1 ];
    deduped_8_1 := [ 0, 1, 2 ];
    deduped_7_1 := [ 0, 1, 1 ];
    deduped_6_1 := [ 0, 0, 1 ];
    deduped_5_1 := [ 0, 2 ];
    hoisted_17_1 := List( ListWithIdenticalEntries( deduped_39_1, CreateCapCategoryMorphismWithAttributes( deduped_45_1, deduped_38_1, deduped_40_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
            local deduped_1_2, deduped_2_2, deduped_3_2;
            deduped_3_2 := Source( morB_2 );
            deduped_2_2 := IndexOfObject( deduped_3_2 );
            deduped_1_2 := 1 + deduped_5_1[(1 + deduped_2_2)];
    ...
    hoisted_19_1 := List( deduped_34_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, deduped_4_2;
            deduped_4_2 := 1 + (CAP_JIT_INCOMPLETE_LOGIC( i_2 ) + deduped_37_1);
            hoisted_3_2 := hoisted_17_1[1 + i_2];
            hoisted_2_2 := deduped_33_1[deduped_4_2];
            hoisted_1_2 := Product( deduped_33_1{[ 1 .. deduped_4_2 - 1 ]} );
    ...
    hoisted_9_1 := [ deduped_38_1, deduped_38_1, deduped_40_1 ];
    hoisted_4_1 := Concatenation( List( deduped_35_1, IndexOfObject ), List( deduped_36_1, IndexOfObject ) );
    hoisted_12_1 := List( deduped_34_1, function ( i_2 )
            ...
            hoisted_2_2 := deduped_33_1[deduped_7_2];
            hoisted_1_2 := Product( deduped_33_1{[ 1 .. deduped_7_2 - 1 ]} );
            return List( deduped_30_1, function ( i_3 )
                    return hoisted_3_2[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_3 ), hoisted_1_2 ), hoisted_2_2 ) )];
                end );
        end );
    ...
    hoisted_27_1 := [ 0 .. deduped_32_1[2] - 1 ];
    hoisted_25_1 := Product( deduped_33_1{[ 1 + deduped_31_1 .. Sum( deduped_32_1{[ 1, 2 ]} ) ]} );
    hoisted_24_1 := [ 0 .. deduped_31_1 - 1 ];
    deduped_22_1 := Product( deduped_33_1{[ 1 .. deduped_31_1 ]} );
    return List( [ 0 .. deduped_28_1 - 1 ], function ( i_2 )
            ...
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfBouquetMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( hoisted_24_1, function ( i_3 )
                        return REM_INT( QUO_INT( hoisted_1_2, deduped_41_1 ^ i_3 ), deduped_41_1 );
