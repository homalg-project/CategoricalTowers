...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_22_1 := DefiningTripleOfBouquet( arg2_1 );
    deduped_21_1 := DefiningTripleOfBouquet( arg3_1 );
    ...
    hoisted_6_1 := [ 0 .. deduped_20_1 - 1 ];
    hoisted_3_1 := deduped_17_1;
    hoisted_12_1 := List( [ 0 .. deduped_15_1 - 1 ], function ( i_2 )
            return Sum( List( hoisted_6_1, function ( k_3 )
                      return hoisted_10_1[(1 + REM_INT( QUO_INT( i_2, hoisted_9_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_9_1 ))] * hoisted_3_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_8_1 := List( [ 0 .. deduped_14_1 - 1 ], function ( i_2 )
            ...
            return Sum( List( hoisted_6_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_5_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_3_1 ^ k_3;
                  end ) );
        end );
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Length, Length( Filtered( [ 0 .. deduped_13_1 * deduped_16_1 - 1 ], function ( x_2 )
                ...
                return deduped_1_2 + deduped_1_2 * hoisted_2_1 = hoisted_8_1[1 + REM_INT( deduped_2_2, hoisted_7_1 )] + hoisted_12_1[(1 + REM_INT( QUO_INT( deduped_2_2, hoisted_7_1 ), hoisted_11_1 ))] * hoisted_2_1;
            end ) ) );
end
########
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_41_1 := DefiningTripleOfBouquet( range_1 );
    deduped_40_1 := DefiningTripleOfBouquet( source_1 );
    ...
    hoisted_12_1 := List( [ 0 .. deduped_33_1 - 1 ], function ( i_2 )
            return Sum( List( hoisted_7_1, function ( k_3 )
                      return hoisted_10_1[(1 + REM_INT( QUO_INT( i_2, hoisted_9_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_9_1 ))] * hoisted_2_1 ^ k_3;
                  end ) );
        end );
    hoisted_11_1 := deduped_33_1;
    ...
    hoisted_8_1 := List( [ 0 .. deduped_32_1 - 1 ], function ( i_2 )
            ...
            return Sum( List( hoisted_7_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_6_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_2_1 ^ k_3;
                  end ) );
        end );
    hoisted_4_1 := deduped_34_1;
    hoisted_3_1 := deduped_28_1;
    hoisted_1_1 := deduped_32_1;
    deduped_27_1 := Filtered( [ 0 .. deduped_28_1 * deduped_34_1 - 1 ], function ( x_2 )
            local deduped_1_2, deduped_2_2;
            deduped_2_2 := CAP_JIT_INCOMPLETE_LOGIC( x_2 );
            deduped_1_2 := REM_INT( QUO_INT( deduped_2_2, hoisted_3_1 ), hoisted_4_1 );
            return deduped_1_2 + deduped_1_2 * hoisted_4_1 = hoisted_8_1[1 + REM_INT( deduped_2_2, hoisted_1_1 )] + hoisted_12_1[(1 + REM_INT( QUO_INT( deduped_2_2, hoisted_1_1 ), hoisted_11_1 ))] * hoisted_4_1;
        end );
    deduped_26_1 := [ 0 .. Length( deduped_27_1 ) - 1 ];
    hoisted_24_1 := List( [ 0 .. deduped_33_1 * deduped_36_1 - 1 ], function ( i_2 )
            return REM_INT( QUO_INT( i_2, hoisted_9_1 ^ QUO_INT( i_2, hoisted_11_1 ) ), hoisted_9_1 );
        end );
    hoisted_23_1 := deduped_36_1;
    hoisted_13_1 := deduped_27_1;
    hoisted_21_1 := List( deduped_26_1, function ( i_2 )
            return REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_13_1[1 + i_2] ), hoisted_1_1 ), hoisted_11_1 );
        end );
    hoisted_14_1 := AsList( alpha_1 );
    hoisted_22_1 := List( deduped_31_1, function ( i_2 )
            return hoisted_21_1[1 + hoisted_14_1[(1 + i_2)]];
        end );
    hoisted_16_1 := deduped_39_1;
    hoisted_25_1 := List( [ 0 .. deduped_39_1 * deduped_36_1 - 1 ], function ( logic_new_func_x_2 )
            ...
            return hoisted_24_1[1 + (hoisted_22_1[1 + REM_INT( deduped_1_2, hoisted_16_1 )] + REM_INT( QUO_INT( deduped_1_2, hoisted_16_1 ), hoisted_23_1 ) * hoisted_11_1)];
        end );
    ...
    hoisted_18_1 := deduped_35_1;
    hoisted_15_1 := List( deduped_26_1, function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_13_1[1 + i_2] ), hoisted_1_1 );
        end );
    hoisted_17_1 := List( deduped_31_1, function ( i_2 )
            return hoisted_15_1[1 + hoisted_14_1[(1 + i_2)]];
        end );
    hoisted_20_1 := List( [ 0 .. deduped_39_1 * deduped_35_1 - 1 ], function ( logic_new_func_x_2 )
            local deduped_1_2;
            deduped_1_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
            return hoisted_19_1[1 + (hoisted_17_1[1 + REM_INT( deduped_1_2, hoisted_16_1 )] + REM_INT( QUO_INT( deduped_1_2, hoisted_16_1 ), hoisted_18_1 ) * hoisted_1_1)];
        end );
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfBouquetMorphism, NTuple( 2, List( deduped_29_1, function ( i_2 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_34_1 := DefiningTripleOfBouquet( arg2_1 );
    deduped_33_1 := DefiningTripleOfBouquet( arg3_1 );
    ...
    hoisted_19_1 := List( deduped_25_1, function ( logic_new_func_x_2 )
            return REM_INT( logic_new_func_x_2, hoisted_18_1 );
        end );
    hoisted_17_1 := List( [ 0 .. deduped_26_1 * deduped_30_1 - 1 ], function ( i_2 )
            return REM_INT( QUO_INT( i_2, hoisted_3_1 ^ QUO_INT( i_2, hoisted_7_1 ) ), hoisted_3_1 );
        end );
    ...
    return List( [ 0 .. deduped_21_1 - 1 ], function ( logic_new_func_x_2 )
            ...
            deduped_3_2 := CAP_JIT_INCOMPLETE_LOGIC( hoisted_14_1[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_4_2, hoisted_13_1 ^ QUO_INT( deduped_4_2, hoisted_13_1 ) ), hoisted_13_1 ) )] );
            hoisted_2_2 := REM_INT( QUO_INT( deduped_3_2, hoisted_7_1 ), hoisted_11_1 );
            hoisted_1_2 := REM_INT( deduped_3_2, hoisted_7_1 );
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfBouquetMorphism, NTuple( 2, List( hoisted_4_1, function ( logic_new_func_x_3 )
                        return hoisted_17_1[1 + (hoisted_1_2 + hoisted_16_1[(1 + logic_new_func_x_3)] * hoisted_7_1)];
                    end ), List( hoisted_6_1, function ( logic_new_func_x_3 )
                        return hoisted_20_1[1 + (hoisted_2_2 + hoisted_19_1[(1 + logic_new_func_x_3)] * hoisted_11_1)];
                    end ) ) );
        end );
end
########
