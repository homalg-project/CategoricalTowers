...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_1_1 := [ deduped_24_1, deduped_26_1 ];
    ...
    hoisted_15_1 := List( ListWithIdenticalEntries( deduped_25_1, CreateCapCategoryMorphismWithAttributes( deduped_29_1, deduped_24_1, deduped_26_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
            ...
            deduped_2_2 := 1 + deduped_5_1[(1 + deduped_3_2)];
            if IdFunc( function (  )
                        if deduped_3_2 = deduped_6_1[deduped_2_2] and IndexOfObject( Range( morB_2 ) ) = deduped_7_1[deduped_2_2] then
                            return IndexOfMorphism( morB_2 ) = deduped_8_1[deduped_2_2];
                        else
                            return false;
                        fi;
                        return;
    ...
    hoisted_12_1 := List( deduped_20_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := deduped_4_1[1 + deduped_3_1[(1 + i_2)]];
            return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                     return IndexOfObject( obj_3 ) = hoisted_1_2;
                 end )];
        end );
    ...
    hoisted_11_1 := List( deduped_20_1, function ( i_2 )
            ...
            deduped_8_2 := 1 + deduped_3_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( i_2 ))];
            deduped_7_2 := 1 + deduped_5_1[(1 + deduped_4_1[deduped_8_2])];
            deduped_6_2 := deduped_6_1[deduped_7_2];
            deduped_5_2 := 1 + deduped_5_1[(1 + deduped_6_2)];
            hoisted_4_2 := CAP_JIT_INCOMPLETE_LOGIC( IdFunc( function (  )
                        if IdFunc( function (  )
                                    if deduped_6_2 = deduped_6_1[deduped_5_2] and deduped_7_1[deduped_7_2] = deduped_7_1[deduped_5_2] then
                                        return deduped_8_1[deduped_7_2] = deduped_8_1[deduped_5_2];
                                    else
                                        return false;
                                    fi;
                                    return;
            ...
            hoisted_3_2 := deduped_19_1[deduped_8_2];
            hoisted_2_2 := Product( deduped_19_1{[ 1 .. deduped_8_2 - 1 ]} );
            return List( deduped_18_1, function ( i_3 )
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_38_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_37_1 := deduped_41_1[3];
    deduped_36_1 := deduped_41_1[2];
    deduped_35_1 := deduped_41_1[1];
    deduped_34_1 := CreateCapCategoryObjectWithAttributes( deduped_40_1, IndexOfObject, 1 );
    ...
    deduped_30_1 := ListWithIdenticalEntries( deduped_32_1, deduped_34_1 );
    deduped_29_1 := ListWithIdenticalEntries( deduped_31_1, deduped_33_1 );
    deduped_28_1 := [ 0 .. deduped_32_1 - 1 ];
    deduped_27_1 := List( ListOfValues( [ CreateCapCategoryObjectWithAttributes( deduped_38_1, Length, deduped_31_1 ), CreateCapCategoryObjectWithAttributes( deduped_38_1, Length, deduped_32_1 ) ] ), Length );
    deduped_26_1 := deduped_27_1[1];
    deduped_2_1 := [ deduped_35_1, deduped_36_1 ];
    deduped_1_1 := [ deduped_33_1, deduped_34_1 ];
    deduped_25_1 := Concatenation( List( deduped_29_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
                   end )];
          end ), List( deduped_30_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_24_1 := Product( deduped_25_1{[ 1 .. deduped_26_1 ]} );
    deduped_23_1 := [ 0 .. Product( deduped_25_1 ) - 1 ];
    deduped_8_1 := [ 0, 1, 2 ];
    deduped_7_1 := [ 0, 1, 1 ];
    deduped_6_1 := [ 0, 0, 1 ];
    deduped_5_1 := [ 0, 2 ];
    hoisted_15_1 := List( ListWithIdenticalEntries( deduped_32_1, CreateCapCategoryMorphismWithAttributes( deduped_40_1, deduped_33_1, deduped_34_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
            local deduped_2_2, deduped_3_2;
            deduped_3_2 := IndexOfObject( Source( morB_2 ) );
            deduped_2_2 := 1 + deduped_5_1[(1 + deduped_3_2)];
            if IdFunc( function (  )
    ...
    hoisted_17_1 := List( deduped_28_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, deduped_4_2;
            deduped_4_2 := 1 + (CAP_JIT_INCOMPLETE_LOGIC( i_2 ) + deduped_31_1);
            hoisted_3_2 := hoisted_15_1[1 + i_2];
    ...
    deduped_4_1 := Concatenation( List( deduped_29_1, IndexOfObject ), List( deduped_30_1, IndexOfObject ) );
    ...
    deduped_13_1 := List( deduped_28_1, function ( j_2 )
            return Product( hoisted_12_1{[ 1 .. j_2 ]} );
        end );
    hoisted_11_1 := List( deduped_28_1, function ( i_2 )
            ...
            hoisted_3_2 := deduped_25_1[deduped_8_2];
            hoisted_2_2 := Product( deduped_25_1{[ 1 .. deduped_8_2 - 1 ]} );
            return List( deduped_23_1, function ( i_3 )
                    return hoisted_4_2[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_3 ), hoisted_2_2 ), hoisted_3_2 ) )];
                end );
        end );
    ...
    hoisted_21_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_22_1, deduped_24_1 ), Product( deduped_25_1{[ 1 + deduped_26_1 .. Sum( deduped_27_1{[ 1, 2 ]} ) ]} ) ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfBouquetMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( [ 0 .. deduped_26_1 - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_19_1, deduped_35_1 ^ i_2 ), deduped_35_1 );
            end ), List( [ 0 .. deduped_27_1[2] - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_21_1, deduped_36_1 ^ i_2 ), deduped_36_1 );
            end ) ) );
end
########
...
########
function ( cat_1, arg2_1, arg3_1 )
    local deduped_1_1, deduped_2_1, deduped_3_1, deduped_4_1, deduped_5_1, deduped_6_1, deduped_7_1, deduped_8_1, hoisted_11_1, hoisted_12_1, deduped_13_1, hoisted_15_1, hoisted_17_1, deduped_20_1, hoisted_22_1, hoisted_23_1, hoisted_25_1, deduped_26_1, deduped_27_1, deduped_28_1, deduped_29_1, deduped_30_1, deduped_31_1, deduped_32_1, deduped_33_1, deduped_34_1, deduped_35_1, deduped_36_1, deduped_37_1, deduped_38_1, deduped_39_1, deduped_40_1, deduped_41_1, deduped_42_1, deduped_43_1, deduped_44_1, deduped_45_1;
    deduped_45_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_44_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( arg3_1 );
    deduped_43_1 := UnderlyingCategory( cat_1 );
    deduped_42_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( arg2_1 );
    deduped_41_1 := deduped_44_1[3];
    deduped_40_1 := deduped_44_1[2];
    deduped_39_1 := deduped_44_1[1];
    deduped_38_1 := CreateCapCategoryObjectWithAttributes( deduped_43_1, IndexOfObject, 1 );
    deduped_37_1 := deduped_42_1[2];
    deduped_36_1 := CreateCapCategoryObjectWithAttributes( deduped_43_1, IndexOfObject, 0 );
    deduped_35_1 := deduped_42_1[1];
    deduped_34_1 := ListWithIdenticalEntries( deduped_37_1, deduped_38_1 );
    deduped_33_1 := ListWithIdenticalEntries( deduped_35_1, deduped_36_1 );
    deduped_32_1 := [ 0 .. deduped_37_1 - 1 ];
    deduped_31_1 := List( ListOfValues( [ CreateCapCategoryObjectWithAttributes( deduped_45_1, Length, deduped_35_1 ), CreateCapCategoryObjectWithAttributes( deduped_45_1, Length, deduped_37_1 ) ] ), Length );
    deduped_30_1 := deduped_31_1[1];
    deduped_2_1 := [ deduped_39_1, deduped_40_1 ];
    deduped_1_1 := [ deduped_36_1, deduped_38_1 ];
    deduped_29_1 := Concatenation( List( deduped_33_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_28_1 := [ 0 .. Product( deduped_29_1 ) - 1 ];
    deduped_8_1 := [ 0, 1, 2 ];
    deduped_7_1 := [ 0, 1, 1 ];
    deduped_6_1 := [ 0, 0, 1 ];
    deduped_5_1 := [ 0, 2 ];
    hoisted_15_1 := List( ListWithIdenticalEntries( deduped_37_1, CreateCapCategoryMorphismWithAttributes( deduped_43_1, deduped_36_1, deduped_38_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
            local deduped_2_2, deduped_3_2;
            deduped_3_2 := IndexOfObject( Source( morB_2 ) );
            deduped_2_2 := 1 + deduped_5_1[(1 + deduped_3_2)];
            if IdFunc( function (  )
    ...
    hoisted_17_1 := List( deduped_32_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, deduped_4_2;
            deduped_4_2 := 1 + (CAP_JIT_INCOMPLETE_LOGIC( i_2 ) + deduped_35_1);
            hoisted_3_2 := hoisted_15_1[1 + i_2];
            hoisted_2_2 := deduped_29_1[deduped_4_2];
            hoisted_1_2 := Product( deduped_29_1{[ 1 .. deduped_4_2 - 1 ]} );
            return List( deduped_28_1, function ( i_3 )
                    return hoisted_3_2[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_3 ), hoisted_1_2 ), hoisted_2_2 ) )];
                end );
        end );
    deduped_4_1 := Concatenation( List( deduped_33_1, IndexOfObject ), List( deduped_34_1, IndexOfObject ) );
    ...
    deduped_13_1 := List( deduped_32_1, function ( j_2 )
            return Product( hoisted_12_1{[ 1 .. j_2 ]} );
        end );
    hoisted_11_1 := List( deduped_32_1, function ( i_2 )
            ...
            hoisted_3_2 := deduped_29_1[deduped_8_2];
            hoisted_2_2 := Product( deduped_29_1{[ 1 .. deduped_8_2 - 1 ]} );
            return List( deduped_28_1, function ( i_3 )
                    return hoisted_4_2[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_3 ), hoisted_2_2 ), hoisted_3_2 ) )];
                end );
        end );
    ...
    hoisted_25_1 := [ 0 .. deduped_31_1[2] - 1 ];
    hoisted_23_1 := Product( deduped_29_1{[ 1 + deduped_30_1 .. Sum( deduped_31_1{[ 1, 2 ]} ) ]} );
    hoisted_22_1 := [ 0 .. deduped_30_1 - 1 ];
    deduped_20_1 := Product( deduped_29_1{[ 1 .. deduped_30_1 ]} );
    return List( [ 0 .. deduped_26_1 - 1 ], function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := CAP_JIT_INCOMPLETE_LOGIC( deduped_27_1[1 + REM_INT( i_2, deduped_26_1 )] );
            ...
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfBouquetMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( hoisted_22_1, function ( i_3 )
                        return REM_INT( QUO_INT( hoisted_1_2, deduped_39_1 ^ i_3 ), deduped_39_1 );
                    end ), List( hoisted_25_1, function ( i_3 )
