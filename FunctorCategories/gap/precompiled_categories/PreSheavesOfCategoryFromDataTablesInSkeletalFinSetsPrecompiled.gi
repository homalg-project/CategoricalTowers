...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_8_1 := List( [ 0 .. deduped_24_1 + deduped_23_1 - 1 ], function ( logic_new_func_x_2 )
    ...
    hoisted_18_1 := Concatenation( List( deduped_22_1, function ( logic_new_func_x_2 )
              ...
              hoisted_10_2 := List( [ 0 .. deduped_15_2 ^ deduped_13_2 - 1 ], function ( i_3 )
                      return Sum( List( hoisted_4_2, function ( k_4 )
                                return hoisted_8_2[(1 + REM_INT( QUO_INT( i_3, hoisted_7_2 ^ CAP_JIT_INCOMPLETE_LOGIC( k_4 ) ), hoisted_7_2 ))] * hoisted_1_2 ^ k_4;
                            end ) );
                  end );
              ...
              hoisted_6_2 := List( [ 0 .. deduped_11_2 ^ deduped_12_2 - 1 ], function ( i_3 )
                      ...
                      return Sum( List( hoisted_4_2, function ( k_4 )
                                return hoisted_1_3[(1 + hoisted_3_2[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_4 ))])] * hoisted_1_2 ^ k_4;
                            end ) );
                  end );
...
function ( cat_1, source_1, alpha_1, beta_1, range_1 )
    ...
    deduped_85_1 := DefiningPairOfUnderlyingQuiver( Source( cat_1 ) );
    ...
    deduped_77_1 := deduped_79_1 - 1;
    deduped_76_1 := Length( deduped_80_1 );
    deduped_75_1 := [ 0 .. deduped_77_1 ];
    deduped_74_1 := [ 1 .. deduped_76_1 ];
    hoisted_41_1 := List( deduped_92_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_40_1 := List( deduped_91_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    deduped_73_1 := List( deduped_78_1, function ( logic_new_func_x_2 )
            return hoisted_40_1[logic_new_func_x_2] ^ hoisted_41_1[logic_new_func_x_2];
        end );
    deduped_72_1 := [ 0 .. deduped_76_1 * 2 - 1 ];
    deduped_71_1 := [ 0 .. deduped_79_1 + deduped_76_1 - 1 ];
    hoisted_22_1 := List( deduped_84_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_21_1 := List( deduped_83_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_20_1 := List( deduped_89_1[1], Length );
    hoisted_19_1 := List( deduped_88_1[1], Length );
    deduped_70_1 := Concatenation( List( deduped_78_1, function ( logic_new_func_x_2 )
    ...
    hoisted_4_1 := List( deduped_82_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_3_1 := List( deduped_81_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_2_1 := List( deduped_87_1[1], Length );
    hoisted_1_1 := List( deduped_86_1[1], Length );
    deduped_69_1 := Concatenation( List( deduped_78_1, function ( logic_new_func_x_2 )
              return hoisted_1_1[logic_new_func_x_2] ^ hoisted_2_1[logic_new_func_x_2];
          end ), List( deduped_74_1, function ( logic_new_func_x_2 )
              return hoisted_3_1[logic_new_func_x_2] ^ hoisted_4_1[logic_new_func_x_2];
          end ) );
    deduped_68_1 := [ 0 .. Product( deduped_73_1 ) - 1 ];
    deduped_67_1 := [ 0 .. Length( deduped_75_1 ) - 1 ];
    deduped_66_1 := [ 0 .. Product( deduped_70_1 ) - 1 ];
    deduped_65_1 := [ 0 .. Product( deduped_69_1 ) - 1 ];
    hoisted_32_1 := List( deduped_83_1, AsList );
    hoisted_31_1 := List( deduped_83_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_30_1 := List( deduped_84_1, AsList );
    hoisted_29_1 := List( deduped_84_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_24_1 := deduped_66_1;
    hoisted_23_1 := deduped_70_1;
    hoisted_25_1 := List( deduped_71_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
    ...
    hoisted_15_1 := deduped_80_1;
    hoisted_33_1 := Concatenation( List( deduped_74_1, function ( logic_new_func_x_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, hoisted_7_2, hoisted_8_2, hoisted_9_2, hoisted_10_2, deduped_11_2, deduped_12_2, deduped_13_2, deduped_14_2, deduped_15_2;
    ...
    hoisted_7_1 := deduped_77_1;
    hoisted_27_1 := Concatenation( List( deduped_74_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
    ...
    hoisted_26_1 := Concatenation( List( deduped_74_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
    ...
    hoisted_17_1 := List( deduped_81_1, AsList );
    hoisted_16_1 := List( deduped_81_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_14_1 := List( deduped_82_1, AsList );
    hoisted_13_1 := List( deduped_82_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_6_1 := deduped_65_1;
    hoisted_5_1 := deduped_69_1;
    hoisted_8_1 := List( deduped_71_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_2_2 := hoisted_5_1[1 + logic_new_func_x_2];
            hoisted_1_2 := Product( hoisted_5_1{[ 1 .. logic_new_func_x_2 ]} );
            return List( hoisted_6_1, function ( i_3 )
    ...
    hoisted_10_1 := Concatenation( List( deduped_74_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_5_1[1 + (hoisted_7_1 + logic_new_func_x_2)];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    ...
    hoisted_9_1 := Concatenation( List( deduped_74_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_8_1[1 + (hoisted_7_1 + logic_new_func_x_2)];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    ...
    hoisted_39_1 := deduped_67_1;
    hoisted_37_1 := List( deduped_75_1, function ( logic_new_func_x_2 )
            return hoisted_23_1[1 + logic_new_func_x_2];
        end );
    hoisted_38_1 := List( deduped_67_1, function ( j_2 )
            return Product( hoisted_37_1{[ 1 .. j_2 ]} );
        end );
    hoisted_35_1 := deduped_60_1;
    hoisted_34_1 := deduped_64_1;
    hoisted_36_1 := List( deduped_75_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_2_2 := hoisted_23_1[1 + logic_new_func_x_2];
            hoisted_1_2 := Product( hoisted_23_1{[ 1 .. logic_new_func_x_2 ]} );
            return List( hoisted_35_1, function ( i_3 )
                    return REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_34_1[1 + i_3] ), hoisted_1_2 ), hoisted_2_2 );
                end );
        end );
    ...
    hoisted_51_1 := deduped_75_1;
    hoisted_45_1 := List( deduped_91_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_42_1 := List( deduped_92_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_49_1 := List( deduped_78_1, function ( logic_new_func_x_2 )
            return hoisted_45_1[logic_new_func_x_2] ^ hoisted_42_1[logic_new_func_x_2];
        end );
    hoisted_50_1 := List( deduped_75_1, function ( j_2 )
            return Product( hoisted_49_1{[ 1 .. j_2 ]} );
        end );
    hoisted_47_1 := deduped_68_1;
    hoisted_46_1 := deduped_73_1;
    hoisted_44_1 := List( deduped_92_1, AsList );
    hoisted_43_1 := List( deduped_91_1, AsList );
    hoisted_48_1 := List( deduped_78_1, function ( logic_new_func_x_2 )
            ...
            deduped_13_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
            deduped_12_2 := hoisted_41_1[deduped_13_2];
            deduped_11_2 := hoisted_40_1[deduped_13_2];
            deduped_10_2 := deduped_11_2 ^ deduped_12_2;
            hoisted_6_2 := [ 0 .. hoisted_42_1[deduped_13_2] - 1 ];
            hoisted_5_2 := hoisted_45_1[deduped_13_2];
            hoisted_4_2 := hoisted_43_1[deduped_13_2];
            hoisted_3_2 := hoisted_44_1[deduped_13_2];
            hoisted_2_2 := [ 0 .. deduped_12_2 - 1 ];
            hoisted_1_2 := deduped_11_2;
            ...
            hoisted_7_2 := Product( hoisted_46_1{[ 1 .. logic_new_func_x_2 - 1 ]} );
    ...
    hoisted_57_1 := List( deduped_68_1, function ( i_2 )
            local hoisted_1_2;
            hoisted_1_2 := 1 + i_2;
            return Sum( hoisted_51_1, function ( j_3 )
                    local deduped_1_3;
                    deduped_1_3 := 1 + j_3;
                    return hoisted_48_1[deduped_1_3][hoisted_1_2] * hoisted_50_1[deduped_1_3];
                end );
        end );
    hoisted_55_1 := List( deduped_75_1, function ( logic_new_func_x_2 )
            return hoisted_5_1[1 + logic_new_func_x_2];
        end );
    hoisted_56_1 := List( deduped_67_1, function ( j_2 )
            return Product( hoisted_55_1{[ 1 .. j_2 ]} );
        end );
    hoisted_53_1 := deduped_59_1;
    hoisted_52_1 := deduped_63_1;
    hoisted_54_1 := List( deduped_75_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_2_2 := hoisted_5_1[1 + logic_new_func_x_2];
            hoisted_1_2 := Product( hoisted_5_1{[ 1 .. logic_new_func_x_2 ]} );
            return List( hoisted_53_1, function ( i_3 )
                    return REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_52_1[1 + i_3] ), hoisted_1_2 ), hoisted_2_2 );
                end );
        end );
    return CreateCapCategoryMorphismWithAttributes( deduped_90_1, CreateCapCategoryObjectWithAttributes( deduped_90_1, Length, deduped_61_1 ), CreateCapCategoryObjectWithAttributes( deduped_90_1, Length, deduped_62_1 ), AsList, List( deduped_59_1, function ( x_2 )
              local hoisted_1_2;
              hoisted_1_2 := 1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 );
              return -1 + SafePosition( hoisted_58_1, hoisted_57_1[(1 + Sum( hoisted_39_1, function ( j_3 )
                             local deduped_1_3;
                             deduped_1_3 := (1 + j_3);
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    hoisted_11_1 := List( [ 0 .. deduped_38_1 + deduped_35_1 - 1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
    ...
    hoisted_26_1 := List( deduped_34_1, function ( logic_new_func_x_2 )
            ...
            hoisted_3_2 := List( hoisted_23_1, function ( i_3 )
                    return REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_22_1[1 + i_3] ), hoisted_1_2 ), hoisted_2_2 );
                end );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, ValuesOnAllObjects, List( deduped_37_1, function ( i_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, hoisted_7_2, deduped_8_2, deduped_9_2, deduped_10_2;
              deduped_10_2 := hoisted_5_1[i_2];
              deduped_9_2 := hoisted_3_1[i_2];
              ...
              hoisted_4_2 := deduped_9_2;
              hoisted_3_2 := hoisted_26_1[i_2];
              hoisted_7_2 := List( [ 0 .. hoisted_4_1 * deduped_9_2 - 1 ], function ( logic_new_func_x_3 )
                      local deduped_1_3;
                      deduped_1_3 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_3 );
                      return hoisted_6_2[1 + (hoisted_3_2[1 + REM_INT( deduped_1_3, hoisted_4_1 )] + REM_INT( QUO_INT( deduped_1_3, hoisted_4_1 ), hoisted_4_2 ) * hoisted_5_2)];
                  end );
              return CreateCapCategoryMorphismWithAttributes( hoisted_28_1, hoisted_1_1[i_2], hoisted_2_1[i_2], AsList, List( [ 0 .. deduped_9_2 - 1 ], function ( i_3 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_45_1 := ValuesOfPreSheaf( arg2_1 );
    deduped_44_1 := ValuesOfPreSheaf( arg3_1 );
    deduped_43_1 := deduped_45_1[2];
    deduped_42_1 := deduped_44_1[2];
    deduped_41_1 := deduped_45_1[1];
    deduped_40_1 := deduped_44_1[1];
    deduped_39_1 := DefiningPairOfUnderlyingQuiver( Source( cat_1 ) );
    ...
    deduped_33_1 := [ 0 .. deduped_35_1 ];
    deduped_32_1 := [ 1 .. deduped_34_1 ];
    deduped_31_1 := [ 0 .. deduped_34_1 * 2 - 1 ];
    ...
    hoisted_2_1 := List( deduped_41_1, Length );
    hoisted_1_1 := List( deduped_40_1, Length );
    deduped_30_1 := Concatenation( List( deduped_36_1, function ( logic_new_func_x_2 )
              return hoisted_1_1[logic_new_func_x_2] ^ hoisted_2_1[logic_new_func_x_2];
          end ), List( deduped_32_1, function ( logic_new_func_x_2 )
              return hoisted_3_1[logic_new_func_x_2] ^ hoisted_4_1[logic_new_func_x_2];
          end ) );
    deduped_29_1 := [ 0 .. Product( deduped_30_1 ) - 1 ];
    hoisted_17_1 := List( deduped_42_1, AsList );
    hoisted_16_1 := List( deduped_42_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_15_1 := deduped_38_1;
    hoisted_14_1 := List( deduped_43_1, AsList );
    hoisted_13_1 := List( deduped_43_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_6_1 := deduped_29_1;
    hoisted_5_1 := deduped_30_1;
    hoisted_8_1 := List( [ 0 .. deduped_37_1 + deduped_34_1 - 1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_2_2 := hoisted_5_1[1 + logic_new_func_x_2];
            hoisted_1_2 := Product( hoisted_5_1{[ 1 .. logic_new_func_x_2 ]} );
            return List( hoisted_6_1, function ( i_3 )
    ...
    hoisted_18_1 := Concatenation( List( deduped_32_1, function ( logic_new_func_x_2 )
              local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, hoisted_7_2, hoisted_8_2, hoisted_9_2, hoisted_10_2, deduped_11_2, deduped_12_2, deduped_13_2, deduped_14_2, deduped_15_2;
              deduped_15_2 := hoisted_16_1[logic_new_func_x_2];
              deduped_14_2 := hoisted_15_1[logic_new_func_x_2];
              deduped_13_2 := hoisted_4_1[logic_new_func_x_2];
    ...
    hoisted_11_1 := List( deduped_31_1, function ( j_2 )
            return Product( hoisted_10_1{[ 1 .. j_2 ]} );
        end );
    hoisted_9_1 := Concatenation( List( deduped_32_1, function ( logic_new_func_x_2 )
              local deduped_1_2;
              deduped_1_2 := hoisted_8_1[1 + (hoisted_7_1 + logic_new_func_x_2)];
              return [ deduped_1_2, deduped_1_2 ];
          end ) );
    ...
    hoisted_26_1 := deduped_36_1;
    hoisted_25_1 := Range( cat_1 );
    hoisted_24_1 := List( deduped_33_1, function ( logic_new_func_x_2 )
            return hoisted_5_1[1 + logic_new_func_x_2];
        end );
    hoisted_23_1 := deduped_33_1;
    hoisted_22_1 := deduped_28_1;
    hoisted_21_1 := deduped_27_1;
    hoisted_20_1 := deduped_40_1;
    hoisted_19_1 := deduped_41_1;
    return List( [ 0 .. deduped_27_1 - 1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
            hoisted_1_2 := CAP_JIT_INCOMPLETE_LOGIC( hoisted_22_1[1 + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_3_2, hoisted_21_1 ^ QUO_INT( deduped_3_2, hoisted_21_1 ) ), hoisted_21_1 ) )] );
            hoisted_2_2 := List( hoisted_23_1, function ( logic_new_func_x_3 )
            ...
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, ValuesOnAllObjects, List( hoisted_26_1, function ( i_3 )
                      local hoisted_1_3, hoisted_2_3, hoisted_3_3, hoisted_4_3, hoisted_5_3, hoisted_6_3, deduped_7_3, deduped_8_3, deduped_9_3;
                      deduped_9_3 := hoisted_1_1[i_3];
                      deduped_8_3 := hoisted_2_1[i_3];
                      deduped_7_3 := deduped_9_3 ^ deduped_8_3;
                      hoisted_2_3 := deduped_9_3;
                      hoisted_1_3 := deduped_7_3;
                      ...
                      return CreateCapCategoryMorphismWithAttributes( hoisted_25_1, hoisted_19_1[i_3], hoisted_20_1[i_3], AsList, List( [ 0 .. deduped_8_3 - 1 ], function ( logic_new_func_x_4 )
                                return hoisted_6_3[1 + (hoisted_5_3 + REM_INT( CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_4 ), hoisted_3_3 ) * hoisted_4_3)];
                            end ) );
                  end ) );
        end );
end
