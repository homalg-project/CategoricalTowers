...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( Target( cat_1 ), Length, Length( Filtered( deduped_43_1, function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := 1 + x_2;
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return List( [ 0 .. Length( deduped_51_1 ) - 1 ], function ( i_2 )
            local hoisted_1_2;
