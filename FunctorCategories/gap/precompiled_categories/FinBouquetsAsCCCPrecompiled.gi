...
function ( cat_1, a_1, b_1 )
    ...
    deduped_83_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_82_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( b_1 );
    deduped_81_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( a_1 );
    deduped_80_1 := deduped_82_1[3];
    deduped_79_1 := deduped_82_1[2];
    deduped_78_1 := deduped_82_1[1];
    deduped_77_1 := deduped_81_1[2];
    deduped_76_1 := deduped_81_1[1];
    deduped_75_1 := CreateCapCategoryObjectWithAttributes( deduped_83_1, Length, deduped_76_1 );
    deduped_74_1 := 0 * deduped_77_1;
    deduped_73_1 := Source( ModelingCategory( ModelingCategory( cat_1 ) ) );
    deduped_72_1 := [ 0 .. deduped_77_1 - 1 ];
    deduped_71_1 := deduped_76_1 + deduped_74_1;
    deduped_70_1 := CreateCapCategoryObjectWithAttributes( deduped_73_1, IndexOfObject, 1 );
    deduped_69_1 := CreateCapCategoryObjectWithAttributes( deduped_73_1, IndexOfObject, 0 );
    deduped_68_1 := [ 0 .. deduped_74_1 - 1 ];
    deduped_67_1 := CreateCapCategoryMorphismWithAttributes( deduped_73_1, deduped_69_1, deduped_70_1, IndexOfMorphism, 1 );
    deduped_66_1 := ListWithIdenticalEntries( deduped_77_1, deduped_70_1 );
    ...
    deduped_62_1 := List( deduped_64_1, IndexOfObject );
    deduped_2_1 := [ deduped_78_1, deduped_79_1 ];
    ...
    deduped_10_1 := [ 0, 0, 1 ];
    deduped_9_1 := [ 0, 2 ];
    hoisted_33_1 := List( ListWithIdenticalEntries( deduped_77_1, deduped_67_1 ), function ( morB_2 )
            local deduped_1_2, deduped_2_2, deduped_3_2;
            deduped_3_2 := Source( morB_2 );
            deduped_2_2 := IndexOfObject( deduped_3_2 );
            deduped_1_2 := 1 + deduped_9_1[(1 + deduped_2_2)];
            if IdFunc( function (  )
                        if deduped_2_2 = deduped_10_1[deduped_1_2] and IndexOfObject( Range( morB_2 ) ) = deduped_11_1[deduped_1_2] then
                            return IndexOfMorphism( morB_2 ) = deduped_12_1[deduped_1_2];
                        else
                            return false;
                        fi;
                        return;
    ...
    deduped_6_1 := deduped_81_1[3];
    deduped_24_1 := List( deduped_72_1, function ( i_2 )
            return CAP_JIT_INCOMPLETE_LOGIC( deduped_6_1[(1 + REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_2 ), 1 ), deduped_77_1 ))] ) * 1;
        end );
    ...
    hoisted_25_1 := Concatenation( deduped_62_1, List( deduped_66_1, IndexOfObject ) );
    ...
    hoisted_28_1 := List( deduped_72_1, function ( i_2 )
            ...
            deduped_6_2 := 1 + deduped_9_1[(1 + hoisted_25_1[deduped_7_2])];
            deduped_5_2 := deduped_10_1[deduped_6_2];
            deduped_4_2 := 1 + deduped_9_1[(1 + deduped_5_2)];
    ...
    deduped_7_1 := List( deduped_68_1, function ( i_2 )
            return deduped_4_1[1 + i_2] + CAP_JIT_INCOMPLETE_LOGIC( deduped_6_1[(1 + REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_2 ), 0 ), deduped_77_1 ))] ) * 1;
        end );
    ...
    hoisted_8_1 := Concatenation( deduped_62_1, List( deduped_65_1, IndexOfObject ) );
    hoisted_16_1 := List( deduped_68_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 := 1 + deduped_7_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( i_2 ))];
            deduped_6_2 := 1 + deduped_9_1[(1 + hoisted_8_1[deduped_7_2])];
            deduped_5_2 := deduped_10_1[deduped_6_2];
            deduped_4_2 := 1 + deduped_9_1[(1 + deduped_5_2)];
            hoisted_3_2 := CAP_JIT_INCOMPLETE_LOGIC( IdFunc( function (  )
                        if IdFunc( function (  )
    ...
    deduped_53_1 := ListOfValues( [ CreateCapCategoryMorphismWithAttributes( deduped_83_1, deduped_75_1, deduped_75_1, AsList, List( [ 0 .. deduped_76_1 - 1 ], function ( i_2 )
                    return CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_2 ), 1 ), deduped_76_1 ) ) * 1;
                end ) ), CreateCapCategoryMorphismWithAttributes( deduped_83_1, CreateCapCategoryObjectWithAttributes( deduped_83_1, Length, deduped_74_1 ), CreateCapCategoryObjectWithAttributes( deduped_83_1, Length, deduped_77_1 ), AsList, List( deduped_68_1, function ( i_2 )
                    return deduped_4_1[1 + i_2] + CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( i_2 ), 0 ), deduped_77_1 ) ) * 1;
                end ) ) ] );
    ...
    deduped_35_1 := [ [ 0 .. deduped_78_1 - 1 ], [ 0 .. deduped_79_1 - 1 ] ];
    ...
    hoisted_43_1 := Concatenation( List( deduped_64_1, function ( objB_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_9_1[(1 + IndexOfObject( objB_2 ))];
