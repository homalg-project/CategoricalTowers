...
function ( cat_1, a_1, b_1 )
    local deduped_1_1, deduped_2_1, hoisted_4_1, deduped_5_1, deduped_6_1, deduped_7_1, deduped_8_1, deduped_9_1, deduped_10_1, hoisted_13_1, hoisted_14_1, deduped_15_1, hoisted_17_1, hoisted_19_1, hoisted_20_1, hoisted_21_1, hoisted_24_1, deduped_25_1, deduped_27_1, hoisted_29_1, hoisted_30_1, deduped_31_1, hoisted_33_1, hoisted_34_1, hoisted_36_1, deduped_38_1, deduped_39_1, deduped_40_1, deduped_41_1, deduped_42_1, deduped_43_1, deduped_44_1, deduped_45_1, deduped_46_1, deduped_47_1, deduped_48_1, deduped_49_1, deduped_50_1, deduped_51_1, deduped_52_1, deduped_53_1, deduped_54_1, deduped_55_1, deduped_56_1, deduped_57_1, deduped_58_1, deduped_59_1, deduped_60_1, deduped_61_1, deduped_62_1, deduped_63_1;
    deduped_63_1 := RangeCategoryOfHomomorphismStructure( cat_1 );
    deduped_62_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( b_1 );
    deduped_61_1 := UnderlyingCategory( cat_1 );
    deduped_60_1 := DefiningTripleOfBouquetEnrichedOverSkeletalFinSets( a_1 );
    deduped_59_1 := deduped_62_1[3];
    deduped_58_1 := deduped_62_1[2];
    deduped_57_1 := deduped_62_1[1];
    deduped_56_1 := CreateCapCategoryObjectWithAttributes( deduped_61_1, IndexOfObject, 1 );
    deduped_55_1 := deduped_60_1[2];
    deduped_54_1 := CreateCapCategoryObjectWithAttributes( deduped_61_1, IndexOfObject, 0 );
    deduped_53_1 := deduped_60_1[1];
    deduped_52_1 := CreateCapCategoryObjectWithAttributes( deduped_63_1, Length, deduped_53_1 );
    deduped_51_1 := ListWithIdenticalEntries( deduped_55_1, deduped_56_1 );
    deduped_50_1 := ListWithIdenticalEntries( deduped_53_1, deduped_54_1 );
    deduped_49_1 := [ 0 .. deduped_53_1 - 1 ];
    deduped_48_1 := [ 0 .. deduped_55_1 - 1 ];
    deduped_47_1 := ListOfValues( [ CreateCapCategoryMorphismWithAttributes( deduped_63_1, deduped_52_1, deduped_52_1, AsList, deduped_49_1 ), CreateCapCategoryMorphismWithAttributes( deduped_63_1, CreateCapCategoryObjectWithAttributes( deduped_63_1, Length, 0 ), CreateCapCategoryObjectWithAttributes( deduped_63_1, Length, deduped_55_1 ), AsList, [  ] ) ] );
    deduped_2_1 := [ deduped_57_1, deduped_58_1 ];
    deduped_1_1 := [ deduped_54_1, deduped_56_1 ];
    deduped_46_1 := List( deduped_50_1, function ( objB_2 )
            local hoisted_1_2;
    ...
    deduped_45_1 := Concatenation( deduped_46_1, List( deduped_51_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_44_1 := [ 1 .. Length( deduped_47_1 ) ];
    ...
    deduped_8_1 := [ 0, 0, 1 ];
    deduped_7_1 := [ 0, 2 ];
    hoisted_17_1 := List( ListWithIdenticalEntries( deduped_55_1, CreateCapCategoryMorphismWithAttributes( deduped_61_1, deduped_54_1, deduped_56_1, IndexOfMorphism, 1 ) ), function ( morB_2 )
    ...
    hoisted_19_1 := List( deduped_48_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, deduped_4_2;
            deduped_4_2 := 1 + (CAP_JIT_INCOMPLETE_LOGIC( i_2 ) + deduped_53_1);
            hoisted_3_2 := hoisted_17_1[1 + i_2];
            hoisted_2_2 := deduped_45_1[deduped_4_2];
            hoisted_1_2 := Product( deduped_45_1{[ 1 .. deduped_4_2 - 1 ]} );
    ...
    deduped_6_1 := Concatenation( List( deduped_50_1, IndexOfObject ), List( deduped_51_1, IndexOfObject ) );
    hoisted_4_1 := deduped_60_1[3];
    deduped_5_1 := List( deduped_48_1, function ( i_2 )
            return hoisted_4_1[1 + REM_INT( i_2, deduped_55_1 )];
        end );
    hoisted_14_1 := List( deduped_48_1, function ( i_2 )
            local hoisted_1_2;
    ...
    deduped_15_1 := List( deduped_48_1, function ( j_2 )
            return Product( hoisted_14_1{[ 1 .. j_2 ]} );
        end );
    hoisted_13_1 := List( deduped_48_1, function ( i_2 )
            ...
            hoisted_3_2 := deduped_45_1[deduped_8_2];
            hoisted_2_2 := Product( deduped_45_1{[ 1 .. deduped_8_2 - 1 ]} );
            return List( deduped_41_1, function ( i_3 )
    ...
    deduped_25_1 := List( deduped_49_1, function ( j_2 )
            return Product( deduped_46_1{[ 1 .. j_2 ]} );
        end );
    hoisted_20_1 := [ [ 0 .. deduped_57_1 - 1 ], [ 0 .. deduped_58_1 - 1 ] ];
    hoisted_21_1 := List( deduped_50_1, function ( objB_2 )
            local hoisted_1_2;
            hoisted_1_2 := IndexOfObject( objB_2 );
            return hoisted_20_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                     return IndexOfObject( obj_3 ) = hoisted_1_2;
                 end )];
        end );
    hoisted_24_1 := List( [ 1 .. deduped_53_1 ], function ( i_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2;
            hoisted_3_2 := hoisted_21_1[i_2];
            hoisted_2_2 := deduped_46_1[i_2];
            hoisted_1_2 := Product( deduped_46_1{[ 1 .. i_2 - 1 ]} );
    ...
    hoisted_33_1 := Concatenation( List( deduped_44_1, function ( i_2 )
              ...
              return List( [ 0 .. deduped_27_1[i_2] - 1 ], function ( i_3 )
                      ...
                      hoisted_2_3 := deduped_45_1[deduped_3_3];
                      hoisted_1_3 := Product( deduped_45_1{[ 1 .. deduped_3_3 - 1 ]} );
                      return List( deduped_41_1, function ( i_4 )
                              return REM_INT( QUO_INT( i_4, hoisted_1_3 ), hoisted_2_3 );
                          end );
                  end );
          end ) );
    hoisted_30_1 := List( deduped_50_1, function ( objB_2 )
    ...
    hoisted_29_1 := Concatenation( List( deduped_44_1, function ( i_2 )
              return ListWithIdenticalEntries( Length( [ 0 .. deduped_27_1[i_2] - 1 ] ), deduped_43_1 );
          end ) );
    hoisted_34_1 := List( [ 0 .. Sum( List( deduped_44_1, function ( i_2 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, DefiningTripleOfBouquetEnrichedOverSkeletalFinSets, NTuple( 3, Length( deduped_40_1 ), deduped_38_1, List( [ 0 .. deduped_38_1 - 1 ], function ( x_2 )
                local hoisted_1_2;
                hoisted_1_2 := 1 + CAP_JIT_INCOMPLETE_LOGIC( deduped_39_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 ))] );
                return -1 + BigInt( SafePosition( deduped_40_1, CAP_JIT_INCOMPLETE_LOGIC( hoisted_36_1[(1 + Sum( deduped_49_1, function ( j_3 )
                                   local deduped_1_3;
                                   deduped_1_3 := (1 + j_3);
