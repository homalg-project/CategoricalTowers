...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_8_1 := List( [ 0 .. deduped_23_1 + deduped_24_1 - 1 ], function ( logic_new_func_x_2 )
...
function ( cat_1, source_1, alpha_1, beta_1, range_1 )
    ...
    hoisted_41_1 := List( deduped_91_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    ...
    hoisted_22_1 := List( deduped_83_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_21_1 := List( deduped_82_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    ...
    hoisted_4_1 := List( deduped_81_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_3_1 := List( deduped_80_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    ...
    hoisted_51_1 := deduped_74_1;
    hoisted_45_1 := List( deduped_90_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_42_1 := List( deduped_91_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    hoisted_7_1 := List( deduped_44_1, function ( logic_new_func_x_2 )
            return Length( Source( logic_new_func_x_2 ) );
        end );
    hoisted_6_1 := List( deduped_43_1, function ( logic_new_func_x_2 )
            return Length( Range( logic_new_func_x_2 ) );
        end );
    hoisted_5_1 := List( deduped_41_1, Length );
    hoisted_3_1 := List( deduped_40_1, Length );
    ...
    hoisted_11_1 := List( [ 0 .. deduped_37_1 + deduped_38_1 - 1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_2_1 := List( deduped_40_1, Length );
    hoisted_1_1 := List( deduped_39_1, Length );
    ...
    hoisted_8_1 := List( [ 0 .. deduped_36_1 + deduped_37_1 - 1 ], function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2;
            hoisted_2_2 := hoisted_5_1[1 + logic_new_func_x_2];
            hoisted_1_2 := Product( hoisted_5_1{[ 1 .. logic_new_func_x_2 ]} );
            return List( hoisted_6_1, function ( i_3 )
    ...
    hoisted_20_1 := deduped_39_1;
    hoisted_19_1 := deduped_40_1;
