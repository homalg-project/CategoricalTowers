...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_35_1 := deduped_40_1[2];
    deduped_34_1 := deduped_39_1[2];
    deduped_33_1 := SetOfObjects( deduped_38_1 );
    deduped_32_1 := SetOfGeneratingMorphisms( deduped_38_1 );
    deduped_31_1 := CommutativeRingOfLinearCategory( deduped_38_1 );
    ...
    deduped_27_1 := List( deduped_28_1, function ( logic_new_func_x_2 )
    ...
    deduped_11_1 := List( deduped_29_1, function ( logic_new_func_x_2 )
    ...
    deduped_26_1 := SyzygiesOfRows( UnionOfRows( deduped_31_1, Sum( deduped_27_1 ), List( deduped_29_1, function ( logic_new_func_x_2 )
                local deduped_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2, deduped_6_2;
                deduped_6_2 := deduped_4_1[logic_new_func_x_2];
                deduped_5_2 := deduped_3_1[logic_new_func_x_2];
                hoisted_4_2 := deduped_11_1[logic_new_func_x_2];
    ...
    hoisted_22_1 := Range( cat_1 );
    hoisted_16_1 := HomalgIdentityMatrix( deduped_25_1, deduped_31_1 );
    hoisted_21_1 := List( [ 1 .. Length( deduped_36_1 ) ], function ( logic_new_func_x_2 )
            local hoisted_1_2, deduped_2_2;
            deduped_2_2 := deduped_11_1[logic_new_func_x_2];
            hoisted_1_2 := deduped_26_1 * UnionOfRows( HomalgZeroMatrix( Sum( deduped_11_1{[ 1 .. (logic_new_func_x_2 - 1) ]} ), deduped_2_2, deduped_31_1 ), HomalgIdentityMatrix( deduped_2_2, deduped_31_1 ), HomalgZeroMatrix( Sum( deduped_11_1{[ (logic_new_func_x_2 + 1) .. deduped_30_1 ]} ), deduped_2_2, deduped_31_1 ) );
            return List( deduped_24_1, function ( logic_new_func_x_3 )
                    return ConvertRowToMatrix( CertainRows( hoisted_16_1, [ logic_new_func_x_3 ] ), 1, deduped_25_1 ) * hoisted_1_2;
                end );
        end );
    return List( deduped_24_1, function ( j_2 )
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, ValuesOnAllObjects, LazyHList( deduped_29_1, function ( i_3 )
                      return CreateCapCategoryMorphismWithAttributes( hoisted_22_1, deduped_36_1[i_3], deduped_37_1[i_3], UnderlyingMatrix, ConvertRowToMatrix( hoisted_21_1[i_3][j_2], deduped_3_1[i_3], deduped_4_1[i_3] ) );
                  end ) );
        end );
end
########
...
function ( cat_1, arg2_1 )
    ...
    deduped_17_1 := CommutativeRingOfLinearCategory( deduped_22_1 );
    ...
    deduped_13_1 := List( deduped_14_1, function ( logic_new_func_x_2 )
            return hoisted_1_1[logic_new_func_x_2] * hoisted_2_1[logic_new_func_x_2];
        end );
    ...
    return EntriesOfHomalgMatrix( UniqueRightDivide( UnionOfColumns( deduped_17_1, 1, List( ListOfValues( ValuesOnAllObjects( arg2_1 ) ), function ( logic_new_func_x_2 )
                  return ConvertMatrixToRow( UnderlyingMatrix( logic_new_func_x_2 ) );
              end ) ), SyzygiesOfRows( UnionOfRows( deduped_17_1, Sum( deduped_13_1 ), List( [ 1 .. Length( deduped_19_1 ) ], function ( logic_new_func_x_2 )
                    ...
                    deduped_6_2 := deduped_4_1[logic_new_func_x_2];
                    deduped_5_2 := deduped_3_1[logic_new_func_x_2];
                    hoisted_4_2 := deduped_3_1[deduped_7_2] * deduped_4_1[deduped_7_2];
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_3_1 := CommutativeRingOfLinearCategory( deduped_9_1 );
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_9_1, Range, deduped_10_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_8_1[1] ], function ( o_2 )
                ...
                deduped_1_2 := List( arg3_1, function ( logic_new_func_x_3 )
                ...
                deduped_7_2 := RankOfObject( Range( deduped_8_2 ) );
                deduped_6_2 := RankOfObject( Source( deduped_8_2 ) );
                hoisted_2_2 := 1 + deduped_9_2[1];
                deduped_5_2 := List( arg3_1, function ( logic_new_func_x_3 )
                        return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[hoisted_2_2] ) );
                    end );
                hoisted_1_2 := 1 + deduped_9_2[2];
                deduped_4_2 := List( arg3_1, function ( logic_new_func_x_3 )
                        return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[hoisted_1_2] ) );
                    end );
                deduped_3_2 := UniqueLeftDivide( SyzygiesOfColumns( UnionOfRows( deduped_3_1, deduped_6_2, deduped_4_2{deduped_2_1} ) + (- UnionOfRows( deduped_3_1, deduped_6_2, deduped_4_2{deduped_4_1} )) ), UnderlyingMatrix( deduped_8_2 ) * SyzygiesOfColumns( (UnionOfRows( deduped_3_1, deduped_7_2, deduped_5_2{deduped_2_1} ) + (- UnionOfRows( deduped_3_1, deduped_7_2, deduped_5_2{deduped_4_1} ))) ) );
...
function ( cat_1, P_1, morphisms_1, mu_1, morphismsp_1, Pp_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, deduped_9_1, deduped_10_1, deduped_11_1, deduped_12_1, deduped_13_1;
    deduped_13_1 := Length( morphismsp_1 );
    deduped_12_1 := Length( morphisms_1 );
    deduped_11_1 := ValuesOnAllObjects( mu_1 );
    ...
    hoisted_5_1 := List( deduped_11_1, UnderlyingMatrix );
    hoisted_4_1 := [ 2 .. deduped_12_1 ];
    deduped_3_1 := CommutativeRingOfLinearCategory( deduped_10_1 );
    hoisted_2_1 := [ 1 .. deduped_12_1 - 1 ];
    hoisted_1_1 := List( deduped_11_1, function ( logic_new_func_x_2 )
            return RankOfObject( Source( logic_new_func_x_2 ) );
        end );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_10_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2, deduped_4_2, deduped_5_2;
              deduped_5_2 := hoisted_6_1[o_2];
              deduped_4_2 := hoisted_1_1[o_2];
              deduped_3_2 := List( morphismsp_1, function ( logic_new_func_x_3 )
                      return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                  end );
              deduped_2_2 := List( morphisms_1, function ( logic_new_func_x_3 )
                      return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                  end );
...
function ( cat_1, arg2_1 )
    ...
    deduped_3_1 := CommutativeRingOfLinearCategory( deduped_7_1 );
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_7_1, Range, deduped_8_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_6_1[1] ], function ( o_2 )
                return CreateCapCategoryObjectWithAttributes( deduped_8_1, RankOfObject, Sum( List( arg2_1, function ( logic_new_func_x_3 )
                            return RankOfObject( CAP_JIT_INCOMPLETE_LOGIC( ValuesOfPreSheaf( logic_new_func_x_3 )[1][o_2] ) );
                        end ) ) );
...
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    local hoisted_1_1, deduped_2_1, hoisted_3_1, hoisted_4_1, deduped_5_1, deduped_7_1, deduped_8_1;
    deduped_8_1 := Source( cat_1 );
    deduped_7_1 := ValuesOfPreSheaf( Pp_1 )[1];
    deduped_5_1 := Range( cat_1 );
    hoisted_4_1 := [ 1 .. Length( L_1 ) ];
    hoisted_3_1 := Length( objectsp_1 );
    deduped_2_1 := CommutativeRingOfLinearCategory( deduped_8_1 );
    hoisted_1_1 := List( deduped_7_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2;
...
########
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    local hoisted_2_1, deduped_3_1, hoisted_4_1, hoisted_5_1, deduped_6_1, deduped_7_1, deduped_8_1;
    deduped_8_1 := Source( cat_1 );
    deduped_7_1 := ValuesOfPreSheaf( P_1 )[1];
    deduped_6_1 := Range( cat_1 );
    hoisted_5_1 := [ 1 .. Length( L_1 ) ];
    hoisted_4_1 := Length( objects_1 );
    deduped_3_1 := CommutativeRingOfLinearCategory( deduped_8_1 );
...
function ( cat_1, arg2_1 )
    ...
    hoisted_2_1 := CommutativeRingOfLinearCategory( deduped_4_1 );
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_4_1, Range, deduped_5_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_3_1[1] ], function ( o_2 )
                return CreateCapCategoryObjectWithAttributes( deduped_5_1, RankOfObject, Sum( List( arg2_1, function ( logic_new_func_x_3 )
                            return RankOfObject( CAP_JIT_INCOMPLETE_LOGIC( ValuesOfPreSheaf( logic_new_func_x_3 )[1][o_2] ) );
                        end ) ) );
...
function ( cat_1, P_1, objects_1, L_1, objectsp_1, Pp_1 )
    ...
    hoisted_4_1 := Range( cat_1 );
    hoisted_3_1 := CommutativeRingOfLinearCategory( deduped_5_1 );
    hoisted_2_1 := ValuesOfPreSheaf( Pp_1 )[1];
    hoisted_1_1 := ValuesOfPreSheaf( P_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_5_1 )[1] ], function ( o_2 )
...
function ( cat_1, Y_1, morphisms_1, P_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1, hoisted_4_1, deduped_5_1, deduped_7_1, deduped_8_1, deduped_9_1;
    deduped_9_1 := Length( morphisms_1 );
    deduped_8_1 := Source( cat_1 );
    deduped_7_1 := ValuesOfPreSheaf( Y_1 )[1];
    deduped_5_1 := Range( cat_1 );
    hoisted_4_1 := [ 2 .. deduped_9_1 ];
    deduped_3_1 := CommutativeRingOfLinearCategory( deduped_8_1 );
    hoisted_2_1 := [ 1 .. deduped_9_1 - 1 ];
    hoisted_1_1 := List( deduped_7_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Y_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_9_1, Range, deduped_10_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_8_1[1] ], function ( o_2 )
                ...
                deduped_3_2 := UniqueRightDivide( SyzygiesOfRows( (UnionOfColumns( deduped_3_1, deduped_6_2, deduped_4_2{deduped_2_1} ) + (- UnionOfColumns( deduped_3_1, deduped_6_2, deduped_4_2{deduped_4_1} ))) ) * UnderlyingMatrix( deduped_8_2 ), SyzygiesOfRows( UnionOfColumns( deduped_3_1, deduped_7_2, deduped_5_2{deduped_2_1} ) + (- UnionOfColumns( deduped_3_1, deduped_7_2, deduped_5_2{deduped_4_1} )) ) );
                return CreateCapCategoryMorphismWithAttributes( deduped_10_1, CreateCapCategoryObjectWithAttributes( deduped_10_1, RankOfObject, NumberRows( deduped_3_2 ) ), CreateCapCategoryObjectWithAttributes( deduped_10_1, RankOfObject, NumberColumns( deduped_3_2 ) ), UnderlyingMatrix, deduped_3_2 );
            end ) ) );
end
########
...
function ( cat_1, arg2_1 )
    ...
    deduped_1_1 := CommutativeRingOfLinearCategory( deduped_9_1 );
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_9_1, Range, deduped_10_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_8_1[1] ], function ( o_2 )
...
function ( cat_1, P_1, morphisms_1, L_1, morphismsp_1, Pp_1 )
    local hoisted_2_1, deduped_3_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, hoisted_8_1, hoisted_10_1, hoisted_11_1, hoisted_12_1, deduped_13_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1;
    deduped_17_1 := Length( morphismsp_1 );
    deduped_16_1 := Length( morphisms_1 );
    deduped_15_1 := Source( cat_1 );
    ...
    deduped_3_1 := CommutativeRingOfLinearCategory( deduped_15_1 );
    hoisted_2_1 := List( deduped_14_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_15_1 )[1] ], function ( o_2 )
...
function ( cat_1, source_1, alpha_1, beta_1, range_1 )
    ...
    deduped_31_1 := CommutativeRingOfLinearCategory( deduped_39_1 );
    ...
    deduped_24_1 := List( deduped_25_1, function ( logic_new_func_x_2 )
            return hoisted_15_1[logic_new_func_x_2] * hoisted_16_1[logic_new_func_x_2];
        end );
    ...
    deduped_23_1 := List( deduped_25_1, function ( logic_new_func_x_2 )
            return hoisted_1_1[logic_new_func_x_2] * hoisted_2_1[logic_new_func_x_2];
        end );
    ...
    deduped_22_1 := UniqueRightDivide( SyzygiesOfRows( UnionOfRows( deduped_31_1, Sum( deduped_23_1 ), List( deduped_26_1, function ( logic_new_func_x_2 )
                    local deduped_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
                    deduped_7_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
                    deduped_6_2 := deduped_4_1[logic_new_func_x_2];
                    deduped_5_2 := deduped_3_1[logic_new_func_x_2];
                ...
                end ) ) ) * DiagMat( deduped_31_1, List( deduped_26_1, function ( logic_new_func_x_2 )
                  return KroneckerMat( hoisted_13_1[logic_new_func_x_2], hoisted_14_1[logic_new_func_x_2] );
              end ) ), SyzygiesOfRows( UnionOfRows( deduped_31_1, Sum( deduped_24_1 ), List( deduped_26_1, function ( logic_new_func_x_2 )
                  local deduped_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
                  deduped_7_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
                  deduped_6_2 := deduped_18_1[logic_new_func_x_2];
                  deduped_5_2 := deduped_17_1[logic_new_func_x_2];
                  hoisted_4_2 := deduped_17_1[deduped_7_2] * deduped_18_1[deduped_7_2];
                  hoisted_3_2 := TransposedMatrix( HomalgIdentityMatrix( deduped_5_2, deduped_31_1 ) );
                  hoisted_2_2 := HomalgIdentityMatrix( deduped_6_2, deduped_31_1 );
                  deduped_1_2 := deduped_33_1[logic_new_func_x_2];
                  return UnionOfColumns( deduped_31_1, deduped_5_2 * deduped_6_2, List( deduped_25_1, function ( logic_new_func_x_3 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_20_1 := SetOfGeneratingMorphisms( deduped_23_1 );
    deduped_19_1 := CommutativeRingOfLinearCategory( deduped_23_1 );
    deduped_18_1 := SetOfObjects( deduped_23_1 );
    ...
    return CreateCapCategoryObjectWithAttributes( Range( cat_1 ), RankOfObject, Sum( deduped_14_1 ) - RowRankOfMatrix( UnionOfRows( deduped_19_1, Sum( deduped_15_1 ), List( deduped_16_1, function ( logic_new_func_x_2 )
                    local deduped_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2, deduped_6_2;
                    deduped_6_2 := deduped_2_1[logic_new_func_x_2];
                    deduped_5_2 := deduped_1_1[logic_new_func_x_2];
                    hoisted_4_2 := deduped_14_1[logic_new_func_x_2];
...
function ( cat_1, a_1 )
    ...
    hoisted_4_1 := Range( cat_1 );
    hoisted_3_1 := CommutativeRingOfLinearCategory( deduped_6_1 );
    hoisted_2_1 := List( deduped_5_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, a_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_6_1 )[1] ], function ( o_2 )
              local deduped_1_2;
...
function ( cat_1 )
    ...
    hoisted_3_1 := HomalgIdentityMatrix( 0, CommutativeRingOfLinearCategory( deduped_5_1 ) );
...
function ( cat_1, objects_1, k_1, P_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1, hoisted_4_1, deduped_5_1, deduped_6_1, deduped_7_1;
    deduped_7_1 := Source( cat_1 );
    ...
    hoisted_2_1 := [ 1 .. k_1 - 1 ];
    hoisted_1_1 := ValuesOfPreSheaf( CAP_JIT_INCOMPLETE_LOGIC( deduped_6_1 ) )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_6_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_7_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_5_1, hoisted_1_1[o_2], CreateCapCategoryObjectWithAttributes( deduped_5_1, RankOfObject, NumberColumns( deduped_1_2 ) ), UnderlyingMatrix, deduped_1_2 );
          end ) );
end
########
...
########
function ( cat_1, objects_1, k_1, P_1 )
    local hoisted_1_1, hoisted_2_1, hoisted_3_1, deduped_4_1, hoisted_5_1, hoisted_6_1, deduped_7_1, deduped_8_1;
    deduped_8_1 := Source( cat_1 );
    deduped_7_1 := objects_1[k_1];
    hoisted_6_1 := Range( cat_1 );
    hoisted_5_1 := [ k_1 + 1 .. Length( objects_1 ) ];
    deduped_4_1 := CommutativeRingOfLinearCategory( deduped_8_1 );
    hoisted_3_1 := [ 1 .. k_1 - 1 ];
    hoisted_2_1 := ValuesOfPreSheaf( P_1 )[1];
    hoisted_1_1 := ValuesOfPreSheaf( CAP_JIT_INCOMPLETE_LOGIC( deduped_7_1 ) )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_7_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2;
              deduped_2_2 := List( objects_1, function ( logic_new_func_x_3 )
                      return RankOfObject( CAP_JIT_INCOMPLETE_LOGIC( ValuesOfPreSheaf( logic_new_func_x_3 )[1][o_2] ) );
                  end );
              deduped_1_2 := deduped_2_2[k_1];
              return CreateCapCategoryMorphismWithAttributes( hoisted_6_1, hoisted_1_1[o_2], hoisted_2_1[o_2], UnderlyingMatrix, UnionOfColumns( HomalgZeroMatrix( deduped_1_2, Sum( deduped_2_2{hoisted_3_1} ), deduped_4_1 ), HomalgIdentityMatrix( deduped_1_2, deduped_4_1 ), HomalgZeroMatrix( deduped_1_2, Sum( deduped_2_2{hoisted_5_1} ), deduped_4_1 ) ) );
          end ) );
end
########
...
function ( cat_1, morphisms_1, k_1, P_1 )
    local hoisted_1_1, deduped_2_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, deduped_8_1, deduped_9_1, deduped_10_1, deduped_11_1;
    ...
    deduped_2_1 := CommutativeRingOfLinearCategory( deduped_10_1 );
    hoisted_1_1 := ValuesOnAllObjects( deduped_9_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Range( deduped_9_1 ), P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_10_1 )[1] ], function ( o_2 )
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_8_1, Range( CAP_JIT_INCOMPLETE_LOGIC( hoisted_1_1[o_2] ) ), CreateCapCategoryObjectWithAttributes( deduped_8_1, RankOfObject, NumberColumns( deduped_2_2 ) ), UnderlyingMatrix, deduped_2_2 );
          end ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    deduped_18_1 := CommutativeRingOfLinearCategory( deduped_24_1 );
    ...
    deduped_13_1 := UniqueRightDivide( UnionOfColumns( deduped_18_1, 1, List( ListOfValues( ValuesOnAllObjects( alpha_1 ) ), function ( logic_new_func_x_2 )
                return ConvertMatrixToRow( UnderlyingMatrix( logic_new_func_x_2 ) );
            end ) ), SyzygiesOfRows( UnionOfRows( deduped_18_1, Sum( deduped_14_1 ), List( [ 1 .. Length( deduped_20_1 ) ], function ( logic_new_func_x_2 )
                  local deduped_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
                  deduped_7_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
                  deduped_6_2 := deduped_4_1[logic_new_func_x_2];
                  deduped_5_2 := deduped_3_1[logic_new_func_x_2];
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_30_1 := CommutativeRingOfLinearCategory( deduped_31_1 );
    ...
    hoisted_17_1 := UnderlyingMatrix( alpha_1 ) * SyzygiesOfRows( UnionOfRows( deduped_30_1, Sum( deduped_20_1 ), List( deduped_21_1, function ( logic_new_func_x_2 )
                  local deduped_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, deduped_5_2, deduped_6_2;
                  deduped_6_2 := deduped_6_1[logic_new_func_x_2];
                  deduped_5_2 := deduped_5_1[logic_new_func_x_2];
                  hoisted_4_2 := deduped_13_1[logic_new_func_x_2];
    ...
    hoisted_18_1 := List( deduped_21_1, function ( logic_new_func_x_2 )
            ...
            return hoisted_17_1 * UnionOfRows( HomalgZeroMatrix( Sum( deduped_13_1{[ 1 .. (logic_new_func_x_2 - 1) ]} ), deduped_1_2, deduped_30_1 ), HomalgIdentityMatrix( deduped_1_2, deduped_30_1 ), HomalgZeroMatrix( Sum( deduped_13_1{[ (logic_new_func_x_2 + 1) .. deduped_23_1 ]} ), deduped_1_2, deduped_30_1 ) );
        end );
...
function ( cat_1, alpha_1 )
    ...
    deduped_7_1 := Source( cat_1 );
    hoisted_6_1 := Range( cat_1 );
    hoisted_5_1 := List( deduped_8_1, UnderlyingMatrix );
    hoisted_4_1 := CommutativeRingOfLinearCategory( deduped_7_1 );
    hoisted_3_1 := List( deduped_8_1, function ( logic_new_func_x_2 )
            return RankOfObject( Range( logic_new_func_x_2 ) );
        end );
    hoisted_2_1 := List( deduped_8_1, Source );
    hoisted_1_1 := List( deduped_8_1, Range );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Range( alpha_1 ), Source( alpha_1 ), ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_7_1 )[1] ], function ( o_2 )
...
function ( cat_1, S_1, source_diagram_1, mat_1, range_diagram_1, T_1 )
    local hoisted_1_1, hoisted_3_1, deduped_4_1, hoisted_5_1, deduped_6_1, deduped_7_1;
    deduped_7_1 := Source( cat_1 );
    deduped_6_1 := ValuesOfPreSheaf( T_1 )[1];
    hoisted_5_1 := Range( cat_1 );
    deduped_4_1 := CommutativeRingOfLinearCategory( deduped_7_1 );
    hoisted_3_1 := List( deduped_6_1, RankOfObject );
    hoisted_1_1 := ValuesOfPreSheaf( S_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, S_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_7_1 )[1] ], function ( o_2 )
...
function ( cat_1, morphisms_1, P_1 )
    local hoisted_1_1, deduped_2_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, deduped_7_1, deduped_8_1, deduped_9_1, deduped_10_1;
    ...
    deduped_2_1 := CommutativeRingOfLinearCategory( deduped_9_1 );
    hoisted_1_1 := ValuesOnAllObjects( deduped_8_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( deduped_8_1 ), P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_9_1 )[1] ], function ( o_2 )
              ...
              deduped_4_2 := List( hoisted_4_1, function ( logic_new_func_x_3 )
                      local deduped_1_3;
                      deduped_1_3 := deduped_6_2[logic_new_func_x_3];
                      return deduped_7_2[logic_new_func_x_3] * UnionOfColumns( HomalgZeroMatrix( deduped_1_3, Sum( deduped_6_2{[ 1 .. (logic_new_func_x_3 - 1) ]} ), deduped_2_1 ), HomalgIdentityMatrix( deduped_1_3, deduped_2_1 ), HomalgZeroMatrix( deduped_1_3, Sum( deduped_6_2{[ (logic_new_func_x_3 + 1) .. deduped_10_1 ]} ), deduped_2_1 ) );
                  end );
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_7_1, Source( CAP_JIT_INCOMPLETE_LOGIC( hoisted_1_1[o_2] ) ), CreateCapCategoryObjectWithAttributes( deduped_7_1, RankOfObject, NumberColumns( deduped_3_2 ) ), UnderlyingMatrix, deduped_3_2 );
          end ) );
end
########
...
########
function ( cat_1, objects_1, k_1, P_1 )
    local hoisted_1_1, deduped_2_1, hoisted_3_1, deduped_4_1, hoisted_5_1, deduped_6_1, deduped_7_1;
    deduped_7_1 := Source( cat_1 );
    deduped_6_1 := objects_1[k_1];
    hoisted_5_1 := ValuesOfPreSheaf( CAP_JIT_INCOMPLETE_LOGIC( deduped_6_1 ) )[1];
    deduped_4_1 := Range( cat_1 );
    hoisted_3_1 := [ k_1 + 1 .. Length( objects_1 ) ];
    deduped_2_1 := CommutativeRingOfLinearCategory( deduped_7_1 );
    hoisted_1_1 := [ 1 .. k_1 - 1 ];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, deduped_6_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_7_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := List( objects_1, function ( logic_new_func_x_3 )
                      return RankOfObject( CAP_JIT_INCOMPLETE_LOGIC( ValuesOfPreSheaf( logic_new_func_x_3 )[1][o_2] ) );
                  end );
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_4_1, CreateCapCategoryObjectWithAttributes( deduped_4_1, RankOfObject, NumberRows( deduped_1_2 ) ), hoisted_5_1[o_2], UnderlyingMatrix, deduped_1_2 );
          end ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    hoisted_1_1 := ValuesOfPreSheaf( P_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, deduped_7_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2;
              deduped_2_2 := List( objects_1, function ( logic_new_func_x_3 )
                      return RankOfObject( CAP_JIT_INCOMPLETE_LOGIC( ValuesOfPreSheaf( logic_new_func_x_3 )[1][o_2] ) );
                  end );
...
########
function ( cat_1, morphisms_1, k_1, P_1 )
    local deduped_1_1, hoisted_3_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, deduped_7_1, hoisted_8_1, deduped_9_1, deduped_10_1, deduped_11_1;
    deduped_11_1 := Length( morphisms_1 );
    deduped_10_1 := Source( cat_1 );
    deduped_9_1 := CAP_JIT_INCOMPLETE_LOGIC( morphisms_1[k_1] );
    ...
    deduped_1_1 := CommutativeRingOfLinearCategory( deduped_10_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Source( deduped_9_1 ), ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_10_1 )[1] ], function ( o_2 )
              local deduped_2_2, deduped_3_2, deduped_4_2, deduped_5_2, deduped_6_2;
              deduped_6_2 := List( morphisms_1, function ( logic_new_func_x_3 )
                      return RankOfObject( Source( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) ) );
                  end );
              ...
              return CreateCapCategoryMorphismWithAttributes( deduped_7_1, CreateCapCategoryObjectWithAttributes( deduped_7_1, RankOfObject, NumberRows( deduped_2_2 ) ), Source( CAP_JIT_INCOMPLETE_LOGIC( hoisted_8_1[o_2] ) ), UnderlyingMatrix, deduped_2_2 );
          end ) );
end
########
...
########
function ( cat_1, Y_1, morphisms_1, P_1 )
    local hoisted_2_1, hoisted_3_1, deduped_4_1, hoisted_5_1, deduped_6_1, deduped_7_1, deduped_8_1, deduped_9_1;
    deduped_9_1 := Length( morphisms_1 );
    deduped_8_1 := Source( cat_1 );
    deduped_7_1 := ValuesOfPreSheaf( Y_1 )[1];
    deduped_6_1 := Range( cat_1 );
    ...
    hoisted_2_1 := List( deduped_7_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Y_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
...
########
function ( cat_1, P_1, morphisms_1, L_1, morphismsp_1, Pp_1 )
    local deduped_1_1, hoisted_3_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, hoisted_8_1, hoisted_9_1, hoisted_10_1, hoisted_11_1, deduped_12_1, deduped_14_1, deduped_15_1, deduped_16_1, deduped_17_1;
    deduped_17_1 := Length( morphismsp_1 );
    deduped_16_1 := Length( morphisms_1 );
    deduped_15_1 := Source( cat_1 );
    ...
    deduped_1_1 := CommutativeRingOfLinearCategory( deduped_15_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, Pp_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_15_1 )[1] ], function ( o_2 )
...
function ( cat_1, Y_1, morphisms_1, T_1, tau_1, P_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1, hoisted_4_1, hoisted_5_1, deduped_6_1, hoisted_7_1, deduped_8_1, deduped_9_1, deduped_10_1;
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := hoisted_1_1[o_2];
              deduped_2_2 := List( morphisms_1, function ( logic_new_func_x_3 )
                      return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    local hoisted_1_1, hoisted_2_1, deduped_3_1, deduped_5_1, deduped_6_1;
    deduped_6_1 := Source( cat_1 );
    deduped_5_1 := ValuesOfPreSheaf( T_1 )[1];
    deduped_3_1 := Range( cat_1 );
    hoisted_2_1 := CommutativeRingOfLinearCategory( deduped_6_1 );
    hoisted_1_1 := List( deduped_5_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_6_1 )[1] ], function ( o_2 )
              local deduped_1_2;
              deduped_1_2 := UnionOfRows( hoisted_2_1, hoisted_1_1[o_2], List( tau_1, function ( logic_new_func_x_3 )
                        return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                    end ) );
...
########
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    local hoisted_1_1, hoisted_3_1, hoisted_4_1, hoisted_5_1, deduped_6_1, deduped_7_1;
    deduped_7_1 := Source( cat_1 );
    deduped_6_1 := ValuesOfPreSheaf( T_1 )[1];
    hoisted_5_1 := Range( cat_1 );
    hoisted_4_1 := CommutativeRingOfLinearCategory( deduped_7_1 );
    hoisted_3_1 := List( deduped_6_1, RankOfObject );
    hoisted_1_1 := ValuesOfPreSheaf( P_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_7_1 )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( hoisted_5_1, hoisted_1_1[o_2], deduped_6_1[o_2], UnderlyingMatrix, UnionOfRows( hoisted_4_1, hoisted_3_1[o_2], List( tau_1, function ( logic_new_func_x_3 )
                          return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                      end ) ) );
          end ) );
end
...
function ( cat_1, T_1, P_1 )
    ...
    deduped_7_1 := ValuesOfPreSheaf( P_1 )[1];
    hoisted_6_1 := Range( cat_1 );
    hoisted_5_1 := CommutativeRingOfLinearCategory( deduped_9_1 );
    hoisted_4_1 := List( deduped_8_1, RankOfObject );
    hoisted_3_1 := List( deduped_7_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_9_1 )[1] ], function ( o_2 )
...
function ( cat_1, morphisms_1, T_1, tau_1, P_1 )
    local deduped_1_1, hoisted_3_1, hoisted_4_1, hoisted_5_1, hoisted_6_1, deduped_7_1, deduped_9_1, deduped_10_1, deduped_11_1;
    deduped_11_1 := Length( morphisms_1 );
    deduped_10_1 := Source( cat_1 );
    ...
    hoisted_3_1 := [ 1 .. deduped_11_1 ];
    deduped_1_1 := CommutativeRingOfLinearCategory( deduped_10_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, T_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_10_1 )[1] ], function ( o_2 )
...
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    ...
    hoisted_3_1 := CommutativeRingOfLinearCategory( deduped_6_1 );
    hoisted_2_1 := List( deduped_5_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_6_1 )[1] ], function ( o_2 )
              local deduped_1_2;
...
########
function ( cat_1, objects_1, T_1, tau_1, P_1 )
    local hoisted_2_1, hoisted_3_1, hoisted_4_1, hoisted_5_1, deduped_6_1, deduped_7_1;
    deduped_7_1 := Source( cat_1 );
    deduped_6_1 := ValuesOfPreSheaf( T_1 )[1];
    hoisted_5_1 := Range( cat_1 );
    hoisted_4_1 := CommutativeRingOfLinearCategory( deduped_7_1 );
    hoisted_3_1 := List( deduped_6_1, RankOfObject );
    hoisted_2_1 := ValuesOfPreSheaf( P_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_7_1 )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( hoisted_5_1, deduped_6_1[o_2], hoisted_2_1[o_2], UnderlyingMatrix, UnionOfColumns( hoisted_4_1, hoisted_3_1[o_2], List( tau_1, function ( logic_new_func_x_3 )
                          return UnderlyingMatrix( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) );
                      end ) ) );
          end ) );
end
...
########
function ( cat_1, Y_1, morphisms_1, T_1, tau_1, P_1 )
    local hoisted_1_1, hoisted_2_1, hoisted_3_1, hoisted_4_1, deduped_5_1, hoisted_6_1, deduped_7_1, deduped_8_1, deduped_9_1, deduped_10_1;
    deduped_10_1 := Length( morphisms_1 );
    deduped_9_1 := ValuesOnAllObjects( tau_1 );
    deduped_8_1 := Source( cat_1 );
    deduped_7_1 := Range( cat_1 );
    hoisted_6_1 := [ 2 .. deduped_10_1 ];
    deduped_5_1 := CommutativeRingOfLinearCategory( deduped_8_1 );
    hoisted_4_1 := [ 1 .. deduped_10_1 - 1 ];
    hoisted_3_1 := List( ValuesOfPreSheaf( Y_1 )[1], RankOfObject );
    hoisted_2_1 := List( deduped_9_1, UnderlyingMatrix );
    hoisted_1_1 := List( deduped_9_1, Source );
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_8_1 )[1] ], function ( o_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
...
########
function ( cat_1, morphisms_1, T_1, tau_1, P_1 )
    local hoisted_2_1, deduped_3_1, hoisted_5_1, hoisted_6_1, hoisted_7_1, deduped_8_1, deduped_9_1, deduped_10_1, deduped_11_1;
    deduped_11_1 := Length( morphisms_1 );
    deduped_10_1 := Source( cat_1 );
    deduped_9_1 := ValuesOfPreSheaf( T_1 )[1];
    deduped_8_1 := Range( cat_1 );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_10_1 )[1] ], function ( o_2 )
              local deduped_2_2, deduped_3_2, deduped_4_2, deduped_5_2;
              deduped_5_2 := List( morphisms_1, function ( logic_new_func_x_3 )
                      return RankOfObject( Source( CAP_JIT_INCOMPLETE_LOGIC( ValuesOnAllObjects( logic_new_func_x_3 )[o_2] ) ) );
                  end );
...
function ( cat_1, T_1, P_1 )
    ...
    hoisted_4_1 := List( deduped_8_1, RankOfObject );
    hoisted_3_1 := List( deduped_7_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, T_1, P_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_9_1 )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( hoisted_6_1, deduped_7_1[o_2], deduped_8_1[o_2], UnderlyingMatrix, HomalgZeroMatrix( hoisted_3_1[o_2], hoisted_4_1[o_2], hoisted_5_1 ) );
          end ) );
end
########
...
function ( cat_1, a_1, b_1 )
    ...
    hoisted_4_1 := List( deduped_8_1, RankOfObject );
    hoisted_3_1 := List( deduped_7_1, RankOfObject );
    return CreateCapCategoryMorphismWithAttributes( cat_1, a_1, b_1, ValuesOnAllObjects, LazyHList( [ 1 .. DefiningTripleOfUnderlyingQuiver( deduped_9_1 )[1] ], function ( o_2 )
              return CreateCapCategoryMorphismWithAttributes( hoisted_6_1, deduped_7_1[o_2], deduped_8_1[o_2], UnderlyingMatrix, HomalgZeroMatrix( hoisted_3_1[o_2], hoisted_4_1[o_2], hoisted_5_1 ) );
          end ) );
end
########
...
function ( cat_1 )
    ...
    deduped_5_1 := Source( cat_1 );
    deduped_4_1 := DefiningTripleOfUnderlyingQuiver( deduped_5_1 );
    hoisted_3_1 := HomalgZeroMatrix( 0, 0, CommutativeRingOfLinearCategory( deduped_5_1 ) );
    deduped_1_1 := CreateCapCategoryObjectWithAttributes( deduped_6_1, RankOfObject, 0 );
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_5_1, Range, deduped_6_1, ValuesOfPreSheaf, NTuple( 2, LazyHList( [ 1 .. deduped_4_1[1] ], function ( o_2 )
                return deduped_1_1;
            end ), LazyHList( [ 1 .. deduped_4_1[2] ], function ( m_2 )
