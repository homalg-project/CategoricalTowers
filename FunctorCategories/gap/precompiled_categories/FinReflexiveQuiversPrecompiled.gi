...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_50_1 := deduped_55_1[2];
    deduped_49_1 := deduped_55_1[1];
    deduped_48_1 := CreateCapCategoryObjectWithAttributes( deduped_54_1, IndexOfObject, 1 );
    deduped_47_1 := CreateCapCategoryObjectWithAttributes( deduped_54_1, IndexOfObject, 0 );
    deduped_46_1 := deduped_53_1[2];
    deduped_45_1 := deduped_53_1[1];
    deduped_44_1 := CreateCapCategoryMorphismWithAttributes( deduped_54_1, deduped_47_1, deduped_48_1, IndexOfMorphism, 3 );
    deduped_43_1 := CreateCapCategoryMorphismWithAttributes( deduped_54_1, deduped_47_1, deduped_48_1, IndexOfMorphism, 2 );
    deduped_42_1 := CreateCapCategoryMorphismWithAttributes( deduped_54_1, deduped_48_1, deduped_47_1, IndexOfMorphism, 1 );
    deduped_41_1 := ListWithIdenticalEntries( deduped_46_1, deduped_48_1 );
    deduped_40_1 := ListWithIdenticalEntries( deduped_45_1, deduped_47_1 );
    deduped_39_1 := [ 0 .. deduped_46_1 - 1 ];
    deduped_38_1 := [ 0 .. deduped_45_1 - 1 ];
    deduped_37_1 := [ 0 .. Sum( [ deduped_45_1, deduped_46_1, deduped_46_1 ] ) - 1 ];
    deduped_2_1 := [ deduped_49_1, deduped_50_1 ];
    deduped_1_1 := [ deduped_47_1, deduped_48_1 ];
    deduped_35_1 := Concatenation( List( deduped_40_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_36_1 := List( deduped_39_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_33_1 := Product( deduped_35_1{[ 1 .. deduped_45_1 ]} );
    ...
    deduped_12_1 := [ deduped_55_1[3], List( deduped_51_1, function ( a_2 )
                return a_2[1];
    ...
    deduped_3_1 := Concatenation( ListWithIdenticalEntries( Length( deduped_38_1 ), deduped_34_1 ), deduped_32_1, deduped_32_1 );
    ...
    hoisted_20_1 := Concatenation( List( deduped_38_1, function ( i_2 )
              local hoisted_1_2;
              hoisted_1_2 := deduped_6_1[1 + (deduped_4_1[1 + i_2] + deduped_45_1)];
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
                   end )];
    ...
    hoisted_29_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_30_1, deduped_33_1 ), Product( deduped_35_1{[ 1 + deduped_45_1 .. Sum( [ deduped_45_1, deduped_46_1 ]{[ 1, 2 ]} ) ]} ) ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( deduped_38_1, function ( i_2 )
                return REM_INT( QUO_INT( hoisted_27_1, deduped_49_1 ^ i_2 ), deduped_49_1 );
            end ), List( deduped_39_1, function ( i_2 )
                return REM_INT( QUO_INT( hoisted_29_1, deduped_50_1 ^ i_2 ), deduped_50_1 );
            end ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_1_1 := [ deduped_50_1, deduped_52_1 ];
    deduped_39_1 := Concatenation( List( deduped_44_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_40_1 := List( deduped_43_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_3_1 := Concatenation( ListWithIdenticalEntries( Length( deduped_42_1 ), deduped_38_1 ), deduped_37_1, deduped_37_1 );
    ...
    hoisted_20_1 := Concatenation( List( deduped_42_1, function ( i_2 )
              local hoisted_1_2;
              hoisted_1_2 := deduped_6_1[1 + (deduped_4_1[1 + i_2] + deduped_49_1)];
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
                   end )];
    ...
    hoisted_31_1 := Product( deduped_39_1{[ 1 + deduped_49_1 .. Sum( [ deduped_49_1, deduped_51_1 ]{[ 1, 2 ]} ) ]} );
    deduped_28_1 := Product( deduped_39_1{[ 1 .. deduped_49_1 ]} );
