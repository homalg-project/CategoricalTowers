...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_26_1 := List( deduped_32_1, function ( i_2 )
            return Sum( List( hoisted_10_1, function ( k_3 )
                      return hoisted_25_1[(1 + REM_INT( QUO_INT( i_2, hoisted_9_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_9_1 ))] * hoisted_16_1 ^ k_3;
                  end ) );
        end );
    hoisted_23_1 := List( deduped_44_1, function ( a_2 )
            return a_2[2];
        end );
    hoisted_12_1 := [ 0 .. deduped_41_1 - 1 ];
    hoisted_24_1 := List( deduped_33_1, function ( i_2 )
            ...
            return Sum( List( hoisted_10_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_23_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_16_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_22_1 := List( deduped_32_1, function ( i_2 )
            return Sum( List( hoisted_10_1, function ( k_3 )
                      return hoisted_21_1[(1 + REM_INT( QUO_INT( i_2, hoisted_9_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_9_1 ))] * hoisted_16_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_20_1 := List( deduped_33_1, function ( i_2 )
            ...
            return Sum( List( hoisted_10_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_19_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_16_1 ^ k_3;
                  end ) );
        end );
    hoisted_17_1 := deduped_46_1[3];
    hoisted_18_1 := List( deduped_33_1, function ( i_2 )
            return Sum( List( hoisted_12_1, function ( k_3 )
                      return hoisted_17_1[(1 + REM_INT( QUO_INT( i_2, hoisted_16_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_16_1 ))] * hoisted_9_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_15_1 := List( deduped_32_1, function ( i_2 )
            ...
            return Sum( List( hoisted_12_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_11_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_9_1 ^ k_3;
                  end ) );
        end );
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    hoisted_11_1 := deduped_61_1;
    hoisted_2_1 := deduped_60_1;
    hoisted_26_1 := List( deduped_47_1, function ( i_2 )
            return Sum( List( hoisted_12_1, function ( k_3 )
                      return hoisted_25_1[(1 + REM_INT( QUO_INT( i_2, hoisted_11_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_11_1 ))] * hoisted_2_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_24_1 := List( deduped_48_1, function ( i_2 )
            ...
            return Sum( List( hoisted_12_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_23_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_2_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_22_1 := List( deduped_47_1, function ( i_2 )
            return Sum( List( hoisted_12_1, function ( k_3 )
                      return hoisted_21_1[(1 + REM_INT( QUO_INT( i_2, hoisted_11_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_11_1 ))] * hoisted_2_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_20_1 := List( deduped_48_1, function ( i_2 )
            ...
            return Sum( List( hoisted_12_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_19_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_2_1 ^ k_3;
                  end ) );
        end );
    hoisted_17_1 := deduped_66_1[3];
    hoisted_18_1 := List( deduped_48_1, function ( i_2 )
            return Sum( List( hoisted_14_1, function ( k_3 )
                      return hoisted_17_1[(1 + REM_INT( QUO_INT( i_2, hoisted_2_1 ^ CAP_JIT_INCOMPLETE_LOGIC( k_3 ) ), hoisted_2_1 ))] * hoisted_11_1 ^ k_3;
                  end ) );
        end );
    ...
    hoisted_16_1 := List( deduped_47_1, function ( i_2 )
            ...
            return Sum( List( hoisted_14_1, function ( k_3 )
                      return hoisted_1_2[(1 + hoisted_13_1[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_3 ))])] * hoisted_11_1 ^ k_3;
                  end ) );
        end );
    hoisted_15_1 := deduped_55_1;
    hoisted_1_1 := deduped_54_1;
    ...
    hoisted_9_1 := [ 1, deduped_56_1, Product( deduped_50_1{deduped_67_1} ), Product( deduped_50_1{deduped_68_1} ), Product( deduped_50_1{deduped_69_1} ), Product( deduped_50_1{[ 1, 2, 3, 4, 5 ]} ) ];
    ...
    hoisted_38_1 := deduped_59_1;
    hoisted_28_1 := deduped_42_1;
    hoisted_36_1 := List( deduped_41_1, function ( i_2 )
            return REM_INT( QUO_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_28_1[1 + i_2] ), hoisted_1_1 ), hoisted_15_1 );
        end );
    hoisted_29_1 := AsList( alpha_1 );
    hoisted_37_1 := List( deduped_53_1, function ( i_2 )
            return hoisted_36_1[1 + hoisted_29_1[(1 + i_2)]];
        end );
    hoisted_31_1 := deduped_64_1;
    hoisted_40_1 := List( [ 0 .. deduped_64_1 * deduped_59_1 - 1 ], function ( logic_new_func_x_2 )
            ...
            return hoisted_39_1[1 + (hoisted_37_1[1 + REM_INT( deduped_1_2, hoisted_31_1 )] + REM_INT( QUO_INT( deduped_1_2, hoisted_31_1 ), hoisted_38_1 ) * hoisted_15_1)];
        end );
    ...
    hoisted_33_1 := deduped_58_1;
    hoisted_30_1 := List( deduped_41_1, function ( i_2 )
            return REM_INT( CAP_JIT_INCOMPLETE_LOGIC( hoisted_28_1[1 + i_2] ), hoisted_1_1 );
        end );
    hoisted_32_1 := List( deduped_53_1, function ( i_2 )
            return hoisted_30_1[1 + hoisted_29_1[(1 + i_2)]];
        end );
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    hoisted_16_1 := deduped_52_1;
    hoisted_10_1 := deduped_46_1;
    hoisted_9_1 := deduped_54_1;
    ...
    hoisted_8_1 := [ 0, 1, 2, 3, 4, 5 ];
    hoisted_7_1 := [ 1, deduped_50_1, Product( deduped_45_1{deduped_60_1} ), Product( deduped_45_1{deduped_61_1} ), Product( deduped_45_1{deduped_62_1} ), Product( deduped_45_1{[ 1, 2, 3, 4, 5 ]} ) ];
    ...
    hoisted_33_1 := deduped_55_1;
    hoisted_34_1 := List( deduped_46_1, function ( logic_new_func_x_2 )
            return REM_INT( logic_new_func_x_2, hoisted_33_1 );
        end );
    ...
    hoisted_31_1 := List( deduped_47_1, function ( logic_new_func_x_2 )
            return REM_INT( logic_new_func_x_2, hoisted_30_1 );
        end );
    hoisted_29_1 := deduped_37_1;
    hoisted_28_1 := deduped_36_1;
