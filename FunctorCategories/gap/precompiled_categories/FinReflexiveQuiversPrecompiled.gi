...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Length, BigInt( Length( Filtered( deduped_20_1, function ( x_2 )
                  local deduped_1_2;
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Length, BigInt( Length( Filtered( deduped_22_1, function ( x_2 )
                  local deduped_1_2;
                  deduped_1_2 := 1 + x_2;
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_49_1 := CreateCapCategoryObjectWithAttributes( deduped_53_1, IndexOfObject, 1 );
    ...
    deduped_38_1 := [ CreateCapCategoryMorphismWithAttributes( deduped_53_1, deduped_49_1, deduped_50_1, IndexOfMorphism, 1 ), CreateCapCategoryMorphismWithAttributes( deduped_53_1, deduped_50_1, deduped_49_1, IndexOfMorphism, 2 ), CreateCapCategoryMorphismWithAttributes( deduped_53_1, deduped_50_1, deduped_49_1, IndexOfMorphism, 3 ) ];
    deduped_37_1 := [ deduped_52_1[3], List( deduped_48_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_48_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_36_1 := Concatenation( ListWithIdenticalEntries( deduped_43_1, deduped_44_1 ), ListWithIdenticalEntries( deduped_45_1, deduped_46_1 ) );
    deduped_35_1 := ListWithIdenticalEntries( deduped_45_1, [ 0 .. deduped_44_1 - 1 ] );
    deduped_34_1 := Product( deduped_36_1 );
    deduped_33_1 := [ 0 .. Sum( [ deduped_43_1, deduped_45_1, deduped_45_1 ] ) - 1 ];
    deduped_32_1 := ListWithIdenticalEntries( deduped_45_1, deduped_34_1 );
    deduped_31_1 := [ 0 .. deduped_34_1 - 1 ];
    deduped_4_1 := [ deduped_43_1 .. deduped_41_1 - 1 ];
    deduped_29_1 := List( deduped_40_1, function ( i_2 )
            local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
            deduped_7_2 := deduped_4_1[1 + i_2];
            deduped_6_2 := 1 + deduped_7_2;
            deduped_5_2 := deduped_36_1[deduped_6_2];
            deduped_4_2 := Product( deduped_36_1{[ 1 .. deduped_7_2 ]} );
            hoisted_3_2 := DivIntWithGivenQuotient( deduped_34_1, deduped_4_2, deduped_5_2 * Product( deduped_36_1{[ (deduped_6_2 + 1) .. deduped_41_1 ]} ) );
    ...
    hoisted_17_1 := Concatenation( List( deduped_39_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2;
              deduped_6_2 := 1 + i_2;
              deduped_5_2 := deduped_36_1[deduped_6_2];
              deduped_4_2 := Product( deduped_36_1{[ 1 .. i_2 ]} );
              hoisted_3_2 := DivIntWithGivenQuotient( deduped_34_1, deduped_4_2, deduped_5_2 * Product( deduped_36_1{[ (deduped_6_2 + 1) .. deduped_41_1 ]} ) );
              return List( deduped_31_1, function ( i_3 )
                      return RemIntWithDomain( QuoIntWithDomain( i_3, deduped_4_2, deduped_34_1 ), deduped_5_2, hoisted_3_2 );
                  end );
          end ), deduped_29_1, deduped_29_1 );
    hoisted_16_1 := Concatenation( ListWithIdenticalEntries( deduped_43_1, deduped_37_1[SafeUniquePositionProperty( deduped_38_1, function ( mor_2 )
                 if IndexOfObject( Source( mor_2 ) ) = 1 and IndexOfObject( Range( mor_2 ) ) = 0 then
                     return IndexOfMorphism( mor_2 ) = 1;
                 else
                     return false;
                 ...
                 return;
             end )] ), ListWithIdenticalEntries( deduped_45_1, deduped_37_1[SafeUniquePositionProperty( deduped_38_1, function ( mor_2 )
                 if IndexOfObject( Source( mor_2 ) ) = 0 and IndexOfObject( Range( mor_2 ) ) = 1 then
                     return IndexOfMorphism( mor_2 ) = 2;
                 else
                     return false;
    ...
    deduped_1_1 := Concatenation( ListWithIdenticalEntries( deduped_43_1, deduped_34_1 ), deduped_32_1, deduped_32_1 );
    ...
    hoisted_13_1 := Concatenation( ListWithIdenticalEntries( deduped_43_1, deduped_46_1 ), deduped_42_1, deduped_42_1 );
    deduped_14_1 := List( deduped_33_1, function ( j_2 )
            return Product( hoisted_13_1{[ 1 .. j_2 ]} );
        end );
    hoisted_10_1 := List( deduped_47_1, function ( a_2 )
            return a_2[2];
        end );
    hoisted_9_1 := List( deduped_47_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_3_1 := deduped_51_1[3];
    hoisted_11_1 := Concatenation( List( deduped_39_1, function ( i_2 )
              local hoisted_3_2, deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 := deduped_4_1[1 + hoisted_3_1[(1 + i_2)]];
              deduped_6_2 := 1 + deduped_7_2;
              deduped_5_2 := deduped_36_1[deduped_6_2];
    ...
    hoisted_2_1 := Concatenation( ListWithIdenticalEntries( deduped_43_1, [ 0 .. deduped_46_1 - 1 ] ), deduped_35_1, deduped_35_1 );
    ...
    deduped_19_1 := Product( deduped_36_1{[ 1 .. deduped_43_1 ]} );
    ...
    return List( [ 0 .. BigInt( Length( deduped_30_1 ) ) - 1 ], function ( i_2 )
            ...
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( deduped_39_1, function ( i_3 )
