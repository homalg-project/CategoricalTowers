...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( deduped_43_1, function ( i_2 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    return List( [ 0 .. BigInt( Length( deduped_32_1 ) ) - 1 ], function ( i_2 )
            ...
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfReflexiveQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( deduped_43_1, function ( i_3 )
