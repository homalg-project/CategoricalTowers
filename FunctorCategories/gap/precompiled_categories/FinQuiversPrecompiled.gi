...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_1_1 := [ 0, 1 ];
    deduped_29_1 := Concatenation( List( deduped_32_1, function ( objB_2 )
    ...
    deduped_27_1 := List( deduped_31_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_26_1 := ListWithIdenticalEntries( Length( deduped_31_1 ), deduped_28_1 );
    hoisted_23_1 := Concatenation( deduped_27_1, deduped_27_1 );
    ...
    hoisted_18_1 := Concatenation( List( deduped_31_1, function ( i_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, deduped_5_1[1 + deduped_4_1[(1 + i_2)]] )];
          end ), List( deduped_31_1, function ( i_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, deduped_5_1[1 + deduped_12_1[(1 + i_2)]] )];
          end ) );
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_51_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( range_1 );
    deduped_50_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( source_1 );
    deduped_49_1 := deduped_51_1[3];
    deduped_48_1 := deduped_50_1[3];
    deduped_47_1 := CreateCapCategoryObjectWithAttributes( deduped_52_1, IndexOfObject, 1 );
    deduped_46_1 := CreateCapCategoryObjectWithAttributes( deduped_52_1, IndexOfObject, 0 );
    deduped_45_1 := deduped_51_1[2];
    deduped_44_1 := deduped_51_1[1];
    deduped_43_1 := deduped_50_1[2];
    deduped_42_1 := deduped_50_1[1];
    deduped_41_1 := CreateCapCategoryMorphismWithAttributes( deduped_52_1, deduped_46_1, deduped_47_1, IndexOfMorphism, 2 );
    deduped_40_1 := CreateCapCategoryMorphismWithAttributes( deduped_52_1, deduped_46_1, deduped_47_1, IndexOfMorphism, 1 );
    deduped_39_1 := ListWithIdenticalEntries( deduped_43_1, deduped_47_1 );
    deduped_38_1 := ListWithIdenticalEntries( deduped_42_1, deduped_46_1 );
    deduped_37_1 := [ 0 .. deduped_43_1 - 1 ];
    deduped_36_1 := [ 0 .. deduped_43_1 + deduped_43_1 - 1 ];
    deduped_2_1 := [ deduped_44_1, deduped_45_1 ];
    deduped_1_1 := [ 0, 1 ];
    deduped_35_1 := Concatenation( List( deduped_38_1, function ( objB_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, IndexOfObject( objB_2 ) )];
          end ), List( deduped_39_1, function ( objB_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, IndexOfObject( objB_2 ) )];
          end ) );
    deduped_34_1 := Product( deduped_35_1 );
    deduped_30_1 := [ 0 .. deduped_34_1 - 1 ];
    deduped_33_1 := List( deduped_37_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_32_1 := Product( deduped_35_1{[ 1 .. deduped_42_1 ]} );
    deduped_31_1 := ListWithIdenticalEntries( Length( deduped_37_1 ), deduped_34_1 );
    hoisted_23_1 := Concatenation( deduped_33_1, deduped_33_1 );
    deduped_11_1 := [ List( deduped_49_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_49_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_10_1 := [ deduped_40_1, deduped_41_1 ];
    deduped_9_1 := [ 0, 1, 2, 3 ];
    deduped_8_1 := [ 0, 1, 1, 1 ];
    deduped_7_1 := [ 0, 0, 0, 1 ];
    deduped_6_1 := [ 0, 3 ];
    hoisted_21_1 := Concatenation( List( ListWithIdenticalEntries( deduped_43_1, deduped_40_1 ), function ( morB_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 := IndexOfMorphism( morB_2 );
              deduped_6_2 := IndexOfObject( Range( morB_2 ) );
              deduped_5_2 := IndexOfObject( Source( morB_2 ) );
              ...
              return;
          end ), List( ListWithIdenticalEntries( deduped_43_1, deduped_41_1 ), function ( morB_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 := IndexOfMorphism( morB_2 );
              deduped_6_2 := IndexOfObject( Range( morB_2 ) );
              deduped_5_2 := IndexOfObject( Source( morB_2 ) );
    ...
    hoisted_24_1 := List( deduped_36_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := 1 + i_2;
            hoisted_2_2 := hoisted_21_1[deduped_3_2];
            hoisted_1_2 := hoisted_23_1[deduped_3_2];
    ...
    deduped_5_1 := Concatenation( List( deduped_38_1, IndexOfObject ), List( deduped_39_1, IndexOfObject ) );
    deduped_4_1 := List( deduped_48_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_18_1 := Concatenation( List( deduped_37_1, function ( i_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, deduped_5_1[1 + deduped_4_1[(1 + i_2)]] )];
          end ), List( deduped_37_1, function ( i_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, deduped_5_1[1 + deduped_12_1[(1 + i_2)]] )];
          end ) );
    deduped_19_1 := List( deduped_36_1, function ( j_2 )
            return Product( hoisted_18_1{[ 1 .. j_2 ]} );
        end );
    hoisted_16_1 := Concatenation( List( deduped_37_1, function ( i_2 )
              local hoisted_1_2, hoisted_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_4_1[(1 + i_2)];
              hoisted_2_2 := deduped_35_1[deduped_3_2];
              hoisted_1_2 := Product( deduped_35_1{[ 1 .. deduped_3_2 - 1 ]} );
    ...
    hoisted_13_1 := Concatenation( List( deduped_37_1, function ( i_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2, deduped_8_2;
              deduped_8_2 := 1 + deduped_6_1[(1 + deduped_5_1[(1 + deduped_4_1[(1 + i_2)])])];
              deduped_7_2 := deduped_9_1[deduped_8_2];
              deduped_6_2 := deduped_8_1[deduped_8_2];
    ...
    hoisted_28_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_29_1, deduped_32_1 ), Product( deduped_35_1{[ 1 + deduped_42_1 .. Sum( [ deduped_42_1, deduped_43_1 ]{[ 1, 2 ]} ) ]} ) ) );
    hoisted_26_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( deduped_29_1, deduped_32_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( [ 0 .. deduped_42_1 - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_26_1, deduped_44_1 ^ i_2 ), deduped_44_1 );
            end ), List( deduped_37_1, function ( i_2 )
                return REM_INT( QUO_INT( hoisted_28_1, deduped_45_1 ^ i_2 ), deduped_45_1 );
            end ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_56_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( arg3_1 );
    deduped_55_1 := UnderlyingCategory( cat_1 );
    deduped_54_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( arg2_1 );
    deduped_53_1 := deduped_56_1[3];
    deduped_52_1 := deduped_54_1[3];
    deduped_51_1 := deduped_56_1[2];
    deduped_50_1 := deduped_56_1[1];
    deduped_49_1 := CreateCapCategoryObjectWithAttributes( deduped_55_1, IndexOfObject, 1 );
    deduped_48_1 := deduped_54_1[2];
    deduped_47_1 := CreateCapCategoryObjectWithAttributes( deduped_55_1, IndexOfObject, 0 );
    deduped_46_1 := deduped_54_1[1];
    deduped_45_1 := CreateCapCategoryMorphismWithAttributes( deduped_55_1, deduped_47_1, deduped_49_1, IndexOfMorphism, 2 );
    deduped_44_1 := CreateCapCategoryMorphismWithAttributes( deduped_55_1, deduped_47_1, deduped_49_1, IndexOfMorphism, 1 );
    deduped_43_1 := ListWithIdenticalEntries( deduped_48_1, deduped_49_1 );
    deduped_42_1 := ListWithIdenticalEntries( deduped_46_1, deduped_47_1 );
    deduped_41_1 := [ 0 .. deduped_48_1 - 1 ];
    deduped_40_1 := [ 0 .. deduped_48_1 + deduped_48_1 - 1 ];
    deduped_2_1 := [ deduped_50_1, deduped_51_1 ];
    deduped_1_1 := [ 0, 1 ];
    deduped_39_1 := Concatenation( List( deduped_42_1, function ( objB_2 )
              return deduped_2_1[SafeUniquePosition( deduped_1_1, IndexOfObject( objB_2 ) )];
    ...
    deduped_37_1 := List( deduped_41_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_36_1 := ListWithIdenticalEntries( Length( deduped_41_1 ), deduped_38_1 );
    hoisted_23_1 := Concatenation( deduped_37_1, deduped_37_1 );
    deduped_11_1 := [ List( deduped_53_1, function ( a_2 )
                return a_2[1];
    ...
    deduped_7_1 := [ 0, 0, 0, 1 ];
    deduped_6_1 := [ 0, 3 ];
    hoisted_21_1 := Concatenation( List( ListWithIdenticalEntries( deduped_48_1, deduped_44_1 ), function ( morB_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2;
              deduped_7_2 := IndexOfMorphism( morB_2 );
              deduped_6_2 := IndexOfObject( Range( morB_2 ) );
              deduped_5_2 := IndexOfObject( Source( morB_2 ) );
    ...
    hoisted_24_1 := List( deduped_40_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := 1 + i_2;
            hoisted_2_2 := hoisted_21_1[deduped_3_2];
            hoisted_1_2 := hoisted_23_1[deduped_3_2];
    ...
    deduped_12_1 := List( deduped_52_1, function ( a_2 )
            return a_2[2];
        end );
    deduped_5_1 := Concatenation( List( deduped_42_1, IndexOfObject ), List( deduped_43_1, IndexOfObject ) );
    deduped_4_1 := List( deduped_52_1, function ( a_2 )
            return a_2[1];
        end );
    ...
    deduped_19_1 := List( deduped_40_1, function ( j_2 )
            return Product( hoisted_18_1{[ 1 .. j_2 ]} );
        end );
    hoisted_16_1 := Concatenation( List( deduped_41_1, function ( i_2 )
              local hoisted_1_2, hoisted_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_4_1[(1 + i_2)];
              hoisted_2_2 := deduped_39_1[deduped_3_2];
              hoisted_1_2 := Product( deduped_39_1{[ 1 .. deduped_3_2 - 1 ]} );
    ...
    hoisted_13_1 := Concatenation( List( deduped_41_1, function ( i_2 )
              local deduped_4_2, deduped_5_2, deduped_6_2, deduped_7_2, deduped_8_2;
              deduped_8_2 := 1 + deduped_6_1[(1 + deduped_5_1[(1 + deduped_4_1[(1 + i_2)])])];
              deduped_7_2 := deduped_9_1[deduped_8_2];
              deduped_6_2 := deduped_8_1[deduped_8_2];
    ...
    hoisted_17_1 := List( deduped_40_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := 1 + i_2;
            hoisted_2_2 := hoisted_13_1[deduped_3_2];
            hoisted_1_2 := hoisted_16_1[deduped_3_2];
    ...
    hoisted_30_1 := Product( deduped_39_1{[ 1 + deduped_46_1 .. Sum( [ deduped_46_1, deduped_48_1 ]{[ 1, 2 ]} ) ]} );
    hoisted_29_1 := [ 0 .. deduped_46_1 - 1 ];
    deduped_27_1 := Product( deduped_39_1{[ 1 .. deduped_46_1 ]} );
    return List( [ 0 .. deduped_33_1 - 1 ], function ( i_2 )
            ...
            return CreateCapCategoryMorphismWithAttributes( cat_1, arg2_1, arg3_1, DefiningPairOfQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( hoisted_29_1, function ( i_3 )
                        return REM_INT( QUO_INT( hoisted_1_2, deduped_50_1 ^ i_3 ), deduped_50_1 );
                    end ), List( deduped_41_1, function ( i_3 )
                        return REM_INT( QUO_INT( hoisted_2_2, deduped_51_1 ^ i_3 ), deduped_51_1 );
                    end ) ) );
        end );
end
########
