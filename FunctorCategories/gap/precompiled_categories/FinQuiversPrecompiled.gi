...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_47_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( arg3_1 );
    ...
    deduped_38_1 := CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_40_1, deduped_42_1, IndexOfMorphism, 2 );
    deduped_37_1 := CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_40_1, deduped_42_1, IndexOfMorphism, 1 );
    deduped_36_1 := ListWithIdenticalEntries( deduped_41_1, deduped_42_1 );
    deduped_35_1 := ListWithIdenticalEntries( deduped_39_1, deduped_40_1 );
    deduped_34_1 := [ 0 .. deduped_41_1 - 1 ];
    deduped_33_1 := [ 0 .. deduped_41_1 + deduped_41_1 - 1 ];
    deduped_2_1 := [ deduped_47_1[1], deduped_47_1[2] ];
    deduped_1_1 := [ deduped_40_1, deduped_42_1 ];
    deduped_32_1 := Concatenation( List( deduped_35_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ), List( deduped_36_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ) );
    deduped_31_1 := Product( deduped_32_1 );
    deduped_30_1 := ListWithIdenticalEntries( Length( deduped_34_1 ), deduped_31_1 );
    deduped_29_1 := [ 0 .. deduped_31_1 - 1 ];
    deduped_28_1 := List( deduped_34_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    hoisted_26_1 := Concatenation( deduped_28_1, deduped_28_1 );
    deduped_13_1 := [ List( deduped_44_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_44_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_12_1 := [ deduped_37_1, deduped_38_1 ];
    deduped_9_1 := [ 0, 1, 2, 3 ];
    deduped_8_1 := [ 0, 1, 1, 1 ];
    deduped_7_1 := [ 0, 0, 0, 1 ];
    deduped_6_1 := [ 0, 3 ];
    hoisted_24_1 := Concatenation( List( ListWithIdenticalEntries( deduped_41_1, deduped_37_1 ), function ( morB_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := Source( morB_2 );
              deduped_2_2 := IndexOfObject( deduped_3_2 );
              deduped_1_2 := 1 + deduped_6_1[(1 + deduped_2_2)];
              if IdFunc( function (  )
                          if deduped_2_2 = deduped_7_1[deduped_1_2] and IndexOfObject( Range( morB_2 ) ) = deduped_8_1[deduped_1_2] then
                              return IndexOfMorphism( morB_2 ) = deduped_9_1[deduped_1_2];
                          else
                              return false;
                          fi;
                          return;
    ...
    deduped_3_1 := Concatenation( deduped_30_1, deduped_30_1 );
    ...
    deduped_20_1 := Concatenation( deduped_35_1, deduped_36_1 );
    deduped_14_1 := List( deduped_43_1, function ( a_2 )
            return a_2[2];
        end );
    deduped_4_1 := List( deduped_43_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_21_1 := Concatenation( List( deduped_34_1, function ( i_2 )
    ...
    deduped_22_1 := List( deduped_33_1, function ( j_2 )
    ...
    deduped_11_1 := [ CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_40_1, deduped_40_1, IndexOfMorphism, 0 ), deduped_37_1, deduped_38_1, CreateCapCategoryMorphismWithAttributes( deduped_46_1, deduped_42_1, deduped_42_1, IndexOfMorphism, 3 ) ];
    deduped_10_1 := [ deduped_40_1, deduped_40_1, deduped_40_1, deduped_42_1 ];
    deduped_5_1 := Concatenation( List( deduped_35_1, IndexOfObject ), List( deduped_36_1, IndexOfObject ) );
    hoisted_15_1 := Concatenation( List( deduped_34_1, function ( i_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_6_1[(1 + deduped_5_1[(1 + deduped_4_1[(1 + i_2)])])];
              ...
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_6_1[(1 + deduped_5_1[(1 + deduped_14_1[(1 + i_2)])])];
              deduped_2_2 := deduped_7_1[deduped_3_2];
              deduped_1_2 := 1 + deduped_6_1[(1 + deduped_2_2)];
              if IdFunc( function (  )
                          if deduped_2_2 = deduped_7_1[deduped_1_2] and deduped_8_1[deduped_3_2] = deduped_8_1[deduped_1_2] then
    ...
    hoisted_19_1 := List( deduped_33_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := 1 + i_2;
    ...
    return CreateCapCategoryObjectWithAttributes( RangeCategoryOfHomomorphismStructure( cat_1 ), Length, Length( Filtered( deduped_29_1, function ( x_2 )
                local deduped_1_2;
...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_58_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( range_1 );
    deduped_57_1 := UnderlyingCategory( cat_1 );
    deduped_56_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( source_1 );
    ...
    deduped_46_1 := CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_49_1, deduped_50_1, IndexOfMorphism, 2 );
    deduped_45_1 := CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_49_1, deduped_50_1, IndexOfMorphism, 1 );
    deduped_44_1 := ListWithIdenticalEntries( deduped_48_1, deduped_50_1 );
    deduped_43_1 := ListWithIdenticalEntries( deduped_47_1, deduped_49_1 );
    deduped_42_1 := [ 0 .. deduped_48_1 - 1 ];
    deduped_41_1 := [ 0 .. deduped_48_1 + deduped_48_1 - 1 ];
    ...
    deduped_37_1 := ListWithIdenticalEntries( Length( deduped_42_1 ), deduped_39_1 );
    deduped_36_1 := deduped_38_1[1];
    deduped_35_1 := [ 0 .. deduped_39_1 - 1 ];
    deduped_34_1 := List( deduped_42_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_33_1 := Product( deduped_40_1{[ 1 .. deduped_36_1 ]} );
    hoisted_26_1 := Concatenation( deduped_34_1, deduped_34_1 );
    deduped_13_1 := [ List( deduped_54_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_54_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_12_1 := [ deduped_45_1, deduped_46_1 ];
    deduped_9_1 := [ 0, 1, 2, 3 ];
    deduped_8_1 := [ 0, 1, 1, 1 ];
    deduped_7_1 := [ 0, 0, 0, 1 ];
    deduped_6_1 := [ 0, 3 ];
    hoisted_24_1 := Concatenation( List( ListWithIdenticalEntries( deduped_48_1, deduped_45_1 ), function ( morB_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := Source( morB_2 );
              deduped_2_2 := IndexOfObject( deduped_3_2 );
              deduped_1_2 := 1 + deduped_6_1[(1 + deduped_2_2)];
    ...
    deduped_3_1 := Concatenation( deduped_37_1, deduped_37_1 );
    ...
    deduped_20_1 := Concatenation( deduped_43_1, deduped_44_1 );
    deduped_14_1 := List( deduped_53_1, function ( a_2 )
            return a_2[2];
        end );
    deduped_4_1 := List( deduped_53_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_21_1 := Concatenation( List( deduped_42_1, function ( i_2 )
              return deduped_2_1[SafePosition( deduped_1_1, deduped_20_1[1 + deduped_4_1[(1 + i_2)]] )];
    ...
    deduped_11_1 := [ CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_49_1, deduped_49_1, IndexOfMorphism, 0 ), deduped_45_1, deduped_46_1, CreateCapCategoryMorphismWithAttributes( deduped_57_1, deduped_50_1, deduped_50_1, IndexOfMorphism, 3 ) ];
    deduped_10_1 := [ deduped_49_1, deduped_49_1, deduped_49_1, deduped_50_1 ];
    deduped_5_1 := Concatenation( List( deduped_43_1, IndexOfObject ), List( deduped_44_1, IndexOfObject ) );
    ...
    deduped_32_1 := CAP_JIT_INCOMPLETE_LOGIC( Filtered( deduped_35_1, function ( x_2 )
                local deduped_1_2;
                deduped_1_2 := 1 + CAP_JIT_INCOMPLETE_LOGIC( x_2 );
    ...
    hoisted_31_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_32_1, deduped_33_1 ), Product( deduped_40_1{[ 1 + deduped_36_1 .. Sum( deduped_38_1{[ 1, 2 ]} ) ]} ) ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( [ 0 .. deduped_36_1 - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_29_1, deduped_51_1 ^ i_2 ), deduped_51_1 );
            end ), List( [ 0 .. deduped_38_1[2] - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_31_1, deduped_52_1 ^ i_2 ), deduped_52_1 );
            end ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_61_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( arg3_1 );
    deduped_60_1 := UnderlyingCategory( cat_1 );
    deduped_59_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( arg2_1 );
    deduped_58_1 := deduped_61_1[3];
    deduped_57_1 := deduped_59_1[3];
    ...
    deduped_50_1 := CreateCapCategoryMorphismWithAttributes( deduped_60_1, deduped_52_1, deduped_54_1, IndexOfMorphism, 2 );
    deduped_49_1 := CreateCapCategoryMorphismWithAttributes( deduped_60_1, deduped_52_1, deduped_54_1, IndexOfMorphism, 1 );
    deduped_48_1 := ListWithIdenticalEntries( deduped_53_1, deduped_54_1 );
    deduped_47_1 := ListWithIdenticalEntries( deduped_51_1, deduped_52_1 );
    deduped_46_1 := [ 0 .. deduped_53_1 - 1 ];
    deduped_45_1 := [ 0 .. deduped_53_1 + deduped_53_1 - 1 ];
    deduped_2_1 := [ deduped_55_1, deduped_56_1 ];
    deduped_1_1 := [ deduped_52_1, deduped_54_1 ];
    deduped_44_1 := Concatenation( List( deduped_47_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ), List( deduped_48_1, function ( objB_2 )
              return deduped_2_1[SafePosition( deduped_1_1, objB_2 )];
          end ) );
    deduped_43_1 := List( ListOfValues( [ CreateCapCategoryObjectWithAttributes( deduped_62_1, Length, deduped_51_1 ), CreateCapCategoryObjectWithAttributes( deduped_62_1, Length, deduped_53_1 ) ] ), Length );
    deduped_42_1 := Product( deduped_44_1 );
    deduped_41_1 := deduped_43_1[1];
    deduped_40_1 := ListWithIdenticalEntries( Length( deduped_46_1 ), deduped_42_1 );
    deduped_39_1 := [ 0 .. deduped_42_1 - 1 ];
    deduped_38_1 := List( deduped_46_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
            deduped_3_2 := 1 + (i_2 + deduped_51_1);
            hoisted_2_2 := deduped_44_1[deduped_3_2];
            hoisted_1_2 := Product( deduped_44_1{[ 1 .. deduped_3_2 - 1 ]} );
            return List( deduped_39_1, function ( i_3 )
                    return REM_INT( QUO_INT( i_3, hoisted_1_2 ), hoisted_2_2 );
                end );
        end );
    hoisted_26_1 := Concatenation( deduped_38_1, deduped_38_1 );
    deduped_13_1 := [ List( deduped_58_1, function ( a_2 )
                return a_2[1];
            end ), List( deduped_58_1, function ( a_2 )
                return a_2[2];
            end ) ];
    deduped_12_1 := [ deduped_49_1, deduped_50_1 ];
    deduped_9_1 := [ 0, 1, 2, 3 ];
    deduped_8_1 := [ 0, 1, 1, 1 ];
    deduped_7_1 := [ 0, 0, 0, 1 ];
    deduped_6_1 := [ 0, 3 ];
    hoisted_24_1 := Concatenation( List( ListWithIdenticalEntries( deduped_53_1, deduped_49_1 ), function ( morB_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := Source( morB_2 );
              deduped_2_2 := IndexOfObject( deduped_3_2 );
              deduped_1_2 := 1 + deduped_6_1[(1 + deduped_2_2)];
    ...
    deduped_3_1 := Concatenation( deduped_40_1, deduped_40_1 );
    ...
    deduped_20_1 := Concatenation( deduped_47_1, deduped_48_1 );
    deduped_14_1 := List( deduped_57_1, function ( a_2 )
            return a_2[2];
        end );
    deduped_4_1 := List( deduped_57_1, function ( a_2 )
            return a_2[1];
        end );
    hoisted_21_1 := Concatenation( List( deduped_46_1, function ( i_2 )
              return deduped_2_1[SafePosition( deduped_1_1, deduped_20_1[1 + deduped_4_1[(1 + i_2)]] )];
          end ), List( deduped_46_1, function ( i_2 )
              return deduped_2_1[SafePosition( deduped_1_1, deduped_20_1[1 + deduped_14_1[(1 + i_2)]] )];
          end ) );
    deduped_22_1 := List( deduped_45_1, function ( j_2 )
            return Product( hoisted_21_1{[ 1 .. j_2 ]} );
        end );
    hoisted_18_1 := Concatenation( List( deduped_46_1, function ( i_2 )
              local hoisted_1_2, hoisted_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_4_1[(1 + i_2)];
              hoisted_2_2 := deduped_44_1[deduped_3_2];
              hoisted_1_2 := Product( deduped_44_1{[ 1 .. deduped_3_2 - 1 ]} );
    ...
    deduped_11_1 := [ CreateCapCategoryMorphismWithAttributes( deduped_60_1, deduped_52_1, deduped_52_1, IndexOfMorphism, 0 ), deduped_49_1, deduped_50_1, CreateCapCategoryMorphismWithAttributes( deduped_60_1, deduped_54_1, deduped_54_1, IndexOfMorphism, 3 ) ];
    deduped_10_1 := [ deduped_52_1, deduped_52_1, deduped_52_1, deduped_54_1 ];
    deduped_5_1 := Concatenation( List( deduped_47_1, IndexOfObject ), List( deduped_48_1, IndexOfObject ) );
    hoisted_15_1 := Concatenation( List( deduped_46_1, function ( i_2 )
              local deduped_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := 1 + deduped_6_1[(1 + deduped_5_1[(1 + deduped_4_1[(1 + i_2)])])];
              deduped_2_2 := deduped_7_1[deduped_3_2];
              deduped_1_2 := 1 + deduped_6_1[(1 + deduped_2_2)];
    ...
    hoisted_33_1 := Product( deduped_44_1{[ 1 + deduped_41_1 .. Sum( deduped_43_1{[ 1, 2 ]} ) ]} );
    hoisted_32_1 := [ 0 .. deduped_41_1 - 1 ];
    deduped_30_1 := Product( deduped_44_1{[ 1 .. deduped_41_1 ]} );
