...
function ( cat_1, source_1, range_1, alpha_1 )
    ...
    deduped_52_1 := DefiningTripleOfQuiverEnrichedOverSkeletalFinSets( range_1 );
    ...
    deduped_47_1 := deduped_52_1[2];
    deduped_46_1 := deduped_52_1[1];
    deduped_45_1 := CreateCapCategoryObjectWithAttributes( deduped_51_1, IndexOfObject, 1 );
    ...
    deduped_41_1 := CreateCapCategoryMorphismWithAttributes( deduped_51_1, deduped_44_1, deduped_45_1, IndexOfMorphism, 2 );
    deduped_40_1 := CreateCapCategoryMorphismWithAttributes( deduped_51_1, deduped_44_1, deduped_45_1, IndexOfMorphism, 1 );
    deduped_39_1 := ListWithIdenticalEntries( deduped_43_1, deduped_45_1 );
    deduped_38_1 := ListWithIdenticalEntries( deduped_42_1, deduped_44_1 );
    deduped_37_1 := [ 0 .. deduped_43_1 - 1 ];
    deduped_36_1 := [ 0 .. deduped_43_1 + deduped_43_1 - 1 ];
    deduped_2_1 := [ deduped_46_1, deduped_47_1 ];
    deduped_1_1 := [ deduped_44_1, deduped_45_1 ];
    deduped_34_1 := Concatenation( List( deduped_38_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_35_1 := List( deduped_37_1, function ( i_2 )
            local hoisted_1_2, hoisted_2_2, deduped_3_2;
    ...
    deduped_32_1 := Product( deduped_34_1{[ 1 .. deduped_42_1 ]} );
    deduped_31_1 := ListWithIdenticalEntries( Length( deduped_37_1 ), deduped_33_1 );
    ...
    hoisted_28_1 := CAP_JIT_INCOMPLETE_LOGIC( REM_INT( QUO_INT( deduped_29_1, deduped_32_1 ), Product( deduped_34_1{[ 1 + deduped_42_1 .. Sum( [ deduped_42_1, deduped_43_1 ]{[ 1, 2 ]} ) ]} ) ) );
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, DefiningPairOfQuiverMorphismEnrichedOverSkeletalFinSets, NTuple( 2, List( [ 0 .. deduped_42_1 - 1 ], function ( i_2 )
                return REM_INT( QUO_INT( hoisted_26_1, deduped_46_1 ^ i_2 ), deduped_46_1 );
            end ), List( deduped_37_1, function ( i_2 )
                return REM_INT( QUO_INT( hoisted_28_1, deduped_47_1 ^ i_2 ), deduped_47_1 );
            end ) ) );
end
########
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_1_1 := [ deduped_47_1, deduped_49_1 ];
    deduped_38_1 := Concatenation( List( deduped_42_1, function ( objB_2 )
              local hoisted_1_2;
              hoisted_1_2 := IndexOfObject( objB_2 );
              return deduped_2_1[SafeUniquePositionProperty( deduped_1_1, function ( obj_3 )
                       return IndexOfObject( obj_3 ) = hoisted_1_2;
    ...
    deduped_36_1 := ListWithIdenticalEntries( Length( deduped_41_1 ), deduped_37_1 );
    ...
    hoisted_30_1 := Product( deduped_38_1{[ 1 + deduped_46_1 .. Sum( [ deduped_46_1, deduped_48_1 ]{[ 1, 2 ]} ) ]} );
    hoisted_29_1 := [ 0 .. deduped_46_1 - 1 ];
    deduped_27_1 := Product( deduped_38_1{[ 1 .. deduped_46_1 ]} );
