...
function ( cat_1 )
    ...
    deduped_24_1 := SetOfGeneratingMorphisms( deduped_26_1 );
    ...
    deduped_20_1 := List( deduped_21_1, function ( logic_new_func_x_2 )
            ...
            hoisted_17_2 := hoisted_6_1[deduped_25_2];
            ...
            hoisted_18_2 := Concatenation( List( hoisted_4_1, function ( logic_new_func_x_3 )
                      ...
                      deduped_8_3 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_3 );
                      deduped_7_3 := hoisted_7_1[hoisted_6_1[deduped_8_3]];
                      deduped_6_3 := Sum( hoisted_10_2{[ 1 .. logic_new_func_x_3 - 1 ]} );
                      hoisted_5_3 := [ deduped_6_3 .. deduped_6_3 + hoisted_1_2[deduped_8_3] - 1 ];
                      hoisted_3_3 := deduped_7_3[hoisted_17_2];
                      hoisted_2_3 := deduped_7_3;
                      hoisted_1_3 := deduped_8_3;
                      hoisted_4_3 := Concatenation( List( hoisted_4_1, function ( logic_new_func_x_4 )
                                local hoisted_1_4, hoisted_2_4, hoisted_3_4, hoisted_4_4, deduped_5_4, deduped_6_4, deduped_7_4, deduped_8_4, deduped_9_4;
                                deduped_9_4 := hoisted_6_1[logic_new_func_x_4];
                                deduped_8_4 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_4 );
                                deduped_7_4 := hoisted_1_2[deduped_8_4];
                                deduped_6_4 := hoisted_3_1[deduped_8_4][hoisted_1_3];
                                deduped_5_4 := [ deduped_6_4, deduped_7_4 ];
                                hoisted_4_4 := hoisted_7_1[deduped_9_4][hoisted_17_2];
                                hoisted_3_4 := deduped_5_4[2];
                                hoisted_2_4 := hoisted_2_3[deduped_9_4];
                                hoisted_1_4 := deduped_5_4[1];
                                return List( [ 0 .. deduped_6_4 * deduped_7_4 - 1 ], function ( i_5 )
                                        local deduped_1_5;
                                        deduped_1_5 := CAP_JIT_INCOMPLETE_LOGIC( i_5 );
                                        return -1 + SafePosition( hoisted_3_3, BasisPathOfPathAlgebraBasisElement( QuiverAlgebraElement( hoisted_8_1, hoisted_9_1, hoisted_2_4{[ (1 + REM_INT( deduped_1_5, hoisted_1_4 )) ]} ) * QuiverAlgebraElement( hoisted_8_1, hoisted_9_1, hoisted_4_4{[ (1 + REM_INT( QUO_INT( deduped_1_5, hoisted_1_4 ), hoisted_3_4 )) ]} ) ) );
                                    end );
                            end ) );
            ...
            return CreateCapCategoryObjectWithAttributes( hoisted_10_1, Length, Length( Filtered( [ 0 .. deduped_22_2 - 1 ], function ( x_3 )
    ...
    hoisted_19_1 := [ 0, 1 ];
    hoisted_17_1 := HomStructureOnBasisPaths( deduped_26_1 );
    hoisted_18_1 := List( deduped_24_1, function ( logic_new_func_x_2 )
            ...
            hoisted_6_2 := List( hoisted_2_1, function ( logic_new_func_x_3 )
                    ...
                    hoisted_1_3 := hoisted_17_1[deduped_2_3][hoisted_1_2][deduped_2_3][hoisted_3_2][SafePosition( hoisted_7_1[deduped_2_3][deduped_2_3], BasisPathOfPathAlgebraBasisElement( PathAsAlgebraElement( hoisted_8_1, QuiverVertexAsIdentityPath( deduped_3_3 ) ) ) )][hoisted_5_2];
    ...
    hoisted_14_1 := List( deduped_21_1, function ( logic_new_func_x_2 )
            local hoisted_1_2, hoisted_2_2, hoisted_3_2, hoisted_4_2, hoisted_5_2, hoisted_6_2, hoisted_7_2, hoisted_8_2, hoisted_9_2, hoisted_10_2, hoisted_11_2, hoisted_12_2, hoisted_13_2, hoisted_14_2, hoisted_15_2, hoisted_16_2, hoisted_17_2, hoisted_18_2, deduped_19_2, deduped_20_2, deduped_21_2, deduped_22_2, deduped_23_2, deduped_24_2, deduped_25_2;
            deduped_25_2 := CAP_JIT_INCOMPLETE_LOGIC( logic_new_func_x_2 );
            hoisted_1_2 := hoisted_3_1[deduped_25_2];
            deduped_24_2 := List( hoisted_4_1, function ( logic_new_func_x_3 )
    ...
    return CreateCapCategoryObjectWithAttributes( cat_1, Source, deduped_26_1, Range, deduped_27_1, ValuesOfPreSheaf, NTuple( 2, deduped_20_1, List( [ 1 .. Length( deduped_24_1 ) ], function ( m_2 )
                ...
                deduped_10_2 := hoisted_11_1[m_2];
                deduped_9_2 := hoisted_15_1[deduped_11_2];
                deduped_8_2 := 1 + deduped_10_2[1];
                deduped_7_2 := 1 + deduped_10_2[2];
                hoisted_6_2 := hoisted_14_1[deduped_8_2];
                hoisted_3_2 := [ 0 .. hoisted_16_1[deduped_11_2] - 1 ];
                hoisted_2_2 := hoisted_18_1[deduped_11_2];
                ...
                hoisted_5_2 := List( [ 0 .. 2 ^ deduped_9_2 - 1 ], function ( i_3 )
                        ...
                        return Sum( List( hoisted_3_2, function ( k_4 )
                                  return hoisted_19_1[(1 + hoisted_1_3[(1 + hoisted_2_2[(1 + CAP_JIT_INCOMPLETE_LOGIC( k_4 ))])])] * 2 ^ k_4;
                              end ) );
                    end );
                hoisted_4_2 := hoisted_14_1[deduped_7_2];
                return CreateCapCategoryMorphismWithAttributes( hoisted_10_1, hoisted_12_1[deduped_7_2], hoisted_12_1[deduped_8_2], AsList, List( [ 0 .. hoisted_13_1[deduped_7_2] - 1 ], function ( x_3 )
