...
ReadPackage( "FunctorCategories", "gap/ENHANCED_SYNTAX_TREEs_for_CategoryOfBouquets.gi");
...
ReadPackage( "FunctorCategories", "gap/ENHANCED_SYNTAX_TREEs_for_CategoryOfReflexiveQuivers.gi");
