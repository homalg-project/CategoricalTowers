...
./codecov -Z -v -s ../ -F CatReps || (sleep 30; ./codecov -Z -v -s ../ -F CatReps || (sleep 30; ./codecov -Z -v -s ../ -F CatReps))
...
./codecov -Z -v -s ../ -F InternalModules || (sleep 30; ./codecov -Z -v -s ../ -F InternalModules || (sleep 30; ./codecov -Z -v -s ../ -F InternalModules))
